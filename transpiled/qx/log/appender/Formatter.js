  ...
  qx.Class.define("qx.log.appender.Formatter", {
    ...
    members: {
      ...
      formatEntryTime: function formatEntryTime(entry) {
        ...
        if (!qx.log.appender.Formatter.__DATETIME_FORMAT__P_183_0) {
          qx.log.appender.Formatter.__DATETIME_FORMAT__P_183_0 = new qx.util.format.DateFormat("YYYY-MM-dd HH:mm:ss");
        }

        return qx.log.appender.Formatter.__DATETIME_FORMAT__P_183_0.format(entry.time);
      },
    ...
    statics: {
      ...
      __DATETIME_FORMAT__P_183_0: null,

      /** @type {qx.log.appender.Formatter} the default instance */
      __defaultFormatter__P_183_1: null,
      ...
      getFormatter: function getFormatter() {
        if (!qx.log.appender.Formatter.__defaultFormatter__P_183_1) {
          qx.log.appender.Formatter.__defaultFormatter__P_183_1 = new qx.log.appender.Formatter();
        }

        return qx.log.appender.Formatter.__defaultFormatter__P_183_1;
      },
      ...
      setFormatter: function setFormatter(instance) {
        qx.log.appender.Formatter.__defaultFormatter__P_183_1 = instance;
      },
      ...
      escapeHTML: function escapeHTML(value) {
        return String(value).replace(/[<>&"']/g, qx.log.appender.Formatter.__escapeHTMLReplace__P_183_2);
      },
       ...
       */
      __escapeHTMLReplace__P_183_2: function __escapeHTMLReplace__P_183_2(ch) {
        var map = {
          "<": "&lt;",
          ">": "&gt;",
          "&": "&amp;",
...
//# sourceMappingURL=Formatter.js.map?dt=1592520317212