  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.log.appender.Console", {
    statics: {
      ...
      ---------------------------------------------------------------------------
      */
      __main__P_183_0: null,
      __log__P_183_1: null,
      __cmd__P_183_2: null,
      __lastCommand__P_183_3: null,
      ...
      init: function init() {
        ...
        this.__main__P_183_0 = main;
        this.__log__P_183_1 = main.childNodes[1];
        this.__cmd__P_183_2 = main.childNodes[2].firstChild; // Correct height of messages frame

        this.__onResize__P_183_4(); // Finally register to log engine
      ...
      dispose: function dispose() {
        qx.event.Registration.removeListener(document.documentElement, "keypress", this.__onKeyPress__P_183_5, this);
      ...
      */
      ...
      process: function process(entry) {
        ...
        this.__log__P_183_1.appendChild(formatter.toHtml(entry)); // Scroll down


        this.__scrollDown__P_183_6();
      },

      /**
       * Automatically scroll down to the last line
       */
      __scrollDown__P_183_6: function __scrollDown__P_183_6() {
        this.__log__P_183_1.scrollTop = this.__log__P_183_1.scrollHeight;
      },
      ...
      */
      ...
      toggle: function toggle() {
        if (!this.__main__P_183_0) {
          this.init();
        } else if (this.__main__P_183_0.style.display == "none") {
          this.show();
        } else {
          this.__main__P_183_0.style.display = "none";
        }
      },
      ...
      show: function show() {
        if (!this.__main__P_183_0) {
          ...
          this.__main__P_183_0.style.display = "block";
          this.__log__P_183_1.scrollTop = this.__log__P_183_1.scrollHeight;
        }
      },
      ...
      */
      ...
      execute: function execute() {
        var value = this.__cmd__P_183_2.value;
        ...
        this.__history__P_183_8.push(value);

        this.__lastCommand__P_183_3 = this.__history__P_183_8.length;

        this.__log__P_183_1.appendChild(command);
      ...
      */
       ...
       */
      __onResize__P_183_4: function __onResize__P_183_4(e) {
        this.__log__P_183_1.style.height = this.__main__P_183_0.clientHeight - this.__main__P_183_0.firstChild.offsetHeight - this.__main__P_183_0.lastChild.offsetHeight + "px";
      },
       ...
       * @param e {Event} Event object
       */
      __onKeyPress__P_183_5: function __onKeyPress__P_183_5(e) {
        ...
        if (!qx.dom.Hierarchy.contains(this.__main__P_183_0, e.getTarget())) {
          return;
        } // Command execution


        if (iden == "Enter" && this.__cmd__P_183_2.value != "") {
          this.execute();
          this.__cmd__P_183_2.value = "";
        } // History management


        if (iden == "Up" || iden == "Down") {
          this.__lastCommand__P_183_3 += iden == "Up" ? -1 : 1;
          this.__lastCommand__P_183_3 = Math.min(Math.max(0, this.__lastCommand__P_183_3), this.__history__P_183_8.length);
          var entry = this.__history__P_183_8[this.__lastCommand__P_183_3];
          this.__cmd__P_183_2.value = entry || "";

          this.__cmd__P_183_2.select();
        }
      }
    },
    ...
    */
    defer: function defer(statics) {
      qx.event.Registration.addListener(document.documentElement, "keypress", statics.__onKeyPress__P_183_5, statics);
      qx.event.Registration.addListener(document.documentElement, "longtap", statics.__onKeyPress__P_183_5, statics);
    }
  });
  qx.log.appender.Console.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Console.js.map?dt=1599312831124