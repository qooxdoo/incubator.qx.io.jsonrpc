  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.io.ImageLoader", {
    statics: {
      ...
      __defaultSize__P_154_1: {
        width: null,
        height: null
      },

      /** @type {RegExp} Known image types */
      __knownImageTypesRegExp__P_154_2: /\.(png|gif|jpg|jpeg|bmp)\b/i,

      /** @type {RegExp} Image types of a data URL */
      __dataUrlRegExp__P_154_3: /^data:image\/(png|gif|jpg|jpeg|bmp)\b/i,
      ...
      isLoaded: function isLoaded(source) {
        var entry = this.__data__P_154_0[source];
      ...
      getFormat: function getFormat(source) {
        ...
        if (!entry || !entry.format) {
          var result = this.__dataUrlRegExp__P_154_3.exec(source);

          if (result != null) {
            // If width and height aren't defined, provide some defaults
            var width = entry && qx.lang.Type.isNumber(entry.width) ? entry.width : this.__defaultSize__P_154_1.width;
            var height = entry && qx.lang.Type.isNumber(entry.height) ? entry.height : this.__defaultSize__P_154_1.height;
            entry = {
              loaded: true,
              format: result[1],
              width: width,
      ...
      load: function load(source, callback, context) {
        ...
        if (!entry) {
          entry = this.__data__P_154_0[source] = {};
        } // Normalize context
        ...
        if (entry.loaded || entry.loading || entry.failed) {
          ...
          var boundCallback = qx.lang.Function.listener(this.__onload__P_154_4, this, el, source); // Assign callback to element
      ...
      abort: function abort(source) {
        ...
        this.__data__P_154_0[source] = null;
      },

      /**
       * Calls a method based on qx.globalErrorHandling
       */
      __onload__P_154_4: function __onload__P_154_4() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__onLoadHandler__P_154_5),
          "false": this.__onLoadHandler__P_154_5
        });
       ...
       */
      __onLoadHandler__P_154_5: function __onLoadHandler__P_154_5(event, element, source) {
        // Shorthand
        var entry = this.__data__P_154_0[source]; // [BUG #9149]: When loading a SVG IE11 won't have
        ...
        if (event.type === "load" && isImageAvailable(element)) {
          ...
          var result = this.__knownImageTypesRegExp__P_154_2.exec(source);
...
//# sourceMappingURL=ImageLoader.js.map?dt=1625734502208