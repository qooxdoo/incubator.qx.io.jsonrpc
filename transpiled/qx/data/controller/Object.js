  ...
  qx.Class.define("qx.data.controller.Object", {
    ...
    */
    ...
    construct: function construct(model) {
      ...
      this.__bindings__P_91_0 = {}; // create an array to store all current targets

      this.__targets__P_91_1 = [];
    ...
    */
    members: {
      // private members
      __targets__P_91_1: null,
      __bindings__P_91_0: null,
      ...
      _applyModel: function _applyModel(value, old) {
        // for every target
        for (var i = 0; i < this.__targets__P_91_1.length; i++) {
          // get the properties
          var targetObject = this.__targets__P_91_1[i][0];
          var targetProperty = this.__targets__P_91_1[i][1];
          var sourceProperty = this.__targets__P_91_1[i][2];
          var bidirectional = this.__targets__P_91_1[i][3];
          var options = this.__targets__P_91_1[i][4];
          var reverseOptions = this.__targets__P_91_1[i][5]; // remove it from the old if possible

          if (old != undefined && !old.isDisposed()) {
            this.__removeTargetFrom__P_91_2(targetObject, targetProperty, sourceProperty, old);
          } // add it to the new if available


          if (value != undefined) {
            this.__addTarget__P_91_3(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions);
          } else {
      ...
      addTarget: function addTarget(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions) {
        ...
        this.__targets__P_91_1.push([targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions]); // delegate the adding
      ...
      *   {@link qx.data.SingleValueBinding} class.
      */
      __addTarget__P_91_3: function __addTarget__P_91_3(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions) {
        ...
        if (this.__bindings__P_91_0[targetHash] == undefined) {
          this.__bindings__P_91_0[targetHash] = [];
        }

        this.__bindings__P_91_0[targetHash].push([id, idReverse, targetProperty, sourceProperty, options, reverseOptions]);
      },
      ...
      removeTarget: function removeTarget(targetObject, targetProperty, sourceProperty) {
        this.__removeTargetFrom__P_91_2(targetObject, targetProperty, sourceProperty, this.getModel()); // delete the target in the targets reference


        for (var i = 0; i < this.__targets__P_91_1.length; i++) {
          if (this.__targets__P_91_1[i][0] == targetObject && this.__targets__P_91_1[i][1] == targetProperty && this.__targets__P_91_1[i][2] == sourceProperty) {
            this.__targets__P_91_1.splice(i, 1);
          }
        }
      },
       ...
       *   comes.
       */
      __removeTargetFrom__P_91_2: function __removeTargetFrom__P_91_2(targetObject, targetProperty, sourceProperty, sourceObject) {
        ...
        var currentListing = this.__bindings__P_91_0[targetObject.toHashCode()]; // if no binding is stored
...
//# sourceMappingURL=Object.js.map?dt=1606150442828