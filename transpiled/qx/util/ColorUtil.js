    ...
    statics: {
      ...
      stringToRgb: function stringToRgb(str) {
        ...
        if (this.isNamedColor(str)) {
          ...
          return this.__rgbaStringToRgb__P_570_0(str);
        } else if (this.isRgbString(str)) {
          return this.__rgbStringToRgb__P_570_1();
        } else if (this.isHex3String(str)) {
          return this.__hex3StringToRgb__P_570_2();
        } else if (this.isHex6String(str)) {
          return this.__hex6StringToRgb__P_570_3();
        }
      ...
      cssStringToRgb: function cssStringToRgb(str) {
        if (this.isNamedColor(str)) {
          ...
          return this.__rgbaStringToRgb__P_570_0();
        } else if (this.isHex3String(str)) {
          return this.__hex3StringToRgb__P_570_2();
        } else if (this.isHex6String(str)) {
          return this.__hex6StringToRgb__P_570_3();
       ...
       */
      __rgbStringToRgb__P_570_1: function __rgbStringToRgb__P_570_1() {
       ...
       * @return {Array} an array with red, green, blue
       */
      __rgbaStringToRgb__P_570_0: function __rgbaStringToRgb__P_570_0() {
        var red = parseInt(RegExp.$1, 10);
        var green = parseInt(RegExp.$2, 10);
        var blue = parseInt(RegExp.$3, 10);
       ...
       * @return {Array} an array with red, green, blue
       */
      __hex3StringToRgb__P_570_2: function __hex3StringToRgb__P_570_2() {
       ...
       * @return {Array} an array with red, green, blue
       */
      __hex6StringToRgb__P_570_3: function __hex6StringToRgb__P_570_3() {
      ...
      hex3StringToRgb: function hex3StringToRgb(value) {
        if (this.isHex3String(value)) {
          return this.__hex3StringToRgb__P_570_2(value);
        }
      ...
      hex6StringToRgb: function hex6StringToRgb(value) {
        if (this.isHex6String(value)) {
          return this.__hex6StringToRgb__P_570_3(value);
        }
...
//# sourceMappingURL=ColorUtil.js.map?dt=1591363011449