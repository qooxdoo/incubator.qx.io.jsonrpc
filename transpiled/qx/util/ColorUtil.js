    ...
    statics: {
      ...
      stringToRgb: function stringToRgb(str) {
        ...
        if (this.isNamedColor(str)) {
          ...
          return this.__rgbaStringToRgb__P_571_0(str);
        } else if (this.isRgbString(str)) {
          return this.__rgbStringToRgb__P_571_1();
        } else if (this.isHex3String(str)) {
          return this.__hex3StringToRgb__P_571_2();
        } else if (this.isHex6String(str)) {
          return this.__hex6StringToRgb__P_571_3();
        }
      ...
      cssStringToRgb: function cssStringToRgb(str) {
        if (this.isNamedColor(str)) {
          ...
          return this.__rgbaStringToRgb__P_571_0();
        } else if (this.isHex3String(str)) {
          return this.__hex3StringToRgb__P_571_2();
        } else if (this.isHex6String(str)) {
          return this.__hex6StringToRgb__P_571_3();
       ...
       * @return {Array} an array with red, green, blue
       */
      __hex3StringToRgb__P_571_2: function __hex3StringToRgb__P_571_2() {
       ...
       * @return {Array} an array with red, green, blue
       */
      __hex6StringToRgb__P_571_3: function __hex6StringToRgb__P_571_3() {
      ...
      hex3StringToRgb: function hex3StringToRgb(value) {
        if (this.isHex3String(value)) {
          return this.__hex3StringToRgb__P_571_2(value);
        }
      ...
      hex6StringToRgb: function hex6StringToRgb(value) {
        if (this.isHex6String(value)) {
          return this.__hex6StringToRgb__P_571_3(value);
        }
...
//# sourceMappingURL=ColorUtil.js.map?dt=1592908480823