    ...
    members: {
      ...
      setParser: function setParser(parser) {
        ...
        if (typeof qx.util.ResponseParser.PARSER[parser] === "function") {
          return this.__parser__P_580_0 = qx.util.ResponseParser.PARSER[parser];
        ...
        return this.__parser__P_580_0 = parser;
      },
      ...
      _getParser: function _getParser(contentType) {
        var parser = this.__parser__P_580_0,
            contentTypeOrig = "",
...
//# sourceMappingURL=ResponseParser.js.map?dt=1592867928565