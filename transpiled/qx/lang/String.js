  ...
  qx.Bootstrap.define("qx.lang.String", {
    statics: {
      ...
      camelCase: function camelCase(str) {
        var result = this.__stringsMap__P_179_2[str];
        ...
        if (!result) {
          ...
          if (str.indexOf("-") >= 0) {
            this.__stringsMap__P_179_2[str] = result;
          }
        }
      ...
      capitalize: function capitalize(str) {
        if (this.__unicodeFirstLetterInWordRegexp__P_179_1 === null) {
          var unicodeEscapePrefix = '\\u';
          this.__unicodeFirstLetterInWordRegexp__P_179_1 = new RegExp("(^|[^" + this.__unicodeLetters__P_179_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "])[" + this.__unicodeLetters__P_179_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "]", "g");
        }

        return str.replace(this.__unicodeFirstLetterInWordRegexp__P_179_1, function (match) {
...
//# sourceMappingURL=String.js.map?dt=1599462387792