(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.storage.Memory", {
    statics: {
      __local__P_65_0: null,
      __session__P_65_1: null,
      ...
      getLocal: function getLocal() {
        if (this.__local__P_65_0) {
          return this.__local__P_65_0;
        }

        return this.__local__P_65_0 = new qx.bom.storage.Memory();
      },
      ...
      getSession: function getSession() {
        if (this.__session__P_65_1) {
          return this.__session__P_65_1;
        }

        return this.__session__P_65_1 = new qx.bom.storage.Memory();
      }
    },
    construct: function construct() {
      this.__storage__P_65_2 = {};
    },
    members: {
      __storage__P_65_2: null,
      ...
      getLength: function getLength() {
        return Object.keys(this.__storage__P_65_2).length;
      },
      ...
      setItem: function setItem(key, value) {
        ...
        this.__storage__P_65_2[key] = value;
      },
      ...
      getItem: function getItem(key) {
        var item = this.__storage__P_65_2[key];
      ...
      removeItem: function removeItem(key) {
        delete this.__storage__P_65_2[key];
      },
      ...
      getKey: function getKey(index) {
        var keys = Object.keys(this.__storage__P_65_2);
        return keys[index];
      },
...
//# sourceMappingURL=Memory.js.map?dt=1625734494803