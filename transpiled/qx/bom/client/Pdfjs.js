(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Pdfjs", {
    statics: {
      ...
      getPdfjs: function getPdfjs(callback, context) {
        qx.bom.client.Pdfjs.__isAvailable__P_42_0(callback, context);
      },
       ...
       * @param context {Object} The context object for the callback function.
       */
      __isAvailable__P_42_0: function __isAvailable__P_42_0(callback, context) {
        var resManager = qx.util.ResourceManager.getInstance();
        var urlToPdf = resManager.toUri("qx/static/empty.pdf");

        var pluginDetect = qx.bom.client.Pdfjs.__getPluginDetect__P_42_1();
       ...
       */
      __getPluginDetect__P_42_1: null
    },
  ...
  (function () {
    ...
    qx.bom.client.Pdfjs.__getPluginDetect__P_42_1 = function () {
...
//# sourceMappingURL=Pdfjs.js.map?dt=1599578744685