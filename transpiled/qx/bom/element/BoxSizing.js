  ...
  qx.Bootstrap.define("qx.bom.element.BoxSizing", {
    ...
    */
    statics: {
       ...
       */
      __usesNativeBorderBox__P_51_1: function __usesNativeBorderBox__P_51_1(element) {
        var map = this.__nativeBorderBox__P_51_0;
      ...
      get: function get(element) {
        ...
        if (qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(element))) {
          if (!this.__usesNativeBorderBox__P_51_1(element)) {
            return "content-box";
          }
        }
...
//# sourceMappingURL=BoxSizing.js.map?dt=1599312820379