  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Location", {
    statics: {
       ...
       */
      __style__P_56_0: function __style__P_56_0(elem, style) {
       ...
       */
      __num__P_56_1: function __num__P_56_1(elem, style) {
       ...
       */
      __computeScroll__P_56_2: function __computeScroll__P_56_2(elem) {
        var left = 0,
            top = 0; // Find window
       ...
       */
      __computeBody__P_56_3: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(elem) {
          ...
          if (!qx.core.Environment.get("browser.quirksmode")) {
            left += this.__num__P_56_1(body, "borderLeftWidth");
            top += this.__num__P_56_1(body, "borderTopWidth");
          }
       ...
       * @return {Map} Map which contains the <code>left</code> and <code>top</code> offsets
       */
      __computeOffset__P_56_4: function __computeOffset__P_56_4(elem) {
      ...
      get: function get(elem, mode) {
        if (elem.tagName == "BODY") {
          var location = this.__getBodyLocation__P_56_5(elem);

          var left = location.left;
          var top = location.top;
        } else {
          var body = this.__computeBody__P_56_3(elem);

          var offset = this.__computeOffset__P_56_4(elem); // Reduce by viewport scrolling.
          // Hint: getBoundingClientRect returns the location of the
          // element in relation to the viewport which includes
          // the scrolling


          var scroll = this.__computeScroll__P_56_2(elem);
        ...
        if (mode) {
          ...
          if (mode == "padding" || mode == "scroll") {
            ...
            if (overX == "scroll" || overX == "auto") {
              right += elem.scrollWidth - elementWidth + this.__num__P_56_1(elem, "borderLeftWidth") + this.__num__P_56_1(elem, "borderRightWidth");
            }

            var overY = qx.bom.element.Style.get(elem, "overflowY");

            if (overY == "scroll" || overY == "auto") {
              bottom += elem.scrollHeight - elementHeight + this.__num__P_56_1(elem, "borderTopWidth") + this.__num__P_56_1(elem, "borderBottomWidth");
            }
          }

          switch (mode) {
            case "padding":
              left += this.__num__P_56_1(elem, "paddingLeft");
              top += this.__num__P_56_1(elem, "paddingTop");
              right -= this.__num__P_56_1(elem, "paddingRight");
              bottom -= this.__num__P_56_1(elem, "paddingBottom");
            // no break here
            ...
            case "border":
              left += this.__num__P_56_1(elem, "borderLeftWidth");
              top += this.__num__P_56_1(elem, "borderTopWidth");
              right -= this.__num__P_56_1(elem, "borderRightWidth");
              bottom -= this.__num__P_56_1(elem, "borderBottomWidth");
              break;

            case "margin":
              left -= this.__num__P_56_1(elem, "marginLeft");
              top -= this.__num__P_56_1(elem, "marginTop");
              right += this.__num__P_56_1(elem, "marginRight");
              bottom += this.__num__P_56_1(elem, "marginBottom");
              break;
          }
        }
       ...
       */
      __getBodyLocation__P_56_5: function __getBodyLocation__P_56_5(body) {
        var top = body.offsetTop;
        var left = body.offsetLeft;
        top += this.__num__P_56_1(body, "marginTop");
        left += this.__num__P_56_1(body, "marginLeft");

        if (qx.core.Environment.get("engine.name") === "gecko") {
          top += this.__num__P_56_1(body, "borderLeftWidth");
          left += this.__num__P_56_1(body, "borderTopWidth");
        }
...
//# sourceMappingURL=Location.js.map?dt=1608415638761