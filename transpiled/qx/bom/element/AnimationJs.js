  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationJs", {
    statics: {
       ...
       */
      __maxStepTime__P_48_0: 30,

      /**
       * The supported CSS units.
       */
      __units__P_48_1: ["%", "in", "cm", "mm", "em", "ex", "pt", "pc", "px"],

      /** The used keys for transforms. */
      __transitionKeys__P_48_2: {
        "scale": true,
        "rotate": true,
        "skew": true,
        "translate": true
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        ...
        var keys = this.__getOrderedKeys__P_48_3(keyFrames);

        var stepTime = this.__getStepTime__P_48_4(duration, keys);

        var steps = parseInt(duration / stepTime, 10);

        this.__normalizeKeyFrames__P_48_5(keyFrames, el);

        var delta = this.__calculateDelta__P_48_6(steps, stepTime, keys, keyFrames, duration, desc.timing);
        ...
        handle.i = 0;
        handle.initValues = {};
        handle.repeatSteps = this.__applyRepeat__P_48_7(steps, desc.repeat);
       ...
       * @param el {Element} The element to animate.
       */
      __normalizeKeyFrames__P_48_5: function __normalizeKeyFrames__P_48_5(keyFrames, el) {
          ...
          for (var name in keyFrames[percent]) {
            ...
            if (units[name] == undefined) {
              ...
              if (typeof item == "string") {
                units[name] = this.__getUnit__P_48_8(item);
              } else {
                units[name] = "";
              }
            }
        ...
        for (var percent in keyFrames) {
          ...
          for (var name in units) {
            if (frame[name] == undefined) {
              ...
              if (frame[name] === "" && this.__units__P_48_1.indexOf(units[name]) != -1) {
       ...
       */
      __normalizeKeyFrameTransforms__P_48_9: function __normalizeKeyFrameTransforms__P_48_9(frame) {
        frame = qx.lang.Object.clone(frame);
        var transforms;

        for (var name in frame) {
          if (name in this.__transitionKeys__P_48_2) {
            if (!transforms) {
              transforms = {};
            }
       ...
       */
      __calculateDelta__P_48_6: function __calculateDelta__P_48_6(steps, stepTime, keys, keyFrames, duration, timing) {
        var delta = new Array(steps);
        var keyIndex = 1;
        delta[0] = this.__normalizeKeyFrameTransforms__P_48_9(keyFrames[0]);
            ...
            if (name in this.__transitionKeys__P_48_2) {
              ...
              if (qx.Bootstrap.isArray(last[name])) {
                ...
                for (var j = 0; j < next[name].length; j++) {
                  ...
                  transforms[name][j] = this.__getNextValue__P_48_10(item, last[name], timing, x);
                }
              } else {
                var x = calculationIndex / stepsToNext;
                transforms[name] = this.__getNextValue__P_48_10(nItem, last[name], timing, x);
              } // color values
              ...
              var x = calculationIndex / stepsToNext;
              delta[i][name] = this.__getNextValue__P_48_10(nItem, last[name], timing, x);
            } else {
        ...
        delta[delta.length - 1] = this.__normalizeKeyFrameTransforms__P_48_9(keyFrames[100]);
        return delta;
      },
       ...
       */
      __getUnit__P_48_8: function __getUnit__P_48_8(item) {
       ...
       */
      __getNextValue__P_48_10: function __getNextValue__P_48_10(nextItem, lastItem, timing, x) {
        var range = parseFloat(nextItem) - parseFloat(lastItem);
        return parseFloat(lastItem) + range * qx.bom.AnimationFrame.calculateTiming(timing, x) + this.__getUnit__P_48_8(nextItem);
      },
      ...
      play: function play(handle) {
        ...
        var id = window.setInterval(function () {
          ...
          qx.bom.element.AnimationJs.__applyStyles__P_48_11(handle.el, values);
      ...
      stop: function stop(handle) {
        ...
        if (keep != undefined && !handle.stopped) {
          ...
          this.__applyStyles__P_48_11(el, this.__normalizeKeyFrameTransforms__P_48_9(desc.keyFrames[keep]));
        } else {
          this.__applyStyles__P_48_11(el, initValues);
        }
       ...
       */
      __applyRepeat__P_48_7: function __applyRepeat__P_48_7(steps, repeat) {
        if (repeat == undefined) {
          return steps;
        }
       ...
       */
      __applyStyles__P_48_11: function __applyStyles__P_48_11(el, styles) {
       ...
       */
      __getStepTime__P_48_4: function __getStepTime__P_48_4(duration, keys) {
        // get min difference
        var minDiff = 100;
        ...
        while (stepTime > this.__maxStepTime__P_48_0) {
          stepTime = stepTime / 2;
        }
       ...
       */
      __getOrderedKeys__P_48_3: function __getOrderedKeys__P_48_3(keyFrames) {
...
//# sourceMappingURL=AnimationJs.js.map?dt=1598908848465