  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    statics: {
       ...
       */
      __fixNonDirectlyClosableHelper__P_19_0: function __fixNonDirectlyClosableHelper__P_19_0(all, front, tag) {
        return tag.match(/^(abbr|br|col|img|input|link|meta|param|hr|area|embed)$/i) ? all : front + "></" + tag + ">";
      },

      /** @type {Map} Contains wrap fragments for specific HTML matches */
      __convertMap__P_19_1: {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__fixNonDirectlyClosableHelper__P_19_0);
      },
       ...
       */
      __convertHtmlString__P_19_2: function __convertHtmlString__P_19_2(html, context) {
      ...
      clean: function clean(objs, context, fragment) {
        ...
        for (var i = 0, l = objs.length; i < l; i++) {
          ...
          if (typeof obj === "string") {
            obj = this.__convertHtmlString__P_19_2(obj, context);
...
//# sourceMappingURL=Html.js.map?dt=1600416830241