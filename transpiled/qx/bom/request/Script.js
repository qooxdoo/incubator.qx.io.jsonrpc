  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct: function construct() {
      this.__initXhrProperties__P_61_0();

      this.__onNativeLoadBound__P_61_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__onNativeErrorBound__P_61_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__onTimeoutBound__P_61_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__headElement__P_61_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__supportsErrorHandler__P_61_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
       ...
       */
      __determineSuccess__P_61_6: null,
      ...
      open: function open(method, url) {
        ...
        this.__abort__P_61_8 = null;
        this.__url__P_61_9 = url;

        if (this.__environmentGet__P_61_10("qx.debug.io")) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__url__P_61_9 = qx.util.Uri.appendParamsToUrl(this.__url__P_61_9, param);
        return this;
      },
      ...
      send: function send() {
        ...
        var script = this.__createScriptElement__P_61_11(),
            head = this.__headElement__P_61_4,
            that = this;

        if (this.timeout > 0) {
          this.__timeoutId__P_61_12 = window.setTimeout(this.__onTimeoutBound__P_61_3, this.timeout);
        }
      ...
      abort: function abort() {
        ...
        this.__abort__P_61_8 = true;

        this.__disposeScriptElement__P_61_13();
      ...
      */
      ...
      getResponseHeader: function getResponseHeader(key) {
        ...
        if (this.__environmentGet__P_61_10("qx.debug")) {
      ...
      setDetermineSuccess: function setDetermineSuccess(check) {
        this.__determineSuccess__P_61_6 = check;
      },
      ...
      dispose: function dispose() {
        var script = this.__scriptElement__P_61_14;
        ...
        if (!this.__disposed__P_61_7) {
          ...
          if (this.__timeoutId__P_61_12) {
            window.clearTimeout(this.__timeoutId__P_61_12);
          }

          this.__disposed__P_61_7 = true;
        }
      },
      ...
      isDisposed: function isDisposed() {
        return !!this.__disposed__P_61_7;
      },
      ...
      */
      ...
      _getScriptElement: function _getScriptElement() {
        return this.__scriptElement__P_61_14;
      },
      ...
      _onTimeout: function _onTimeout() {
        this.__failure__P_61_15();

        if (!this.__supportsErrorHandler__P_61_5()) {
          this._emit("error");
        }
      ...
      _onNativeLoad: function _onNativeLoad() {
        var script = this.__scriptElement__P_61_14,
            determineSuccess = this.__determineSuccess__P_61_6,
            that = this; // Aborted request must not fire load

        if (this.__abort__P_61_8) {
          return;
        } // BUGFIX: IE < 9
        ...
        if (this.__environmentGet__P_61_10("engine.name") === "mshtml" && this.__environmentGet__P_61_10("browser.documentmode") < 9) {
      ...
      */
       ...
       */
      __scriptElement__P_61_14: null,

      /**
       * @type {Element} Head element
       */
      __headElement__P_61_4: null,
      ...
      */
       ...
       */
      __initXhrProperties__P_61_0: function __initXhrProperties__P_61_0() {
        this.readyState = 0;
        this.status = 0;
        this.statusText = "";
      },
       ...
       * Handle failure.
       */
      __failure__P_61_15: function __failure__P_61_15() {
        this.__disposeScriptElement__P_61_13();
       ...
       */
      __supportsErrorHandler__P_61_5: function __supportsErrorHandler__P_61_5() {
        var isLegacyIe = this.__environmentGet__P_61_10("engine.name") === "mshtml" && this.__environmentGet__P_61_10("browser.documentmode") < 9;
        var isOpera = this.__environmentGet__P_61_10("engine.name") === "opera";
       ...
       */
      __createScriptElement__P_61_11: function __createScriptElement__P_61_11() {
        var script = this.__scriptElement__P_61_14 = document.createElement("script");
        script.src = this.__url__P_61_9;
        script.onerror = this.__onNativeErrorBound__P_61_2;
        script.onload = this.__onNativeLoadBound__P_61_1; // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event

        if (this.__environmentGet__P_61_10("engine.name") === "mshtml" && this.__environmentGet__P_61_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__onNativeLoadBound__P_61_1;
        }
       ...
       */
      __disposeScriptElement__P_61_13: function __disposeScriptElement__P_61_13() {
        var script = this.__scriptElement__P_61_14;

        if (script && script.parentNode) {
          this.__headElement__P_61_4.removeChild(script);
        }
      },
       ...
       */
      __environmentGet__P_61_10: function __environmentGet__P_61_10(key) {
...
//# sourceMappingURL=Script.js.map?dt=1596696208012