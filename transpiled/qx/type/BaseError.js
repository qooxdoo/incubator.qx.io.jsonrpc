  ...
  qx.Bootstrap.define("qx.type.BaseError", {
    ...
    */
    ...
    construct: function construct(comment, failMessage) {
      ...
      this.__comment__P_366_0 = comment || ""; // opera 10 crashes if the message is an empty string!!!?!?!
    ...
    */
    members: {
      __sTrace__P_366_1: null,
      __comment__P_366_0: null,
      ...
      getComment: function getComment() {
        return this.__comment__P_366_0;
      },
      ...
      toString: function toString() {
        return this.__comment__P_366_0 + (this.message ? ": " + this.message : "");
      }
    }
  });
...
//# sourceMappingURL=BaseError.js.map?dt=1592520335235