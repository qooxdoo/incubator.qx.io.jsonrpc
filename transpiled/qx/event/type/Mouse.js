  ...
  qx.Class.define("qx.event.type.Mouse", {
    ...
    */
    members: {
       ...
       */
      __buttonsDom2EventModel__P_146_0: {
        0: "left",
        2: "right",
        1: "middle"
      },
       ...
       */
      __buttonsDom3EventModel__P_146_1: {
        0: "none",
        1: "left",
        2: "right",
        4: "middle"
       ...
       */
      __buttonsMshtmlEventModel__P_146_2: {
        1: "left",
        2: "right",
        4: "middle"
      },
          ...
          default:
            if (!(qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") <= 8)) {
              ...
              if (this._native.button === -1) {
                return this.__buttonsDom3EventModel__P_146_1[this._native.buttons] || "none";
              }

              return this.__buttonsDom2EventModel__P_146_0[this._native.button] || "none";
            } else {
              return this.__buttonsMshtmlEventModel__P_146_2[this._native.button] || "none";
            }
...
//# sourceMappingURL=Mouse.js.map?dt=1606253503296