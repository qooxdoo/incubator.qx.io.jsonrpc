  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Gesture", {
    ...
    construct: function construct(manager) {
      ...
      qx.event.handler.GestureCore.apply(this, [this.__root__P_126_2]);
    },
    members: {
      __manager__P_126_0: null,
      __window__P_126_1: null,
      __root__P_126_2: null,
      __listener__P_126_3: null,
      __onDblClickWrapped__P_126_4: null,
      __fireRollWrapped__P_126_5: null,
      ...
      _initObserver: function _initObserver() {
        this.__listener__P_126_3 = qx.lang.Function.listener(this.checkAndFireGesture, this);
        qx.event.handler.Gesture.GESTURE_EVENTS.forEach(function (type) {
          qx.event.Registration.addListener(this.__root__P_126_2, type, this.__listener__P_126_3, this);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          this.__onDblClickWrapped__P_126_4 = qx.lang.Function.listener(this._onDblClick, this);
          qx.bom.Event.addNativeListener(this.__root__P_126_2, "dblclick", this.__onDblClickWrapped__P_126_4);
        } // list to wheel events


        var data = qx.bom.client.Event.getMouseWheel(this.__window__P_126_1);
        this.__fireRollWrapped__P_126_5 = qx.lang.Function.listener(this._fireRoll, this); // replaced the useCapture (4th parameter) from this to true
        // see https://github.com/qooxdoo/qooxdoo/pull/9292

        qx.bom.Event.addNativeListener(data.target, data.type, this.__fireRollWrapped__P_126_5, true, false);
      },
      ...
      checkAndFireGesture: function checkAndFireGesture(pointerEvent, type, target) {
        this.__callBase__P_126_6("checkAndFireGesture", [pointerEvent.getNativeEvent(), pointerEvent.getType(), pointerEvent.getTarget()]);
      },
      // overridden
      _stopObserver: function _stopObserver() {
        qx.event.handler.Gesture.GESTURE_EVENTS.forEach(function (type) {
          qx.event.Registration.removeListener(this.__root__P_126_2, type, this.__listener__P_126_3);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          qx.bom.Event.removeNativeListener(this.__root__P_126_2, "dblclick", this.__onDblClickWrapped__P_126_4);
        }

        var data = qx.bom.client.Event.getMouseWheel(this.__window__P_126_1);
        qx.bom.Event.removeNativeListener(data.target, data.type, this.__fireRollWrapped__P_126_5);
      },
      // overridden
      ...
      dispose: function dispose() {
        ...
        this.__callBase__P_126_6("dispose");

        this.__manager__P_126_0 = this.__window__P_126_1 = this.__root__P_126_2 = this.__onDblClickWrapped__P_126_4 = null;
      },
       ...
       */
      __callBase__P_126_6: function __callBase__P_126_6(method, args) {
...
//# sourceMappingURL=Gesture.js.map?dt=1625734499953