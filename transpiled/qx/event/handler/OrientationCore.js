  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.OrientationCore", {
    ...
    construct: function construct(targetWindow, emitter) {
      ...
      this.__emitter__P_133_0 = emitter;

      this._initObserver();
    },
    members: {
      __emitter__P_133_0: null,
      _window: null,
      _currentOrientation: null,
      __onNativeWrapper__P_133_1: null,
      __nativeEventType__P_133_2: null,
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__onNativeWrapper__P_133_1 = qx.lang.Function.listener(this._onNative, this); // Handle orientation change event for Android devices by the resize event.
        // See http://stackoverflow.com/questions/1649086/detect-rotation-of-android-phone-in-the-browser-with-javascript
        // for more information.

        this.__nativeEventType__P_133_2 = qx.bom.Event.supportsEvent(this._window, "orientationchange") ? "orientationchange" : "resize";
        qx.bom.Event.addNativeListener(this._window, this.__nativeEventType__P_133_2, this.__onNativeWrapper__P_133_1);
      },
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        qx.bom.Event.removeNativeListener(this._window, this.__nativeEventType__P_133_2, this.__onNativeWrapper__P_133_1);
      },
      ...
      */
      ...
      _onNative: function _onNative(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          if (this.__emitter__P_133_0) {
            this.__emitter__P_133_0.emit("orientationchange", domEvent);
          }
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this.__manager__P_133_3 = this.__emitter__P_133_0 = null;
    }
  });
  qx.event.handler.OrientationCore.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=OrientationCore.js.map?dt=1625734500436