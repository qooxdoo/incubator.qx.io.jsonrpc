  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.GestureCore", {
    ...
    construct: function construct(target, emitter) {
      this.__defaultTarget__P_130_0 = target;
      this.__emitter__P_130_1 = emitter;
      this.__gesture__P_130_2 = {};
      this.__lastTap__P_130_3 = {};
      this.__stopMomentum__P_130_4 = {};
      this.__momentum__P_130_5 = {};
      this.__rollEvents__P_130_6 = [];

      this._initObserver();
    },
    members: {
      __defaultTarget__P_130_0: null,
      __emitter__P_130_1: null,
      __gesture__P_130_2: null,
      __eventName__P_130_7: null,
      __primaryTarget__P_130_8: null,
      __isMultiPointerGesture__P_130_9: null,
      __initialAngle__P_130_10: null,
      __lastTap__P_130_3: null,
      __rollImpulseId__P_130_11: null,
      __stopMomentum__P_130_4: null,
      __initialDistance__P_130_12: null,
      __momentum__P_130_5: null,
      __rollEvents__P_130_6: null,
      __rollEventsCountStart__P_130_13: 0,
      __rollEventsCount__P_130_14: 0,
      __touchPadDetectionPerformed__P_130_15: false,
      __lastRollEventTime__P_130_16: 0,
      ...
      _initObserver: function _initObserver() {
        qx.event.handler.GestureCore.GESTURE_EVENTS.forEach(function (gestureType) {
          qxWeb(this.__defaultTarget__P_130_0).on(gestureType, this.checkAndFireGesture, this);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          qxWeb(this.__defaultTarget__P_130_0).on("dblclick", this._onDblClick, this);
      ...
      _stopObserver: function _stopObserver() {
        qx.event.handler.GestureCore.GESTURE_EVENTS.forEach(function (pointerType) {
          qxWeb(this.__defaultTarget__P_130_0).off(pointerType, this.checkAndFireGesture, this);
        }.bind(this));

        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          qxWeb(this.__defaultTarget__P_130_0).off("dblclick", this._onDblClick, this);
        }
      ...
      gestureBegin: function gestureBegin(domEvent, target) {
        if (this.__gesture__P_130_2[domEvent.pointerId]) {
          this.__stopLongTapTimer__P_130_17(this.__gesture__P_130_2[domEvent.pointerId]);

          delete this.__gesture__P_130_2[domEvent.pointerId];
        }
        /*
        ...
        this.__gesture__P_130_2[domEvent.pointerId] = {
          ...
          "longTapTimer": window.setTimeout(this.__fireLongTap__P_130_18.bind(this, domEvent, target), qx.event.handler.GestureCore.LONGTAP_TIME)
        };

        if (domEvent.isPrimary) {
          this.__isMultiPointerGesture__P_130_9 = false;
          this.__primaryTarget__P_130_8 = target;

          this.__fireTrack__P_130_19("trackstart", domEvent, target);
        } else {
          this.__isMultiPointerGesture__P_130_9 = true;

          if (Object.keys(this.__gesture__P_130_2).length === 2) {
            this.__initialAngle__P_130_10 = this._calcAngle();
            this.__initialDistance__P_130_12 = this._calcDistance();
          }
        }
      },
      ...
      gestureMove: function gestureMove(domEvent, target) {
        var gesture = this.__gesture__P_130_2[domEvent.pointerId];
        ...
        if (gesture) {
          ...
          if (Object.keys(this.__gesture__P_130_2).length === 2) {
            this.__fireRotate__P_130_20(domEvent, gesture.target);

            this.__firePinch__P_130_21(domEvent, gesture.target);
          }

          if (!this.__isMultiPointerGesture__P_130_9) {
            this.__fireTrack__P_130_19("track", domEvent, gesture.target);
          ...
          if (gesture.isTap) {
            ...
            if (!gesture.isTap) {
              this.__stopLongTapTimer__P_130_17(gesture);
            }
          }
        }
      },
      ...
      _hasIntermediaryHandler: function _hasIntermediaryHandler(target) {
        while (target && target !== this.__defaultTarget__P_130_0) {
      ...
      gestureFinish: function gestureFinish(domEvent, target) {
        ...
        var gesture = this.__gesture__P_130_2[domEvent.pointerId]; // delete the long tap
        ...
        this.__handleRollImpulse__P_130_22(gesture.velocityX, gesture.velocityY, domEvent, gesture.target);

        this.__fireTrack__P_130_19("trackend", domEvent, gesture.target);
        ...
        if (gesture.isTap) {
          ...
          if (Object.keys(this.__lastTap__P_130_3).length > 0) {
            // delete old tap entries
            var limit = Date.now() - qx.event.handler.GestureCore.DOUBLETAP_TIME;

            for (var time in this.__lastTap__P_130_3) {
              if (time < limit) {
                delete this.__lastTap__P_130_3[time];
              } else {
                var lastTap = this.__lastTap__P_130_3[time];

                var isBelowDoubleTapDistance = this.__isBelowDoubleTapDistance__P_130_23(lastTap.x, lastTap.y, domEvent.clientX, domEvent.clientY, domEvent.getPointerType());
          ...
          if (!isDblTap) {
            this.__lastTap__P_130_3[Date.now()] = {
              x: domEvent.clientX,
              y: domEvent.clientY,
          ...
          var swipe = this.__getSwipeGesture__P_130_24(domEvent, target);
      ...
      stopMomentum: function stopMomentum(id) {
        this.__stopMomentum__P_130_4[id] = true;
      },
      ...
      gestureCancel: function gestureCancel(id) {
        if (this.__gesture__P_130_2[id]) {
          this.__stopLongTapTimer__P_130_17(this.__gesture__P_130_2[id]);

          delete this.__gesture__P_130_2[id];
        }

        if (this.__momentum__P_130_5[id]) {
          this.stopMomentum(this.__momentum__P_130_5[id]);
          delete this.__momentum__P_130_5[id];
        }
      },
      ...
      updateGestureTarget: function updateGestureTarget(id, target) {
        this.__gesture__P_130_2[id].target = target;
      },
       ...
       */
      __handleRollImpulse__P_130_22: function __handleRollImpulse__P_130_22(deltaX, deltaY, domEvent, target, time) {
        var oldTimeoutId = domEvent.timeoutId;

        if (!time && this.__momentum__P_130_5[domEvent.pointerId]) {
          // new roll impulse started, stop the old one
          this.stopMomentum(this.__momentum__P_130_5[domEvent.pointerId]);
        } // do nothing if we don't need to scroll


        if (Math.abs(deltaY) < 1 && Math.abs(deltaX) < 1 || this.__stopMomentum__P_130_4[oldTimeoutId] || !this.getWindow()) {
          delete this.__stopMomentum__P_130_4[oldTimeoutId];
          delete this.__momentum__P_130_5[domEvent.pointerId];
          return;
        }
        ...
        var timeoutId = qx.bom.AnimationFrame.request(qx.lang.Function.bind(function (deltaX, deltaY, domEvent, target, time) {
          this.__handleRollImpulse__P_130_22(deltaX, deltaY, domEvent, target, time);
        ...
        this.__momentum__P_130_5[domEvent.pointerId] = timeoutId;
      ...
      */
      _calcAngle: function _calcAngle() {
        ...
        for (var pointerId in this.__gesture__P_130_2) {
          var gesture = this.__gesture__P_130_2[pointerId];
       ...
       */
      __isBelowDoubleTapDistance__P_130_23: function __isBelowDoubleTapDistance__P_130_23(x1, y1, x2, y2, type) {
      ...
      */
      ...
      _fireEvent: function _fireEvent(domEvent, type, target) {
        ...
        if (!this.__defaultTarget__P_130_0) {
          return;
        }
        ...
        if (qx.core.Environment.get("event.dispatchevent")) {
        ...
        } else if (this.__emitter__P_130_1) {
          evt = new qx.event.type.dom.Custom(type, domEvent, {
            target: this.__defaultTarget__P_130_0,
            currentTarget: this.__defaultTarget__P_130_0,
            srcElement: this.__defaultTarget__P_130_0,
            swipe: domEvent.swipe,
            scale: domEvent.scale,
            angle: domEvent.angle,
            delta: domEvent.delta,
          ...
          this.__emitter__P_130_1.emit(type, domEvent);
        }
      },
       ...
       */
      __getSwipeGesture__P_130_24: function __getSwipeGesture__P_130_24(domEvent, target) {
        var gesture = this.__gesture__P_130_2[domEvent.pointerId];
       ...
       * @param target {Element} event target
       */
      __fireTrack__P_130_19: function __fireTrack__P_130_19(type, domEvent, target) {
       ...
       */
      __fireRollEvent__P_130_25: function __fireRollEvent__P_130_25(domEvent, target, rollFactor) {
        domEvent.delta = {
       ...
       * @param target {Element} event target
       */
      __performAdaptativeRollScrolling__P_130_26: function __performAdaptativeRollScrolling__P_130_26(target) {
        ...
        this.__lastRollEventTime__P_130_16 = new Date().getTime();
        var reLength = this.__rollEvents__P_130_6.length;

        for (var i = 0; i < reLength; i++) {
          var domEvent = this.__rollEvents__P_130_6[i];

          this.__fireRollEvent__P_130_25(domEvent, target, rollFactor);
        }
       ...
       */
      __endTouchPadDetection__P_130_27: function __endTouchPadDetection__P_130_27() {
        if (this.__rollEvents__P_130_6.length > qx.event.handler.GestureCore.TOUCHPAD_WHEEL_EVENTS_THRESHOLD) {
          qx.util.Wheel.IS_TOUCHPAD = true;
        } else {
          qx.util.Wheel.IS_TOUCHPAD = false;
        }

        this.__touchPadDetectionPerformed__P_130_15 = true;
      },
      ...
      _fireRoll: function _fireRoll(domEvent, type, target) {
        ...
        if (domEvent.type === qx.core.Environment.get("event.mousewheel").type) {
          if (this._isTouchPadDetectionEnabled()) {
            ...
            if (this.__lastRollEventTime__P_130_16 > 0 && now - this.__lastRollEventTime__P_130_16 > detectionTimeout) {
              // The detection timeout was reached. A new detection step should occur.
              this.__touchPadDetectionPerformed__P_130_15 = false;
              this.__rollEvents__P_130_6 = [];
              this.__lastRollEventTime__P_130_16 = 0;
            }

            if (!this.__touchPadDetectionPerformed__P_130_15) {
              ...
              if (this.__rollEvents__P_130_6.length === 0) {
                // detection starts
                this.__rollEventsCountStart__P_130_13 = now;
                qx.event.Timer.once(function () {
                  if (!this.__touchPadDetectionPerformed__P_130_15) {
                    ...
                    this.__endTouchPadDetection__P_130_27();

                    this.__performAdaptativeRollScrolling__P_130_26(target);
                  }
                }, this, qx.event.handler.GestureCore.TOUCHPAD_WHEEL_EVENTS_PERIOD + 50);
              }

              this.__rollEvents__P_130_6.push(domEvent);

              this.__rollEventsCount__P_130_14++;

              if (now - this.__rollEventsCountStart__P_130_13 > qx.event.handler.GestureCore.TOUCHPAD_WHEEL_EVENTS_PERIOD) {
                this.__endTouchPadDetection__P_130_27();
              }
            }
            ...
            this.__fireRollEvent__P_130_25(domEvent, target, qx.event.handler.GestureCore.ROLL_FACTOR);
          }
        } else {
          var gesture = this.__gesture__P_130_2[domEvent.pointerId];
          domEvent.delta = {
       ...
       * @param target {Element} event target
       */
      __fireRotate__P_130_20: function __fireRotate__P_130_20(domEvent, target) {
        if (!domEvent.isPrimary) {
          var angle = this._calcAngle();

          domEvent.angle = Math.round((angle - this.__initialAngle__P_130_10) % 360);

          this._fireEvent(domEvent, "rotate", this.__primaryTarget__P_130_8);
        }
      },
       ...
       * @param target {Element} event target
       */
      __firePinch__P_130_21: function __firePinch__P_130_21(domEvent, target) {
        if (!domEvent.isPrimary) {
          var distance = this._calcDistance();

          var scale = distance / this.__initialDistance__P_130_12;
          domEvent.scale = Math.round(scale * 100) / 100;

          this._fireEvent(domEvent, "pinch", this.__primaryTarget__P_130_8);
        }
      },
       ...
       * @param target {Element} event target
       */
      __fireLongTap__P_130_18: function __fireLongTap__P_130_18(domEvent, target) {
        var gesture = this.__gesture__P_130_2[domEvent.pointerId];
       ...
       */
      __stopLongTapTimer__P_130_17: function __stopLongTapTimer__P_130_17(gesture) {
      ...
      dispose: function dispose() {
        for (var gesture in this.__gesture__P_130_2) {
          this.__stopLongTapTimer__P_130_17(gesture);
        }

        this._stopObserver();

        this.__defaultTarget__P_130_0 = this.__emitter__P_130_1 = null;
      }
    }
  });
...
//# sourceMappingURL=GestureCore.js.map?dt=1608415594335