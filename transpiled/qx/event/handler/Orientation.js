  ...
  qx.Class.define("qx.event.handler.Orientation", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__window__P_132_1 = manager.getWindow();
    ...
    */
    members: {
      ...
      __nativeEventType__P_132_2: null,
      _currentOrientation: null,
      __onNativeWrapper__P_132_3: null,
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__onNativeWrapper__P_132_3 = qx.lang.Function.listener(this._onNative, this); // Handle orientation change event for Android devices by the resize event.
        // See http://stackoverflow.com/questions/1649086/detect-rotation-of-android-phone-in-the-browser-with-javascript
        // for more information.

        this.__nativeEventType__P_132_2 = qx.bom.Event.supportsEvent(this.__window__P_132_1, "orientationchange") ? "orientationchange" : "resize";
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__window__P_132_1, this.__nativeEventType__P_132_2, this.__onNativeWrapper__P_132_3);
      },
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__window__P_132_1, this.__nativeEventType__P_132_2, this.__onNativeWrapper__P_132_3);
      },
      ...
      */
      ...
      _onOrientationChange: function _onOrientationChange(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          qx.event.Registration.fireEvent(this.__window__P_132_1, "orientationchange", qx.event.type.Orientation, [orientation, mode]);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this.__manager__P_132_0 = this.__window__P_132_1 = null;
    },
...
//# sourceMappingURL=Orientation.js.map?dt=1625734500410