  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.Date", {
    statics: {
       ...
       * @internal
       */
      __mgr__P_179_0: qx.locale.Manager.getInstance(),
      ...
      getAmMarker: function getAmMarker(locale) {
        return this.__mgr__P_179_0.localize("cldr_am", [], locale);
      },
      ...
      getPmMarker: function getPmMarker(locale) {
        return this.__mgr__P_179_0.localize("cldr_pm", [], locale);
      },
      ...
      getDayNames: function getDayNames(length, locale, context, withFallback) {
        ...
        for (var i = 0; i < days.length; i++) {
          ...
          names.push(withFallback ? this.__localizeWithFallback__P_179_1(context, context === 'format' ? 'stand-alone' : 'format', key, locale) : this.__mgr__P_179_0.localize(key, [], locale));
        }
      ...
      getDayName: function getDayName(length, day, locale, context, withFallback) {
        ...
        return withFallback ? this.__localizeWithFallback__P_179_1(context, context === 'format' ? 'stand-alone' : 'format', key, locale) : this.__mgr__P_179_0.localize(key, [], locale);
      },
      ...
      getDateFormat: function getDateFormat(size, locale) {
        ...
        return this.__mgr__P_179_0.localize(key, [], locale);
      },
      ...
      getDateTimeFormat: function getDateTimeFormat(canonical, fallback, locale) {
        ...
        var localizedFormat = this.__mgr__P_179_0.localize(key, [], locale);
      ...
      _getTerritory: function _getTerritory(locale) {
        if (locale) {
          ...
          territory = this.__mgr__P_179_0.getTerritory() || this.__mgr__P_179_0.getLanguage();
        }
       ...
       *
       */
      __localizeWithFallback__P_179_1: function __localizeWithFallback__P_179_1(context, fallbackContext, key, locale) {
        var localizedString = this.__mgr__P_179_0.localize(key, [], locale);

        if (localizedString == key) {
          var newKey = key.replace('_' + context + '_', '_' + fallbackContext + '_');
          return this.__mgr__P_179_0.localize(newKey, [], locale);
        } else {
...
//# sourceMappingURL=Date.js.map?dt=1599343214967