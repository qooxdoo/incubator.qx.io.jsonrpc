  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Blocker", {
    statics: {
       ...
       */
      __attachBlocker__P_189_0: function __attachBlocker__P_189_0(item, color, opacity, zIndex) {
        ...
        if (!item.__blocker__P_189_1) {
          item.__blocker__P_189_1 = {
            div: qxWeb.create("<div class='qx-blocker' />")
          };
        }

        if (isDocument) {
          item.__blocker__P_189_1.div.insertBefore(qxWeb(win.document.body).getChildren(':first'));
        } else {
          item.__blocker__P_189_1.div.appendTo(win.document.body);
        }

        qx.module.Blocker.__styleBlocker__P_189_2(item, color, opacity, zIndex, isDocument);
      },
       ...
       */
      __styleBlocker__P_189_2: function __styleBlocker__P_189_2(item, color, opacity, zIndex, isDocument) {
        ...
        item.__blocker__P_189_1.div.setStyles(styles);
      },
       ...
       */
      __detachBlocker__P_189_3: function __detachBlocker__P_189_3(item, index) {
        if (!item.__blocker__P_189_1) {
          return;
        }

        item.__blocker__P_189_1.div.remove();
      },
       ...
       */
      __getBlocker__P_189_4: function __getBlocker__P_189_4(collection) {
        var blockerElements = qxWeb();
        collection.forEach(function (item, index) {
          if (typeof item.__blocker__P_189_1 !== "undefined") {
            blockerElements = blockerElements.concat(item.__blocker__P_189_1.div);
          }
        });
    ...
    members: {
      ...
      block: function block(color, opacity, zIndex) {
        ...
        this.forEach(function (item, index) {
          qx.module.Blocker.__attachBlocker__P_189_0(item, color, opacity, zIndex);
        });
        return this;
      },
      ...
      unblock: function unblock() {
        ...
        this.forEach(qx.module.Blocker.__detachBlocker__P_189_3);
        return this;
      },
      ...
      getBlocker: function getBlocker() {
        ...
        var collection = qx.module.Blocker.__getBlocker__P_189_4(this);
...
//# sourceMappingURL=Blocker.js.map?dt=1599343215583