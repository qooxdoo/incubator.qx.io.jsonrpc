  ...
  qx.Class.define("qx.ui.core.Widget", {
    ...
    */
    construct: function construct() {
      ...
      this.__contentElement__P_388_0 = this.__createContentElement__P_388_1(); // Initialize properties
    ...
    */
    statics: {
      ...
      __separatorPool__P_388_2: new qx.util.ObjectPool()
    },
    ...
    */
    members: {
      __contentElement__P_388_0: null,
      __initialAppearanceApplied__P_388_3: null,
      __toolTipTextListenerId__P_388_4: null,
      ...
      */
       ...
       */
      __layoutManager__P_388_5: null,
      // overridden
      _getLayout: function _getLayout() {
        return this.__layoutManager__P_388_5;
      },
      ...
      _setLayout: function _setLayout(layout) {
        ...
        if (this.__layoutManager__P_388_5) {
          this.__layoutManager__P_388_5.connectToWidget(null);
        }
        ...
        this.__layoutManager__P_388_5 = layout;
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (inner || changes.local || changes.margin) {
          if (this.__layoutManager__P_388_5 && this.hasLayoutChildren()) {
            ...
            this.__layoutManager__P_388_5.renderLayout(innerWidth, innerHeight, padding);
      ...
      ---------------------------------------------------------------------------
      */
      __separators__P_388_6: null,
      // overridden
      clearSeparators: function clearSeparators() {
        var reg = this.__separators__P_388_6;

        if (!reg) {
          return;
        }

        var pool = qx.ui.core.Widget.__separatorPool__P_388_2;
        var content = this.getContentElement();
        var widget;
      ...
      renderSeparator: function renderSeparator(separator, bounds) {
        // Insert
        var widget = qx.ui.core.Widget.__separatorPool__P_388_2.getObject(qx.ui.core.Widget);
        ...
        if (!this.__separators__P_388_6) {
          this.__separators__P_388_6 = [];
        }

        this.__separators__P_388_6.push(widget);
      },
      ...
      */
      ...
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        if (this.__layoutManager__P_388_5) {
          this.__layoutManager__P_388_5.invalidateLayoutCache();
        }
      },
      ...
      _getContentHint: function _getContentHint() {
        var layout = this.__layoutManager__P_388_5;
      ...
      */
       ...
       */
      __createContentElement__P_388_1: function __createContentElement__P_388_1() {
      ...
      getContentElement: function getContentElement() {
        return this.__contentElement__P_388_0;
      },
      ...
      */
      ...
      __widgetChildren__P_388_7: null,
      ...
      getLayoutChildren: function getLayoutChildren() {
        var children = this.__widgetChildren__P_388_7;

        if (!children) {
          return this.__emptyChildren__P_388_8;
        }
      ...
      _getChildren: function _getChildren() {
        return this.__widgetChildren__P_388_7 || this.__emptyChildren__P_388_8;
      },
      ...
      _add: function _add(child, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__widgetChildren__P_388_7, child);
        }

        if (this.__widgetChildren__P_388_7) {
          this.__widgetChildren__P_388_7.push(child);
        } else {
          this.__widgetChildren__P_388_7 = [child];
        }

        this.__addHelper__P_388_9(child, options);
      },
      ...
      _addAt: function _addAt(child, index, options) {
        if (!this.__widgetChildren__P_388_7) {
          this.__widgetChildren__P_388_7 = [];
        } // When moving in the same widget, remove widget first
        ...
        var ref = this.__widgetChildren__P_388_7[index];
        ...
        if (ref) {
          qx.lang.Array.insertBefore(this.__widgetChildren__P_388_7, child, ref);
        } else {
          this.__widgetChildren__P_388_7.push(child);
        }
      ...
      _addBefore: function _addBefore(child, before, options) {
        ...
        qx.lang.Array.insertBefore(this.__widgetChildren__P_388_7, child, before);
      ...
      _addAfter: function _addAfter(child, after, options) {
        ...
        qx.lang.Array.insertAfter(this.__widgetChildren__P_388_7, child, after);
      ...
      _remove: function _remove(child) {
        ...
        this.__removeHelper__P_388_10(child);
      },
      ...
      _removeAt: function _removeAt(index) {
        ...
        var child = this.__widgetChildren__P_388_7[index];
        qx.lang.Array.removeAt(this.__widgetChildren__P_388_7, index);
      ...
      _removeAll: function _removeAll() {
        ...
        var children = this.__widgetChildren__P_388_7.concat();

        this.__widgetChildren__P_388_7.length = 0;

        for (var i = children.length - 1; i >= 0; i--) {
          this.__removeHelper__P_388_10(children[i]);
        }
      ...
      */
       ...
       */
      __addHelper__P_388_9: function __addHelper__P_388_9(child, options) {
        {
       ...
       */
      __removeHelper__P_388_10: function __removeHelper__P_388_10(child) {
        {
        ...
        if (this.__layoutManager__P_388_5) {
          this.__layoutManager__P_388_5.invalidateChildrenCache();
        } // Add to layout queue
      ...
      */
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        this.__updateContentPadding__P_388_11(name, value);
      },
       ...
       */
      __updateContentPadding__P_388_11: function __updateContentPadding__P_388_11(style, value) {
        var content = this.getContentElement();
        var decorator = this.getDecorator();
        decorator = qx.theme.manager.Decoration.getInstance().resolve(decorator);
      ...
      */
      ...
      _applyToolTipText: function _applyToolTipText(value, old) {
        {
          if (this.__toolTipTextListenerId__P_388_4) {
            return;
          }

          var manager = qx.locale.Manager.getInstance();
          this.__toolTipTextListenerId__P_388_4 = manager.addListener("changeLocale", function () {
      ...
      */
      ...
      hasState: function hasState(state) {
        var states = this.__states__P_388_12;
      ...
      addState: function addState(state) {
        ...
        if (!states) {
          states = this.__states__P_388_12 = {};
        }
        ...
        this.__states__P_388_12[state] = true; // Fast path for hovered state
        ...
        var controls = this.__childControls__P_388_13;
      ...
      removeState: function removeState(state) {
        ...
        delete this.__states__P_388_12[state]; // Fast path for hovered state
      ...
      */
      ...
      syncAppearance: function syncAppearance() {
        var states = this.__states__P_388_12;
        var selector = this.__appearanceSelector__P_388_14;
        ...
        if (this.__updateSelector__P_388_15) {
          // Clear flag
          delete this.__updateSelector__P_388_15; // Check if the selector was created previously
        ...
        if (!selector) {
          ...
          this.__appearanceSelector__P_388_14 = selector;
        ...
        this.fireDataEvent("syncAppearance", this.__states__P_388_12);
      },
      // property apply
      ...
      checkAppearanceNeeds: function checkAppearanceNeeds() {
        ...
        if (!this.__initialAppearanceApplied__P_388_3) {
          qx.ui.core.queue.Appearance.add(this);
          this.__initialAppearanceApplied__P_388_3 = true;
      ...
      updateAppearance: function updateAppearance() {
        // Clear selector
        this.__updateSelector__P_388_15 = true; // Add to appearance queue
      ...
      */
      ...
      hasChildControl: function hasChildControl(id) {
        if (!this.__childControls__P_388_13) {
          return false;
        }

        return !!this.__childControls__P_388_13[id];
      },

      /** @type {Map} Map of instantiated child controls */
      __childControls__P_388_13: null,
      ...
      _getCreatedChildControls: function _getCreatedChildControls() {
        return this.__childControls__P_388_13;
      },
      ...
      getChildControl: function getChildControl(id, notcreate) {
        if (!this.__childControls__P_388_13) {
          ...
          this.__childControls__P_388_13 = {};
        }

        var control = this.__childControls__P_388_13[id];
      ...
      _releaseChildControl: function _releaseChildControl(id) {
        ...
        delete this.__childControls__P_388_13[id];
        return control;
      },
      ...
      _createChildControl: function _createChildControl(id) {
        if (!this.__childControls__P_388_13) {
          this.__childControls__P_388_13 = {};
        } else if (this.__childControls__P_388_13[id]) {
        ...
        return this.__childControls__P_388_13[id] = control;
      },
      ...
      _disposeChildControls: function _disposeChildControls() {
        ...
        delete this.__childControls__P_388_13;
      },
    ...
    */
    destruct: function destruct() {
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        {
          if (this.__toolTipTextListenerId__P_388_4) {
            qx.locale.Manager.getInstance().removeListenerById(this.__toolTipTextListenerId__P_388_4);
          }
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        ...
        this.__separators__P_388_6 = null;
      } else {
        this._disposeArray("__separators__P_388_6");
      } // Clear children array


      this._disposeArray("__widgetChildren__P_388_7"); // Cleanup map of appearance states


      this.__states__P_388_12 = this.__childControls__P_388_13 = null; // Dispose layout manager and HTML elements

      this._disposeObjects("__layoutManager__P_388_5", "__contentElement__P_388_0");
    }
  });
  qx.ui.core.Widget.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Widget.js.map?dt=1599463039272