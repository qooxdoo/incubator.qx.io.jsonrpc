(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.FocusHandler", {
    ...
    */
    members: {
      __roots__P_372_0: null,
      __activeChild__P_372_1: null,
      __focusedChild__P_372_2: null,
      __currentRoot__P_372_3: null,
      ...
      connectTo: function connectTo(root) {
        ...
        root.addListener("keypress", this.__onKeyPress__P_372_4, this);
      ...
      addRoot: function addRoot(widget) {
        ...
        this.__roots__P_372_0[widget.toHashCode()] = widget;
      },
      ...
      removeRoot: function removeRoot(widget) {
        ...
        delete this.__roots__P_372_0[widget.toHashCode()];
      },
      ...
      getActiveWidget: function getActiveWidget() {
        return this.__activeChild__P_372_1;
      },
      ...
      isActive: function isActive(widget) {
        return this.__activeChild__P_372_1 == widget;
      },
      ...
      getFocusedWidget: function getFocusedWidget() {
        return this.__focusedChild__P_372_2;
      },
      ...
      isFocused: function isFocused(widget) {
        return this.__focusedChild__P_372_2 == widget;
      },
      ...
      isFocusRoot: function isFocusRoot(widget) {
        return !!this.__roots__P_372_0[widget.toHashCode()];
      },
      ...
      */
      ...
      _onActivate: function _onActivate(e) {
        ...
        this.__activeChild__P_372_1 = target; //this.debug("active: " + target);

        var root = this.__findFocusRoot__P_372_5(target);

        if (root != this.__currentRoot__P_372_3) {
          this.__currentRoot__P_372_3 = root;
        }
      },
      ...
      _onDeactivate: function _onDeactivate(e) {
        ...
        if (this.__activeChild__P_372_1 == target) {
          this.__activeChild__P_372_1 = null;
        }
      },
      ...
      _onFocusIn: function _onFocusIn(e) {
        ...
        if (target != this.__focusedChild__P_372_2) {
          this.__focusedChild__P_372_2 = target;
      ...
      _onFocusOut: function _onFocusOut(e) {
        ...
        if (target == this.__focusedChild__P_372_2) {
          this.__focusedChild__P_372_2 = null;
       ...
       */
      __onKeyPress__P_372_4: function __onKeyPress__P_372_4(e) {
        if (e.getKeyIdentifier() != "Tab" || !this.isUseTabNavigation()) {
          return;
        }

        if (!this.__currentRoot__P_372_3) {
          return;
        ...
        var current = this.__focusedChild__P_372_2;

        if (!e.isShiftPressed()) {
          var next = current ? this.__getWidgetAfter__P_372_6(current) : this.__getFirstWidget__P_372_7();
        } else {
          var next = current ? this.__getWidgetBefore__P_372_8(current) : this.__getLastWidget__P_372_9();
      ...
      */
       ...
       */
      __findFocusRoot__P_372_5: function __findFocusRoot__P_372_5(widget) {
        var roots = this.__roots__P_372_0;
      ...
      */
       ...
       */
      __compareTabOrder__P_372_10: function __compareTabOrder__P_372_10(widget1, widget2) {
        if (widget1 === widget2) {
          return 0;
       ...
       *    the current root.
       */
      __getFirstWidget__P_372_7: function __getFirstWidget__P_372_7() {
        return this.__getFirst__P_372_11(this.__currentRoot__P_372_3, null);
      },
       ...
       *    the current root.
       */
      __getLastWidget__P_372_9: function __getLastWidget__P_372_9() {
        return this.__getLast__P_372_12(this.__currentRoot__P_372_3, null);
      },
       ...
       */
      __getWidgetAfter__P_372_6: function __getWidgetAfter__P_372_6(widget) {
        var root = this.__currentRoot__P_372_3;

        if (root == widget) {
          return this.__getFirstWidget__P_372_7();
        }
        ...
        this.__collectAllAfter__P_372_13(root, widget, result);

        result.sort(this.__compareTabOrder__P_372_10);
        var len = result.length;
        return len > 0 ? result[0] : this.__getFirstWidget__P_372_7();
      },
       ...
       * @return {qx.ui.core.Widget} The found widget.
       */
      __getWidgetBefore__P_372_8: function __getWidgetBefore__P_372_8(widget) {
        var root = this.__currentRoot__P_372_3;

        if (root == widget) {
          return this.__getLastWidget__P_372_9();
        }
        ...
        this.__collectAllBefore__P_372_14(root, widget, result);

        result.sort(this.__compareTabOrder__P_372_10);
        var len = result.length;
        return len > 0 ? result[len - 1] : this.__getLastWidget__P_372_9();
      },
      ...
      */
       ...
       */
      __collectAllAfter__P_372_13: function __collectAllAfter__P_372_13(parent, widget, result) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable() && this.__compareTabOrder__P_372_10(widget, child) < 0) {
              result.push(child);
            }

            this.__collectAllAfter__P_372_13(child, widget, result);
          }
        }
      },
       ...
       * @param result {Array} Result list
       */
      __collectAllBefore__P_372_14: function __collectAllBefore__P_372_14(parent, widget, result) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            ...
            this.__collectAllBefore__P_372_14(child, widget, result);
          }
        }
      },
       ...
       */
      __getFirst__P_372_11: function __getFirst__P_372_11(parent, firstWidget) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (firstWidget == null || this.__compareTabOrder__P_372_10(child, firstWidget) < 0) {
                firstWidget = child;
              }
            } // Deep iteration into children hierarchy


            firstWidget = this.__getFirst__P_372_11(child, firstWidget);
          }
        }
       ...
       */
      __getLast__P_372_12: function __getLast__P_372_12(parent, lastWidget) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (lastWidget == null || this.__compareTabOrder__P_372_10(child, lastWidget) > 0) {
                lastWidget = child;
              }
            } // Deep iteration into children hierarchy


            lastWidget = this.__getLast__P_372_12(child, lastWidget);
          }
        }
    ...
    */
    destruct: function destruct() {
      this._disposeMap("__roots__P_372_0");

      this.__focusedChild__P_372_2 = this.__activeChild__P_372_1 = this.__currentRoot__P_372_3 = null;
    }
  });
  qx.ui.core.FocusHandler.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FocusHandler.js.map?dt=1625734524189