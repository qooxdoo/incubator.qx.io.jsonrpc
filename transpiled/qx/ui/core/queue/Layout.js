  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function remove(widget) {
        delete this.__queue__P_390_0[widget.toHashCode()];
      },
      ...
      add: function add(widget) {
        this.__queue__P_390_0[widget.toHashCode()] = widget;
      ...
      */
      isScheduled: function isScheduled(widget) {
        return !!this.__queue__P_390_0[widget.toHashCode()];
      },
      ...
      flush: function flush() {
        ...
        var queue = this.__getSortedQueue__P_390_2(); // iterate in reversed order to process widgets with the smallest nesting
      ...
      getNestingLevel: function getNestingLevel(widget) {
        var cache = this.__nesting__P_390_1;
        var level = 0;
       ...
       */
      __getLevelGroupedWidgets__P_390_3: function __getLevelGroupedWidgets__P_390_3() {
        var VisibilityQueue = qx.ui.core.queue.Visibility; // clear cache

        this.__nesting__P_390_1 = {}; // sparse level array
       ...
       */
      __getSortedQueue__P_390_2: function __getSortedQueue__P_390_2() {
        var sortedQueue = [];

        var levels = this.__getLevelGroupedWidgets__P_390_3();
...
//# sourceMappingURL=Layout.js.map?dt=1599343235103