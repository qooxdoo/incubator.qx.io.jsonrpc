  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__lookup__P_393_1[widget.toHashCode()]) {
          delete this.__lookup__P_393_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__queue__P_393_0, widget);
        }

        delete this.__data__P_393_2[widget.toHashCode()];
      },
      ...
      isVisible: function isVisible(widget) {
        return this.__data__P_393_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __computeVisible__P_393_3: function __computeVisible__P_393_3(widget) {
        var data = this.__data__P_393_2;
        ...
        if (widget.isExcluded()) {
          ...
          if (parent) {
            visible = this.__computeVisible__P_393_3(parent);
          } else {
      ...
      add: function add(widget) {
        ...
        this.__queue__P_393_0.unshift(widget);

        this.__lookup__P_393_1[widget.toHashCode()] = widget;
      ...
      flush: function flush() {
        ...
        var data = this.__data__P_393_2; // Dynamically add children to queue
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          if (data[hash] == null) {
            this.__computeVisible__P_393_3(widget);
...
//# sourceMappingURL=Visibility.js.map?dt=1599462408378