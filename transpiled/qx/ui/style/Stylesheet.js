  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    construct: function construct() {
      ...
      this.__sheet__P_506_0 = qx.bom.Stylesheet.createElement();
      this.__rules__P_506_1 = [];
    },
    members: {
      __rules__P_506_1: null,
      __sheet__P_506_0: null,
      ...
      addRule: function addRule(selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__sheet__P_506_0, selector, css);

        this.__rules__P_506_1.push(selector);
      },
      ...
      hasRule: function hasRule(selector) {
        return this.__rules__P_506_1.indexOf(selector) != -1;
      },
      ...
      removeRule: function removeRule(selector) {
        delete this.__rules__P_506_1[this.__rules__P_506_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__sheet__P_506_0, selector);
      }
    }
  });
...
//# sourceMappingURL=Stylesheet.js.map?dt=1599312859597