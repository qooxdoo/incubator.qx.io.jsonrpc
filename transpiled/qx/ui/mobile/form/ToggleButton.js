  ...
  qx.Class.define("qx.ui.mobile.form.ToggleButton", {
    ...
    construct: function construct(value, labelChecked, labelUnchecked) {
      ...
      if (labelChecked && labelUnchecked) {
        this.__labelUnchecked__P_471_0 = labelUnchecked;
        this.__labelChecked__P_471_1 = labelChecked;
      }

      this._setAttribute("data-label-checked", this.__labelChecked__P_471_1);

      this._setAttribute("data-label-unchecked", this.__labelUnchecked__P_471_0);

      this.__switch__P_471_2 = this._createSwitch();

      this._add(this.__switch__P_471_2);
    ...
    members: {
      __switch__P_471_2: null,
      __value__P_471_3: false,
      __labelUnchecked__P_471_0: "OFF",
      __labelChecked__P_471_1: "ON",
      __lastToggleTimestamp__P_471_4: 0,
      ...
      _onSwipe: function _onSwipe(evt) {
        if (this._checkLastPointerTime()) {
          ...
          if (direction == "left") {
            if (this.__value__P_471_3 == true) {
              this.toggle();
            }
          } else {
            if (this.__value__P_471_3 == false) {
              this.toggle();
            }
          }
        }
      ...
      _checkLastPointerTime: function _checkLastPointerTime() {
        var elapsedTime = new Date().getTime() - this.__lastToggleTimestamp__P_471_4;

        this.__lastToggleTimestamp__P_471_4 = new Date().getTime();
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__switch__P_471_2", "__labelUnchecked__P_471_0", "__labelChecked__P_471_1");
    }
  });
  qx.ui.mobile.form.ToggleButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ToggleButton.js.map?dt=1606150632628