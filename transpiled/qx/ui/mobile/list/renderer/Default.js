  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.renderer.Default", {
    ...
    members: {
      ...
      __subtitle__P_477_2: null,
      __rightContainer__P_477_3: null,
      ...
      getSubtitleWidget: function getSubtitleWidget() {
        return this.__subtitle__P_477_2;
      },
      ...
      setSubtitle: function setSubtitle(subtitle) {
        if (subtitle && subtitle.translate) {
          this.__subtitle__P_477_2.setValue(subtitle.translate());
        } else {
          this.__subtitle__P_477_2.setValue(subtitle);
        }
      },
      ...
      _init: function _init() {
        ...
        this.__rightContainer__P_477_3 = this._createRightContainer();
        this.add(this.__rightContainer__P_477_3, {
          flex: 1
        });
        this.__title__P_477_1 = this._createTitle();

        this.__rightContainer__P_477_3.add(this.__title__P_477_1);

        this.__subtitle__P_477_2 = this._createSubtitle();

        this.__rightContainer__P_477_3.add(this.__subtitle__P_477_2);
      },
      ...
      reset: function reset() {
        ...
        this.__subtitle__P_477_2.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__image__P_477_0", "__title__P_477_1", "__subtitle__P_477_2", "__rightContainer__P_477_3");
    }
  });
  qx.ui.mobile.list.renderer.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1606238639664