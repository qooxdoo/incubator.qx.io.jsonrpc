    ...
    members: {
      ...
      */
      ...
      getCellWidget: function getCellWidget(row, column) {
        ...
        widget.addListener("changeOpen", this.__onOpenChanged__P_532_0, this);
      ...
      poolCellWidget: function poolCellWidget(widget) {
        widget.removeListener("changeOpen", this.__onOpenChanged__P_532_0, this);
      ...
      */
       ...
       */
      __onOpenChanged__P_532_0: function __onOpenChanged__P_532_0(event) {
...
//# sourceMappingURL=WidgetProvider.js.map?dt=1599343246326