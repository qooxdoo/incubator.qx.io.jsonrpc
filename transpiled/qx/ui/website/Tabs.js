(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Tabs", {
    ...
    members: {
      __mediaQueryListener__P_557_0: null,
      init: function init() {
        ...
        buttons._forEachElementWrapped(function (button) {
          ...
          if (page.length > 0) {
            ...
            if (orientation == "vertical") {
              this.__deactivateTransition__P_557_1(page);
          ...
          this.__activateTransition__P_557_2(page);
        }.bind(this));
        ...
        if (active.length > 0) {
          ...
          this.__deactivateTransition__P_557_1(activePage);

          this._showPage(active, null);

          this.__activateTransition__P_557_2(activePage);
        }
      ...
      _initMediaQueryListener: function _initMediaQueryListener(mediaQuery) {
        var mql = this.__mediaQueryListener__P_557_0;

        if (!mql) {
          mql = q.matchMedia(mediaQuery);
          this.__mediaQueryListener__P_557_0 = mql;
       ...
       */
      __deactivateTransition__P_557_1: function __deactivateTransition__P_557_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __activateTransition__P_557_2: function __activateTransition__P_557_2(elem) {
      ...
      dispose: function dispose() {
        this.__mediaQueryListener__P_557_0 = undefined;
...
//# sourceMappingURL=Tabs.js.map?dt=1625734539127