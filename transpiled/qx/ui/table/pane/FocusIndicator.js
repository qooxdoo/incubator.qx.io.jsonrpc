  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.pane.FocusIndicator", {
    ...
    construct: function construct(scroller) {
      ...
      this.__scroller__P_514_0 = scroller;
    ...
    members: {
      ...
      moveToCell: function moveToCell(col, row, editing) {
        ...
        if (!this.__scroller__P_514_0.getShowCellFocusIndicator() && !this.__scroller__P_514_0.getTable().getTableModel().isColumnEditable(col)) {
          this.exclude();
          return;
        } else {
          this.show();
        ...
        if (col == null) {
          ...
          var xPos = this.__scroller__P_514_0.getTablePaneModel().getX(col);
          ...
          if (xPos === -1) {
            ...
            var table = this.__scroller__P_514_0.getTable();

            var columnModel = table.getTableColumnModel();

            var paneModel = this.__scroller__P_514_0.getTablePaneModel();

            var firstRow = this.__scroller__P_514_0.getTablePane().getFirstVisibleRow();
            ...
            if (editing && this.__scroller__P_514_0.getMinCellEditHeight() && this.__scroller__P_514_0.getMinCellEditHeight() > userHeight) {
              userTop -= Math.floor((this.__scroller__P_514_0.getMinCellEditHeight() - userHeight) / 2);
              userHeight = this.__scroller__P_514_0.getMinCellEditHeight();
            }
    ...
    destruct: function destruct() {
      this.__scroller__P_514_0 = null;
    }
  });
  qx.ui.table.pane.FocusIndicator.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FocusIndicator.js.map?dt=1625734535153