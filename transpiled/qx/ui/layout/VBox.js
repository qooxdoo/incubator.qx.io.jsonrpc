  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    members: {
      ...
      */
      ...
      __rebuildCache__P_438_4: function __rebuildCache__P_438_4() {
        ...
        var reuse = this.__heights__P_438_0 && this.__heights__P_438_0.length != length && this.__flexs__P_438_1 && this.__heights__P_438_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var heights = reuse ? this.__heights__P_438_0 : new Array(length);
        ...
        if (!reuse) {
          this.__heights__P_438_0 = heights;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        for (i = 0; i < length; i += 1) {
          percent = this.__heights__P_438_0[i];
        ...
        if (this.__enableFlex__P_438_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var percent = this.__heights__P_438_0[i];
    ...
    */
    destruct: function destruct() {
      this.__heights__P_438_0 = this.__flexs__P_438_1 = this.__children__P_438_3 = null;
    }
  });
  qx.ui.layout.VBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox.js.map?dt=1599343239221