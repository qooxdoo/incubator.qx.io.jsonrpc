  ...
  qx.Class.define("qx.ui.layout.HBox", {
    ...
    members: {
      ...
      */
      ...
      __rebuildCache__P_436_4: function __rebuildCache__P_436_4() {
        ...
        var reuse = this.__widths__P_436_0 && this.__widths__P_436_0.length != length && this.__flexs__P_436_1 && this.__widths__P_436_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var widths = reuse ? this.__widths__P_436_0 : new Array(length);
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        for (i = 0; i < length; i += 1) {
          percent = this.__widths__P_436_0[i];
        ...
        if (this.__enableFlex__P_436_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var percent = this.__widths__P_436_0[i];
    ...
    */
    destruct: function destruct() {
      this.__widths__P_436_0 = this.__flexs__P_436_1 = this.__children__P_436_3 = null;
    }
  });
  qx.ui.layout.HBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HBox.js.map?dt=1599343239074