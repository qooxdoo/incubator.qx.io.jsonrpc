(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.HBox", {
    ...
    */
    members: {
      __widths__P_437_0: null,
      __flexs__P_437_1: null,
      __enableFlex__P_437_2: null,
      __children__P_437_3: null,
      ...
      */
      ...
      __rebuildCache__P_437_4: function __rebuildCache__P_437_4() {
        ...
        var reuse = this.__widths__P_437_0 && this.__widths__P_437_0.length != length && this.__flexs__P_437_1 && this.__widths__P_437_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var widths = reuse ? this.__widths__P_437_0 : new Array(length);
        var flexs = reuse ? this.__flexs__P_437_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__widths__P_437_0 = widths;
          this.__flexs__P_437_1 = flexs;
        }

        this.__enableFlex__P_437_2 = enableFlex;
        this.__children__P_437_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        var children = this.__children__P_437_3;
        var length = children.length;
        ...
        for (i = 0; i < length; i += 1) {
          percent = this.__widths__P_437_0[i];
        ...
        if (this.__enableFlex__P_437_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;

          for (i = 0; i < length; i += 1) {
            flex = this.__flexs__P_437_1[i];
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        var children = this.__children__P_437_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__flexs__P_437_1[i];
          var percent = this.__widths__P_437_0[i];
    ...
    */
    destruct: function destruct() {
      this.__widths__P_437_0 = this.__flexs__P_437_1 = this.__children__P_437_3 = null;
    }
  });
  qx.ui.layout.HBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HBox.js.map?dt=1599462412411