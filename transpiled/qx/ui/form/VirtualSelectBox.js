  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualSelectBox", {
    ...
    construct: function construct(model) {
      ...
      this.__bindings__P_425_0 = [];
      this.initSelection(this.getChildControl("dropdown").getSelection());
      this.__searchTimer__P_425_1 = new qx.event.Timer(500);

      this.__searchTimer__P_425_1.addListener("interval", this.__preselect__P_425_2, this);

      this.getSelection().addListener("change", this._updateSelectionValue, this);

      if (this.isIncrementalSearch()) {
        this.__initIncrementalSearch__P_425_3();
      }

      this.initHtmlMarkers(['<span style="' + this.__getHighlightStyleFromAppearance__P_425_4() + '">', '</span>']);
    },
    properties: {
      // overridden
      appearance: {
    ...
    members: {
      ...
      */
      ...
      _addBindings: function _addBindings() {
        ...
        this.__bindings__P_425_0.push(id);
      ...
      _removeBindings: function _removeBindings() {
        while (this.__bindings__P_425_0.length > 0) {
          var id = this.__bindings__P_425_0.pop();
      ...
      */
      ...
      _handleKeyboard: function _handleKeyboard(event) {
        ...
        switch (action) {
          case "search":
            if (!this.isIncrementalSearch()) {
              this.__searchValue__P_425_6 += this.__convertKeyIdentifier__P_425_7(event.getKeyIdentifier());

              this.__searchTimer__P_425_1.restart();
            }
      ...
      */
       ...
       * __searchValue value.
       */
      __preselect__P_425_2: function __preselect__P_425_2() {
        this.__searchTimer__P_425_1.stop();

        var searchValue = this.__searchValue__P_425_6;
       ...
       */
      __convertKeyIdentifier__P_425_7: function __convertKeyIdentifier__P_425_7(keyIdentifier) {
      ...
      ---------------------------------------------------------------------------
      */
      __filterValue__P_425_8: null,
      __lastMatch__P_425_9: '',
      // prevent recursion problems when deleting unsucessful filtering
      __filterUpdateRunning__P_425_10: 0,
      __filterInput__P_425_11: null,
      __highlightMarkers__P_425_12: null,
      _highlightFilterValueFunction: null,
      _searchRegExp: null,
      __addFilterInput__P_425_13: function __addFilterInput__P_425_13() {
        var input = this.__filterInput__P_425_11 = new qx.ui.form.TextField().set({
          appearance: 'widget',
          liveUpdate: true,
          height: 0,
          width: 1 // must be > 0
        ...
        input.addListener('changeValue', function (e) {
          if (this.__filterUpdateRunning__P_425_10 === 0) {
            this.__updateDelegate__P_425_14();
          }
        }, this);
      },
      __getHighlightStyleFromAppearance__P_425_4: function __getHighlightStyleFromAppearance__P_425_4() {
      ...
      _highlightFilterValuePlainFunction: function _highlightFilterValuePlainFunction(parts) {
        ...
        return parts[1] + this.__highlightMarkers__P_425_12[0] + parts[2] + this.__highlightMarkers__P_425_12[1] + parts[3];
      },
      ...
      _highlightFilterValueHtmlFunction: function _highlightFilterValueHtmlFunction(parts) {
        ...
        return qx.module.util.String.escapeHtml(parts[1]) + this.__highlightMarkers__P_425_12[0] + qx.module.util.String.escapeHtml(parts[2]) + this.__highlightMarkers__P_425_12[1] + qx.module.util.String.escapeHtml(parts[3]);
      },
      ...
      __updateDelegate__P_425_14: function __updateDelegate__P_425_14(lastFilterValue) {
        this.__filterUpdateRunning__P_425_10++;
        var filterValue = lastFilterValue !== undefined ? lastFilterValue : this.__filterInput__P_425_11.getValue();
        this.__filterValue__P_425_8 = filterValue; // _searchRegExp is used in default _searchMatch function to avoid recreation of regexp object
        // for each list item
        ...
        if (item) {
          this.__lastMatch__P_425_9 = filterValue;
          this.getSelection().setItem(0, item);
        } else {
          var len = filterValue.length;
          var last = len > this.__lastMatch__P_425_9.length + 1 ? this.__filterInput__P_425_11.getValue().charAt(len - 1) : '';
          filterValue = this.__lastMatch__P_425_9 + last;

          this.__updateDelegate__P_425_14(filterValue);
        } // make sure length of dropdown is updated


        this.__filterUpdateRunning__P_425_10--;
      },
      __initIncrementalSearch__P_425_3: function __initIncrementalSearch__P_425_3() {
        // add search input field
        this.__addFilterInput__P_425_13(); // set label converter
        ...
        labelOptions.converter = function (data, model, source, target) {
          var filterValue = that.__filterValue__P_425_8;
      ...
      _applyHighlightMode: function _applyHighlightMode(value, old) {
        switch (value) {
          case 'html':
            ...
            this.__highlightMarkers__P_425_12 = this.getHtmlMarkers();
            break;

          case 'plain':
            this._highlightFilterValueFunction = this._highlightFilterValuePlainFunction;
            this.__highlightMarkers__P_425_12 = this.getPlainMarkers();
            break;
      ...
      __applyMarkers__P_425_5: function __applyMarkers__P_425_5(value, old) {
        this.__highlightMarkers__P_425_12 = value; // make sure we have strings for both markers

        if (value.length < 1) {
          this.__highlightMarkers__P_425_12[0] = '';
        } // this most likely won't work for HTML highlighting


        if (value.length < 2) {
          this.__highlightMarkers__P_425_12[1] = this.__highlightMarkers__P_425_12[0];
        }
      },
      _applyIncrementalSearch: function _applyIncrementalSearch(value, old) {
        if (value) {
          ...
          this.__searchTimer__P_425_1.setEnabled(false);

          this.__initIncrementalSearch__P_425_3();
        } else {
          this.__searchTimer__P_425_1.setEnabled(true);
        }
      }
    },
    destruct: function destruct() {
      ...
      this.__searchTimer__P_425_1.removeListener("interval", this.__preselect__P_425_2, this);

      this.__searchTimer__P_425_1.dispose();

      this.__searchTimer__P_425_1 = null;
    }
  });
  qx.ui.form.VirtualSelectBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VirtualSelectBox.js.map?dt=1625734528219