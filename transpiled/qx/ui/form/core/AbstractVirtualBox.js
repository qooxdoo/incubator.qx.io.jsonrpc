  ...
  qx.Class.define("qx.ui.form.core.AbstractVirtualBox", {
    ...
    construct: function construct(model) {
      ...
      if (model != null) {
        ...
        this.__defaultModel__P_430_0 = new qx.data.Array();
        this.initModel(this.__defaultModel__P_430_0);
      }
    },
    properties: {
      // overridden
    ...
    destruct: function destruct() {
      if (this.__defaultModel__P_430_0) {
        this.__defaultModel__P_430_0.dispose();
      }
    }
  });
...
//# sourceMappingURL=AbstractVirtualBox.js.map?dt=1606211373950