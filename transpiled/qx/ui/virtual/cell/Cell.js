  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.Cell", {
    ...
    construct: function construct() {
      ...
      this.__stylesheet__P_540_0 = qx.ui.virtual.cell.CellStylesheet.getInstance();
      this.__userStyles__P_540_1 = {};
      this.__themeStyles__P_540_2 = {};
      this.__userPaddings__P_540_3 = {};
      this.__themePaddings__P_540_4 = {};
      this.__states__P_540_5 = {};
      this.__themeValues__P_540_6 = {};
      this.initAppearance();

      this.__initializeThemableProperties__P_540_7();
    },
    ...
    */
    members: {
      ...
      __themableProperties__P_540_8: null,

      /** @type {String} Unique key over the current set of states */
      __statesKey__P_540_9: null,
      __states__P_540_5: null,
      __themeValues__P_540_6: null,
      __themeStyles__P_540_2: null,
      __userStyles__P_540_1: null,
      __userPaddings__P_540_3: null,
      __themePaddings__P_540_4: null,
      __isThemed__P_540_10: false,
      __stylesheet__P_540_0: null,

      /**
       * Collect all themable properties, which are not CSS properties
       */
      __initializeThemableProperties__P_540_7: function __initializeThemableProperties__P_540_7() {
        var PropertyUtil = qx.util.PropertyUtil;
        var cssProperties = qx.lang.Object.fromArray(this._getCssProperties());
        this.__themableProperties__P_540_8 = [];
        ...
        while (clazz) {
          ...
          for (var prop in properties) {
            if (!cssProperties[prop]) {
              this.__themableProperties__P_540_8.push(prop);
            }
          }
      ...
      _storeStyle: function _storeStyle(propertyName, styles) {
        ...
        if (this.__isThemed__P_540_10) {
          store = this.__themeStyles__P_540_2;
        } else {
          store = this.__userStyles__P_540_1;
        }
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        if (this.__isThemed__P_540_10) {
          var paddingStore = this.__themePaddings__P_540_4;
        } else {
          paddingStore = this.__userPaddings__P_540_3;
        }
      ...
      */
      ...
      getCellProperties: function getCellProperties(value, states) {
        this.__setStates__P_540_11(states);
      ...
      getCssClasses: function getCssClasses(value, states) {
        var cssClass = this.__stylesheet__P_540_0.getCssClass(this.__statesKey__P_540_9) || "";
       ...
       */
      __setStates__P_540_11: function __setStates__P_540_11(states) {
        ...
        if (this.__statesKey__P_540_9 == statesKey) {
          return;
        }

        this.__statesKey__P_540_9 = statesKey;
        var themeStyles = this.__states__P_540_5[this.__statesKey__P_540_9];

        if (!themeStyles) {
          this.__clearThemedPropertyValues__P_540_12();

          this.__updateThemeableProperties__P_540_13(states);

          this.__computeCssClassForStates__P_540_14(states);

          this.__cacheThemedValues__P_540_15();

          this.__states__P_540_5[this.__statesKey__P_540_9] = 1;
        }

        this.__applyThemeValues__P_540_16();
      },

      /**
       * Remove the themed value from all CSS properties
       */
      __clearThemedPropertyValues__P_540_12: function __clearThemedPropertyValues__P_540_12() {
        var PropertyUtil = qx.util.PropertyUtil;
       ...
       * @param states {Object} A map containing the cell's state names as map keys.
       */
      __updateThemeableProperties__P_540_13: function __updateThemeableProperties__P_540_13(states) {
        this.__themeStyles__P_540_2 = {};
        this.__isThemed__P_540_10 = true;
        var appearance = this.getAppearance();
        var PropertyUtil = qx.util.PropertyUtil;
        ...
        this.__isThemed__P_540_10 = false;
      },

      /**
       * Compute a CSS class for the current values of all CSS properties
       */
      __computeCssClassForStates__P_540_14: function __computeCssClassForStates__P_540_14() {
        var styleString = Object.values(this.__themeStyles__P_540_2).join(";");

        this.__stylesheet__P_540_0.computeClassForStyles(this.__statesKey__P_540_9, styleString);
      },

      /**
       * Cache the themed values for the current state combination
       */
      __cacheThemedValues__P_540_15: function __cacheThemedValues__P_540_15() {
        var properties = this.__themableProperties__P_540_8;
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = {};
        ...
        this.__themeValues__P_540_6[this.__statesKey__P_540_9] = themeValues;
      },

      /**
       * Apply the themed values to the properties
       */
      __applyThemeValues__P_540_16: function __applyThemeValues__P_540_16() {
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = this.__themeValues__P_540_6[this.__statesKey__P_540_9] || {};
      ...
      getStyles: function getStyles(value, states) {
        return Object.values(this.__userStyles__P_540_1).join(";");
      },
      // overridden
      getInsets: function getInsets(value, states) {
        var user = this.__userPaddings__P_540_3;
        var theme = this.__themePaddings__P_540_4;
    ...
    destruct: function destruct() {
      this.__stylesheet__P_540_0 = this.__userStyles__P_540_1 = this.__themeStyles__P_540_2 = this.__userPaddings__P_540_3 = this.__themePaddings__P_540_4 = this.__states__P_540_5 = this.__themeValues__P_540_6 = this.__themableProperties__P_540_8 = null;
    }
  });
  qx.ui.virtual.cell.Cell.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Cell.js.map?dt=1599343247001