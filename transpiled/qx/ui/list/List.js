  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.list.List", {
    ...
    construct: function construct(model) {
      ...
      this.__defaultGroups__P_437_0 = new qx.data.Array();
      this.initGroups(this.__defaultGroups__P_437_0);
    ...
    members: {
      ...
      _init: function _init() {
        ...
        this.__lookupTable__P_437_1 = [];
        this.__lookupTableForGroup__P_437_2 = [];
        this.__groupHashMap__P_437_3 = {};
        this.__groupStringsUsed__P_437_4 = false;
        this.__groupObjectsUsed__P_437_5 = false;
        this.__defaultGroupUsed__P_437_6 = false;
      ...
      */
      ...
      _getLookupTable: function _getLookupTable() {
        return this.__lookupTable__P_437_1;
      },
      ...
      _lookup: function _lookup(row) {
        return this.__lookupTable__P_437_1[row];
      },
      ...
      _lookupGroup: function _lookupGroup(row) {
        return this.__lookupTableForGroup__P_437_2.indexOf(row);
      },
      ...
      _reverseLookup: function _reverseLookup(index) {
        ...
        return this.__lookupTable__P_437_1.indexOf(index);
      },
      ...
      */
      ...
      _applyGroupRowHeight: function _applyGroupRowHeight(value, old) {
        this.__updateGroupRowHeight__P_437_9();
      },
      // apply method
      ...
      */
      ...
      _onLayerUpdated: function _onLayerUpdated() {
        ...
        if (this.__deferredLayerUpdate__P_437_7 === null) {
          this.__deferredLayerUpdate__P_437_7 = new qx.util.DeferredCall(function () {
            this._setRowItemSize();
          }, this);
        }

        this.__deferredLayerUpdate__P_437_7.schedule();
      },
      ...
      */
       ...
       */
      __updateRowCount__P_437_10: function __updateRowCount__P_437_10() {
        this.getPane().getRowConfig().setItemCount(this.__lookupTable__P_437_1.length);
        this.getPane().fullUpdate();
      },
       ...
       */
      __updateGroupRowHeight__P_437_9: function __updateGroupRowHeight__P_437_9() {
        /*
        ...
        if (gh) {
          for (var i = 0, l = this.__lookupTable__P_437_1.length; i < l; ++i) {
            if (this.__lookupTable__P_437_1[i] == -1) {
              rc.setItemSize(i, gh);
            }
          }
        }
       ...
       */
      __buildUpLookupTable__P_437_8: function __buildUpLookupTable__P_437_8() {
        this.__lookupTable__P_437_1 = [];
        this.__lookupTableForGroup__P_437_2 = [];
        this.__groupHashMap__P_437_3 = {};
        ...
        this.__updateRowCount__P_437_10();
      },
      ...
      _runDelegateFilter: function _runDelegateFilter(model) {
        ...
        for (var i = 0, l = model.length; i < l; ++i) {
          if (filter == null || filter(model.getItem(i))) {
            this.__lookupTable__P_437_1.push(i);
          }
        }
      },
      ...
      _runDelegateSorter: function _runDelegateSorter(model) {
        if (this.__lookupTable__P_437_1.length == 0) {
          return;
        }
        ...
        if (sorter != null) {
          this.__lookupTable__P_437_1.sort(function (a, b) {
      ...
      _runDelegateGroup: function _runDelegateGroup(model) {
        ...
        if (groupMethod != null) {
          for (var i = 0, l = this.__lookupTable__P_437_1.length; i < l; ++i) {
            var index = this.__lookupTable__P_437_1[i];
            var item = this.getModel().getItem(index);
            var group = groupMethod(item);

            this.__addGroup__P_437_11(group, index);
          }

          this.__lookupTable__P_437_1 = this.__createLookupFromGroup__P_437_12();
        }
      },
       ...
       */
      __addGroup__P_437_11: function __addGroup__P_437_11(group, index) {
        // if group is null add to default group
        if (group == null) {
          this.__defaultGroupUsed__P_437_6 = true;
          group = "???";
        }

        var name = this.__getUniqueGroupName__P_437_13(group);

        if (this.__groupHashMap__P_437_3[name] == null) {
          this.__groupHashMap__P_437_3[name] = [];
        ...
        this.__groupHashMap__P_437_3[name].push(index);
      },
       ...
       */
      __createLookupFromGroup__P_437_12: function __createLookupFromGroup__P_437_12() {
        this.__checkGroupStructure__P_437_14();
        ...
        for (var i = 0; i < groups.getLength(); i++) {
          ...
          this.__lookupTableForGroup__P_437_2.push(row);

          row++;

          var key = this.__getUniqueGroupName__P_437_13(group);

          var groupMembers = this.__groupHashMap__P_437_3[key];
       ...
       */
      __getUniqueGroupName__P_437_13: function __getUniqueGroupName__P_437_13(group) {
        var name = null;

        if (!qx.lang.Type.isString(group)) {
          var index = this.getGroups().indexOf(group);
          this.__groupObjectsUsed__P_437_5 = true;
          name = "group";
          ...
          this.__groupStringsUsed__P_437_4 = true;
          var name = group;
        }
       ...
       */
      __checkGroupStructure__P_437_14: function __checkGroupStructure__P_437_14() {
        if (this.__groupObjectsUsed__P_437_5 && this.__defaultGroupUsed__P_437_6 || this.__groupObjectsUsed__P_437_5 && this.__groupStringsUsed__P_437_4) {
    ...
    destruct: function destruct() {
      this._disposeObjects("__deferredLayerUpdate__P_437_7");
      ...
      this._background = this._provider = this._layer = this.__lookupTable__P_437_1 = this.__lookupTableForGroup__P_437_2 = this.__groupHashMap__P_437_3 = null;

      if (this.__defaultGroups__P_437_0) {
        this.__defaultGroups__P_437_0.dispose();
      }
    }
  });
...
//# sourceMappingURL=List.js.map?dt=1625734529477