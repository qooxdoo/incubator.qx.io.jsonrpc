    ...
    */
    statics: {
      ...
      getApplication: function getApplication() {
        return this.__application__P_74_0 || null;
      },
      ...
      ready: function ready() {
        ...
        if (clazz) {
          this.__application__P_74_0 = new clazz();
          var start = new Date();

          this.__application__P_74_0.main();

          qx.log.Logger.debug(this, "Main runtime: " + (new Date() - start) + "ms");
          var start = new Date();

          this.__application__P_74_0.finalize();
       ...
       */
      __close__P_74_1: function __close__P_74_1(e) {
        var app = this.__application__P_74_0;
       ...
       *
       */
      __shutdown__P_74_2: function __shutdown__P_74_2() {
        var app = this.__application__P_74_0;
...
//# sourceMappingURL=BaseInit.js.map?dt=1600416835266