  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.data.store.Json", {
    ...
    members: {
      ...
      __data__P_240_1: null,
      __propertyNames__P_240_2: null,

      /**
       * @lint ignoreDeprecated(eval)
       */
      setUp: function setUp() {
        this.__store__P_240_0 = new qx.data.store.Json();
        this.__data__P_240_1 = eval("({s: 'String', n: 12, b: true})");
        this.__propertyNames__P_240_2 = ["s", "n", "b"];
      ...
      tearDown: function tearDown() {
        ...
        this.__store__P_240_0.dispose(); // Remove the former created classes
      ...
      testLoadUrl: function testLoadUrl() {
        this.__store__P_240_0.addListener("loaded", function () {
          this.resume(function () {
            var model = this.__store__P_240_0.getModel();
        ...
        this.__store__P_240_0.setUrl(url);
      ...
      testProgressStates: function testProgressStates() {
        ...
        this.__store__P_240_0.addListener("changeState", function (evt) {
      ...
      testLoadResource: function testLoadResource() {
        ...
        this.__store__P_240_0.setUrl(resource);

        this.wait();
      },
      testParseErrorForResource: function testParseErrorForResource() {
        this.__store__P_240_0.addListener("parseError", function (ev) {
          this.resume(function () {
      ...
      testLoadAlias: function testLoadAlias() {
        ...
        this.__store__P_240_0.setUrl(alias);

        this.wait();
      },
      testDispose: function testDispose() {
        this.__store__P_240_0.setUrl(this.url);
      ...
      testOwnClassWith: function testOwnClassWith() {
        ...
        this.__store__P_240_0 = new qx.data.store.Json(null, delegate);
      ...
      testDisposeOldModel: function testDisposeOldModel() {
        this.__store__P_240_0.addListener("loaded", function () {
          this.resume(function () {
            var model = this.__store__P_240_0.getModel(); // check if the new model is not the old model
        ...
        this.__store__P_240_0.setModel(fakeModel);
      ...
      testErrorEvent: function testErrorEvent() {
        this.__store__P_240_0.addListener("error", function (ev) {
          this.resume(function () {
            this.assertNotNull(ev);
          }, this);
        }, this);

        this.__store__P_240_0.setUrl("not-found");
      ...
      "test Internal Server Error": function testInternalServerError() {
        ...
        this.__store__P_240_0.addListener("error", function (e) {
          this.resume(function () {
        ...
        qx.event.Timer.once(function () {
          this.__store__P_240_0.setUrl("/foo");
...
//# sourceMappingURL=Json.js.map?dt=1599312837410