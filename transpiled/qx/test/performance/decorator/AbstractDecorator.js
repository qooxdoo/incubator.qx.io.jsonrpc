  ...
  qx.Class.define("qx.test.performance.decorator.AbstractDecorator", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__el__P_270_0 = qx.dom.Element.create("div", {
          "id": "testRoot"
        });
        document.body.appendChild(this.__el__P_270_0);
      },
      tearDown: function tearDown() {
        document.body.removeChild(this.__el__P_270_0);
        this.__el__P_270_0 = null;
      },
      createDivs: function createDivs(count) {
        ...
        this.__el__P_270_0.appendChild(container);
...
//# sourceMappingURL=AbstractDecorator.js.map?dt=1598908871345