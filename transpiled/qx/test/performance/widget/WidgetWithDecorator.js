(function () {
  ...
  qx.Class.define("qx.test.performance.widget.WidgetWithDecorator", {
    ...
    construct: function construct() {
      ...
      this.__decorator__P_267_0 = new qx.ui.decoration.Decorator().set({
        width: 1,
        style: "solid",
        color: "red"
      });
    ...
    members: {
      _createWidget: function _createWidget() {
        return new qx.ui.core.Widget().set({
          decorator: this.__decorator__P_267_0
        });
      }
    }
  });
...
//# sourceMappingURL=WidgetWithDecorator.js.map?dt=1599462398015