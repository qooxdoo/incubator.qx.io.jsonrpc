(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.bom.Template", {
    ...
    members: {
      __tmpl__P_215_0: null,
      tearDown: function tearDown() {
        if (this.__tmpl__P_215_0) {
          qx.dom.Element.removeChild(this.__tmpl__P_215_0, document.body);
        }
      },
      ...
      testGet: function testGet() {
        // add template
        this.__tmpl__P_215_0 = qx.dom.Element.create("div");
        qx.bom.element.Attribute.set(this.__tmpl__P_215_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__tmpl__P_215_0, "display", "none");
        this.__tmpl__P_215_0.innerHTML = "<div>{{a}}</div>";
        qx.dom.Element.insertEnd(this.__tmpl__P_215_0, document.body); // test the get method
      ...
      testPlainText: function testPlainText() {
        ...
        qx.bom.element.Attribute.set(this.__tmpl__P_215_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__tmpl__P_215_0, "display", "none");
        this.__tmpl__P_215_0.innerHTML = "{{a}}.{{b}}";
        qx.dom.Element.insertEnd(this.__tmpl__P_215_0, document.body); // test the get method
      ...
      testGetMixed: function testGetMixed() {
        ...
        qx.bom.element.Attribute.set(this.__tmpl__P_215_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__tmpl__P_215_0, "display", "none");
        this.__tmpl__P_215_0.innerHTML = "<div>{{a}}<span>{{b}}</span></div>";
        qx.dom.Element.insertEnd(this.__tmpl__P_215_0, document.body); // test the get method
...
//# sourceMappingURL=Template.js.map?dt=1599343217999