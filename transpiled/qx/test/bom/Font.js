  ...
  qx.Class.define("qx.test.bom.Font", {
    ...
    members: {
      ...
      testItalic: function testItalic() {
        this.__font__P_208_0.setItalic(true);
      ...
      testDecorationUnderline: function testDecorationUnderline() {
        this.__font__P_208_0.setDecoration("underline");
      ...
      testDecorationLineThrough: function testDecorationLineThrough() {
        this.__font__P_208_0.setDecoration("line-through");
      ...
      testDecorationOverline: function testDecorationOverline() {
        this.__font__P_208_0.setDecoration("overline");
      ...
      testFontFamily: function testFontFamily() {
        this.__font__P_208_0.setFamily(["Arial"]);
      ...
      testFontFamilyMultipleWords: function testFontFamilyMultipleWords() {
        this.__font__P_208_0.setFamily(['Times New Roman']);
      ...
      testLineHeight: function testLineHeight() {
        this.__font__P_208_0.setLineHeight(1.5);
      ...
      testSize: function testSize() {
        this.__font__P_208_0.setSize(20);
      ...
      testColor: function testColor() {
        this.__font__P_208_0.setColor("red");
      ...
      testTextShadow: function testTextShadow() {
        ...
        this.__font__P_208_0.setTextShadow("red 1px 1px 3px, green -1px -1px 3px, white -1px 1px 3px, white 1px -1px 3px");
      ...
      testColorAtWidget: function testColorAtWidget() {
        this.__font__P_208_0.setColor("#ff0000");

        var label = new qx.ui.basic.Label("myLabel");
        label.setFont(this.__font__P_208_0);
      ...
      testGetStyles: function testGetStyles() {
        var styles = this.__font__P_208_0.getStyles(); // we expect a map with only 'fontFamily' set, otherwise the null values
      ...
      testGetSomeStyles: function testGetSomeStyles() {
        ...
        this.__font__P_208_0.setColor("#3f3f3f");
...
//# sourceMappingURL=Font.js.map?dt=1599343217658