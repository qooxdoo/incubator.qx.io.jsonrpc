  ...
  qx.Class.define("qx.test.bom.rest.Resource", {
    ...
    members: {
      ...
      setUpDoubleRequest: function setUpDoubleRequest() {
        ...
        this.__reqs__P_223_0 = this.__reqs__P_223_0 || [];

        this.__reqs__P_223_0.push(this.req);
      ...
      tearDown: function tearDown() {
        ...
        this.__reqs__P_223_0.forEach(function (req) {
          req.dispose();
        });
      },
      //
      ...
      respondSubsequent: function respondSubsequent(response, reqIdx, shouldStubResp) {
        ...
        Object.keys(this.res).forEach(function (propName) {
          if (propName.indexOf("____P_223_1") === 0 && "get" in this.res[propName] && qx.lang.Type.isArray(this.res[propName].get) && qx.lang.Type.isObject(this.res[propName].get[0]) && "$$hash" in this.res[propName].get[0]) {
            requests = propName;
          }
        }, this);
...
//# sourceMappingURL=Resource.js.map?dt=1599312834849