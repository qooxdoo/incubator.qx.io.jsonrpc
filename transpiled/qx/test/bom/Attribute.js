(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.bom.Attribute", {
    ...
    members: {
      __maxLengthValues__P_206_0: null,
      setUp: function setUp() {
        ...
        this.__maxLengthValues__P_206_0 = {
          "mshtml": 2147483647,
          "default": -1
        };
      },
      ...
      testGetAttribute: function testGetAttribute() {
        ...
        if (qx.core.Environment.get("browser.name") == "edge") {
          this.assertEquals(Attribute.get(this._input, "maxLength"), this.__maxLengthValues__P_206_0.mshtml);
        } else if (qx.core.Environment.get("browser.name") == "chrome" || qx.core.Environment.get("browser.name") == "safari") {
          this.assertEquals(Attribute.get(this._input, "maxLength"), this.__maxLengthValues__P_206_0["default"]);
        } else {
      ...
      testRemoveAttribute: function testRemoveAttribute() {
        ...
        var maxLengthValue = qx.core.Environment.select("engine.name", this.__maxLengthValues__P_206_0);

        if (qx.core.Environment.get("browser.name") == "edge") {
          maxLengthValue = this.__maxLengthValues__P_206_0.mshtml;
        } else if (qx.core.Environment.get("browser.name") == "chrome" || qx.core.Environment.get("browser.name") == "safari") {
          maxLengthValue = this.__maxLengthValues__P_206_0["default"];
        }
...
//# sourceMappingURL=Attribute.js.map?dt=1599312833223