  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.io.part.ClosurePart", {
    ...
    members: {
      ...
      __timeout__P_252_1: null,
      __loader__P_252_2: null,
      setUp: function setUp() {
        qx.test.PART_FILES = [];
        qx.test.Part.LOAD_ORDER = [];
        this.__dummyLoader__P_252_0 = new qx.test.io.part.MockLoader();
        this.__loader__P_252_2 = new qx.Part(this.__dummyLoader__P_252_0);
        qx.Part.$$instance = this.__loader__P_252_2;
        this.__timeout__P_252_1 = qx.Part.TIMEOUT;
        qx.Part.TIMEOUT = 3000;
      },
      tearDown: function tearDown() {
        qx.Part.$$instance = undefined;
        qx.Part.TIMEOUT = this.__timeout__P_252_1;
      },
      loadPackage: function loadPackage(part, pkg) {
        pkg.loadClosure(this.__loader__P_252_2.notifyPackageResult, this.__loader__P_252_2);
      },
      "test: load part with one package": function testLoadPartWithOnePackage() {
        ...
        var part = new qx.io.part.ClosurePart("juhu", [pkg], this.__loader__P_252_2);

        this.__loader__P_252_2.addToPackage(pkg);
      ...
      "test: load part with two packages": function testLoadPartWithTwoPackages() {
        ...
        var part = new qx.io.part.ClosurePart("juhu", [pkg1, pkg2], this.__loader__P_252_2);

        this.__loader__P_252_2.addToPackage(pkg1);

        this.__loader__P_252_2.addToPackage(pkg2);
      ...
      "test: load part with three packages and delay": function testLoadPartWithThreePackagesAndDelay() {
        ...
        this.__loader__P_252_2.addToPackage(pkg3);

        var part = new qx.io.part.ClosurePart("juhu", [pkg1, pkg2, pkg3], this.__loader__P_252_2);
        var self = this;
        part.load(function (readyState) {
          self.resume(function () {
      ...
      "test: load part with an error package": function testLoadPartWithAnErrorPackage() {
        ...
        var part = new qx.io.part.ClosurePart("juhu", [pkg1], this.__loader__P_252_2);
...
//# sourceMappingURL=ClosurePart.js.map?dt=1599312838709