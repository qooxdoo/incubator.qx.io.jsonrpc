(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.io.part.Part", {
    ...
    members: {
      __loader__P_255_0: null,
      setUp: function setUp() {
        qx.test.Part.LOAD_ORDER = [];
        this.__dummyLoader__P_255_1 = new qx.test.io.part.MockLoader();
        this.__loader__P_255_0 = new qx.Part(this.__dummyLoader__P_255_1);
        qx.Part.$$instance = this.__loader__P_255_0;
      },
      tearDown: function tearDown() {
        this.__loader__P_255_0 = null;
      ...
      "test: load part with one package": function testLoadPartWithOnePackage() {
        ...
        var part = this.createPart("1", [pkg], this.__loader__P_255_0);
      ...
      "test: load part with several packages": function testLoadPartWithSeveralPackages() {
        ...
        var part = this.createPart("1", packages, this.__loader__P_255_0);
        var self = this;
        part.load(function (readyState) {
          self.resume(function () {
      ...
      "test: one already loaded package should not be loaded again and preserve order": function testOneAlreadyLoadedPackageShouldNotBeLoadedAgainAndPreserveOrder() {
        ...
        var self = this;
        var oldLoadPackage = this.__loader__P_255_0.loadPackage;

        this.__loader__P_255_0.loadPackage = function (pkg) {
          if (pkg == packages[0]) {
            self.fail();
          } else {
      ...
      "test: a currently loading package should not be loaded again and should preserve order": function testACurrentlyLoadingPackageShouldNotBeLoadedAgainAndShouldPreserveOrder() {
        ...
        packages[1].load(this.__loader__P_255_0.notifyPackageResult, this.__loader__P_255_0); // now in loading state
      ...
      "test: loading a loaded part again should not reload the packages": function testLoadingALoadedPartAgainShouldNotReloadThePackages() {
        ...
        var self = this;
        part.load(function (readyState) {
          self.__loader__P_255_0.loadPackage = function () {
            self.fail();
          };
      ...
      "test: load part with several packages including wrapped": function testLoadPartWithSeveralPackagesIncludingWrapped() {
        ...
        this.__loader__P_255_0.addToPackage(packages[0]);

        this.__loader__P_255_0.addToPackage(packages[1]);

        this.__loader__P_255_0.addToPackage(packages[2]);
...
//# sourceMappingURL=Part.js.map?dt=1599312838824