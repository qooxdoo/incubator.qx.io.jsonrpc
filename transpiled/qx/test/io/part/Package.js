(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.io.part.Package", {
    ...
    members: {
      __dummyLoader__P_254_0: null,
      setUp: function setUp() {
        qx.test.PART_FILES = [];
        this.__dummyLoader__P_254_0 = new qx.test.io.part.MockLoader();
      },
      ...
      "test: loading a closure package with load() should execute the closure": function testLoadingAClosurePackageWithLoadShouldExecuteTheClosure() {
        ...
        var loader = new qx.Part(this.__dummyLoader__P_254_0);
...
//# sourceMappingURL=Package.js.map?dt=1599312838780