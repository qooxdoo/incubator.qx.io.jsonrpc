(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.theme.simple.Appearance", {
    ...
    members: {
      __obj__P_277_0: qx.theme.simple.Appearance.appearances,
      testLabel: function testLabel() {
        var obj = this.__obj__P_277_0.label;
      ...
      testImage: function testImage() {
        var obj = this.__obj__P_277_0.image;
        var states = {
          replacement: false,
          disabled: true
        };
      ...
      testRoot: function testRoot() {
        var obj = this.__obj__P_277_0.root;
        var style = obj.style();
      ...
      testPopup: function testPopup() {
        var obj = this.__obj__P_277_0.popup;
        var style = obj.style();
      ...
      testTooltip: function testTooltip() {
        var obj = this.__obj__P_277_0.tooltip;
        var style = obj.style();
      ...
      testTooltipError: function testTooltipError() {
        var obj = this.__obj__P_277_0["tooltip-error"];
        var style = obj.style();
      ...
      testIframe: function testIframe() {
        var obj = this.__obj__P_277_0.iframe;
        var style = obj.style();
      ...
      testMoveFrame: function testMoveFrame() {
        var obj = this.__obj__P_277_0["move-frame"];
        var style = obj.style();
        this.assertIdentical("main-dark", style.decorator);
      },
      testDragDropCursor: function testDragDropCursor() {
        var obj = this.__obj__P_277_0["dragdrop-cursor"];
        var states = {
          copy: true,
          move: true,
          alias: true
      ...
      testSlideBarButtonForward: function testSlideBarButtonForward() {
        var style = this.__obj__P_277_0["slidebar/button-forward"].style;
      ...
      testSlideBarButtonBackward: function testSlideBarButtonBackward() {
        var style = this.__obj__P_277_0["slidebar/button-backward"].style;
      ...
      testTableStatusBar: function testTableStatusBar() {
        var style = this.__obj__P_277_0["table/statusbar"].style();
      ...
      testTableColumnButton: function testTableColumnButton() {
        var style = this.__obj__P_277_0["table/column-button"].style();
      ...
      testTableScrollerFocusIndicator: function testTableScrollerFocusIndicator() {
        var style = this.__obj__P_277_0["table-scroller/focus-indicator"].style();

        this.assertIdentical("main", style.decorator);
      },
      testTableScrollerResizeLine: function testTableScrollerResizeLine() {
        var style = this.__obj__P_277_0["table-scroller/resize-line"].style();
      ...
      testTableHeaderCell: function testTableHeaderCell() {
        var styleFunc = this.__obj__P_277_0["table-header-cell"].style;
        var states = {
          first: true,
          disabled: true,
          sorted: true,
      ...
      testTableHeaderCellIcon: function testTableHeaderCellIcon() {
        var style = this.__obj__P_277_0["table-header-cell/icon"].style();

        this.assertIdentical(5, style.paddingRight);
      },
      testTableHeaderCellSortIcon: function testTableHeaderCellSortIcon() {
        var style = this.__obj__P_277_0["table-header-cell/sort-icon"].style();
      ...
      testTableEditorTextField: function testTableEditorTextField() {
        var style = this.__obj__P_277_0["table-editor-textfield"].style();
      ...
      testTableEditorSelectBox: function testTableEditorSelectBox() {
        var style = this.__obj__P_277_0["table-editor-selectbox"].style();

        this.assertArrayEquals([0, 2], style.padding);
      },
      testTableEditorComboBox: function testTableEditorComboBox() {
        var style = this.__obj__P_277_0["table-editor-combobox"].style();

        this.assertUndefined(style.decorator);
      },
      testProgressiveTableHeader: function testProgressiveTableHeader() {
        var style = this.__obj__P_277_0["progressive-table-header"].style();
      ...
      testProgressiveTableHeaderCell: function testProgressiveTableHeaderCell() {
        var style = this.__obj__P_277_0["progressive-table-header-cell"].style();
      ...
      testTreeVirtual: function testTreeVirtual() {
        var styleFunc = this.__obj__P_277_0["treevirtual"].style;
        var superStyles = {
          padding: [3, 4]
        };
      ...
      testTreeVirtualFolder: function testTreeVirtualFolder() {
        var styleFunc = this.__obj__P_277_0["treevirtual-folder"].style;
        var states = {
          opened: true,
          drag: true
        };
      ...
      testTreeVirtualFile: function testTreeVirtualFile() {
        var styleFunc = this.__obj__P_277_0["treevirtual-file"].style;
      ...
      testTreeVirtualLine: function testTreeVirtualLine() {
        var style = this.__obj__P_277_0["treevirtual-line"].style();
      ...
      testTreeVirtualContract: function testTreeVirtualContract() {
        var style = this.__obj__P_277_0["treevirtual-contract"].style();
      ...
      testTreeVirtualExpand: function testTreeVirtualExpand() {
        var style = this.__obj__P_277_0["treevirtual-expand"].style();
      ...
      testTreeVirtualOnlyContract: function testTreeVirtualOnlyContract() {
        var style = this.__obj__P_277_0["treevirtual-only-contract"].style();
      ...
      testTreeVirtualOnlyExpand: function testTreeVirtualOnlyExpand() {
        var style = this.__obj__P_277_0["treevirtual-only-expand"].style();
      ...
      testTreeVirtualStartContract: function testTreeVirtualStartContract() {
        var style = this.__obj__P_277_0["treevirtual-start-contract"].style();
      ...
      testTreeVirtualStartExpand: function testTreeVirtualStartExpand() {
        var style = this.__obj__P_277_0["treevirtual-start-expand"].style();
      ...
      testTreeVirtualEndContract: function testTreeVirtualEndContract() {
        var style = this.__obj__P_277_0["treevirtual-end-contract"].style();
      ...
      testTreeVirtualEndExpand: function testTreeVirtualEndExpand() {
        var style = this.__obj__P_277_0["treevirtual-end-expand"].style();
      ...
      testTreeVirtualCrossContract: function testTreeVirtualCrossContract() {
        var style = this.__obj__P_277_0["treevirtual-cross-contract"].style();
      ...
      testTreeVirtualCrossExpand: function testTreeVirtualCrossExpand() {
        var style = this.__obj__P_277_0["treevirtual-cross-expand"].style();
      ...
      testTreeVirtualEnd: function testTreeVirtualEnd() {
        var style = this.__obj__P_277_0["treevirtual-end"].style();
      ...
      testTreeVirtualCross: function testTreeVirtualCross() {
        var style = this.__obj__P_277_0["treevirtual-cross"].style();
      ...
      testSplitpaneSlider: function testSplitpaneSlider() {
        var style = this.__obj__P_277_0["splitpane/slider"].style();
      ...
      testMenu: function testMenu() {
        var styleFunc = this.__obj__P_277_0["menu"].style;
        var states = {
          submenu: true,
          contextmenu: true
        };
      ...
      testMenuSlideBarButton: function testMenuSlideBarButton() {
        var styleFunc = this.__obj__P_277_0["menu-slidebar-button"].style;
        var style = styleFunc({
          hovered: true
        });
      ...
      testMenuSlideBarButtonBackward: function testMenuSlideBarButtonBackward() {
        var styleFunc = this.__obj__P_277_0["menu-slidebar/button-backward"].style;
        var style = styleFunc({
          hovered: true
        });
      ...
      testMenuSlideBarButtonForward: function testMenuSlideBarButtonForward() {
        var styleFunc = this.__obj__P_277_0["menu-slidebar/button-forward"].style;
        var style = styleFunc({
          hovered: true
        });
      ...
      testMenuSeparator: function testMenuSeparator() {
        var style = this.__obj__P_277_0["menu-separator"].style();
      ...
      testMenuButton: function testMenuButton() {
        var styleFunc = this.__obj__P_277_0["menu-button"].style;
      ...
      testMenuButtonIcon: function testMenuButtonIcon() {
        var style = this.__obj__P_277_0["menu-button/icon"].style();

        this.assertIdentical("middle", style.alignY);
      },
      testMenuButtonLabel: function testMenuButtonLabel() {
        var style = this.__obj__P_277_0["menu-button/label"].style();

        this.assertIdentical("middle", style.alignY);
        this.assertIdentical(1, style.padding);
      },
      testMenuButtonShortcut: function testMenuButtonShortcut() {
        var style = this.__obj__P_277_0["menu-button/shortcut"].style();
      ...
      testMenuButtonArrow: function testMenuButtonArrow() {
        var styleFunc = this.__obj__P_277_0["menu-button/arrow"].style;
        var states = {
          selected: true
        };
        var style = styleFunc(states);
      ...
      testMenuCheckbox: function testMenuCheckbox() {
        var styleFunc = this.__obj__P_277_0["menu-checkbox"].style;
        var states = {
          checked: true,
          selected: true
        };
      ...
      testMenuRadioButton: function testMenuRadioButton() {
        var styleFunc = this.__obj__P_277_0["menu-radiobutton"].style;
        var states = {
          checked: true,
          selected: true
        };
      ...
      testMenuBar: function testMenuBar() {
        var style = this.__obj__P_277_0["menubar"].style();

        this.assertIdentical("light-background", style.backgroundColor);
        this.assertArrayEquals([4, 2], style.padding);
      },
      testMenuBarButton: function testMenuBarButton() {
        var styleFunc = this.__obj__P_277_0["menubar-button"].style;
        var states = {
          disabled: false,
          pressed: true,
          hovered: false
      ...
      testGroupItem: function testGroupItem() {
        var style = this.__obj__P_277_0["group-item"].style();
      ...
      testVirtualTree: function testVirtualTree() {
        var style = this.__obj__P_277_0["virtual-tree"].style();

        this.assertIdentical(21, style.itemHeight);
      },
      testCell: function testCell() {
        var styleFunc = this.__obj__P_277_0["cell"].style;
        var style = styleFunc({
          selected: true
        });
      ...
      testCellNumber: function testCellNumber() {
        var style = this.__obj__P_277_0["cell-number"].style();
...
//# sourceMappingURL=Appearance.js.map?dt=1592867903604