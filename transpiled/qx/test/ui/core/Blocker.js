(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.core.Blocker", {
    ...
    members: {
      __blocker__P_290_0: null,
      setUp: function setUp() {
        qx.test.ui.core.Blocker.prototype.setUp.base.call(this);
        this.__blocker__P_290_0 = new qx.ui.core.Blocker(this.getRoot());

        this.__blocker__P_290_0.setColor("green");

        this.__blocker__P_290_0.setOpacity(0.5);
      },
      tearDown: function tearDown() {
        qx.test.ui.core.Blocker.prototype.tearDown.base.call(this);

        this.__blocker__P_290_0.dispose();
      },
      testBlocker: function testBlocker() {
        var blockerElement = this.__blocker__P_290_0.getBlockerElement();

        this.__blocker__P_290_0.block();

        this.flush();
        this.assertTrue(this.__blocker__P_290_0.isBlocked(), "isBlocked()");
        this.assertTrue(blockerElement.isIncluded(), "isIncluded()");

        this.__blocker__P_290_0.unblock();

        this.flush();
        this.assertFalse(this.__blocker__P_290_0.isBlocked(), "isBlocked()");
      ...
      testForceUnblock: function testForceUnblock() {
        ...
        this.__blocker__P_290_0.forceUnblock();
      ...
      testBlockedEvent: function testBlockedEvent() {
        this.__blockedEventFired__P_290_1 = false;
        this.__unblockedEventFired__P_290_2 = false;

        this.__blocker__P_290_0.addListenerOnce("blocked", function (e) {
          this.__blockedEventFired__P_290_1 = true;
        }, this);

        this.__blocker__P_290_0.addListenerOnce("unblocked", function (e) {
          this.__unblockedEventFired__P_290_2 = true;
        }, this);
        ...
        this.wait(100, function () {
          this.assertTrue(this.__blockedEventFired__P_290_1, "'blocked' event was not fired, after block() was executed!");
          this.assertTrue(this.__unblockedEventFired__P_290_2, "'unblocked' event was not fired, after unblock() was executed!");
        }, this);
      },
...
//# sourceMappingURL=Blocker.js.map?dt=1592908584773