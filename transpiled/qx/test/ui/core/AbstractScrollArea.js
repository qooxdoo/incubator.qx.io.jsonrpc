  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.core.AbstractScrollArea", {
    ...
    members: {
      ...
      __widget__P_288_0: null,

      /** @type {qx.ui.container.Composite} */
      __outer__P_288_1: null,
      setUp: function setUp() {
        ...
        this.__outer__P_288_1 = new qx.ui.container.Composite(new qx.ui.layout.Grow());

        this.__outer__P_288_1.set({
          maxWidth: 100,
          maxHeight: 100
        });

        this.__widget__P_288_0 = new qx.test.ui.core.AbstractScrollArea.fixture.CustomWidget();

        this.__outer__P_288_1.add(this.__widget__P_288_0);

        this.getRoot().add(this.__outer__P_288_1);
      ...
      "test default behaviour": function testDefaultBehaviour() {
        ...
        this.__widget__P_288_0.setSingleChild(inner);

        this.flush();
        this.assertBounds(inner, this.__widget__P_288_0);
      },
      "test smaller widget than container": function testSmallerWidgetThanContainer() {
        ...
        this.flush();
        this.assertBounds(inner, this.__widget__P_288_0);
        this.assertFalse(this.__widget__P_288_0.hasScrollBar('x'));
        this.assertFalse(this.__widget__P_288_0.hasScrollBar('y'));
      },
      "test bigger widget than container": function testBiggerWidgetThanContainer() {
        ...
        this.assertTrue(this.__widget__P_288_0.hasScrollBar('x'));
        this.assertTrue(this.__widget__P_288_0.hasScrollBar('y'));
      },
      ...
      "test bigger widget than smaller preferred container": function testBiggerWidgetThanSmallerPreferredContainer() {
        ...
        this.__outer__P_288_1.resetMaxWidth();

        this.__outer__P_288_1.resetMaxHeight();
...
//# sourceMappingURL=AbstractScrollArea.js.map?dt=1592867904444