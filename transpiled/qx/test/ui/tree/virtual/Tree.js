  ...
  qx.Class.define("qx.test.ui.tree.virtual.Tree", {
    ...
    members: {
      ...
      testBuildLookupTable: function testBuildLookupTable() {
        ...
        this.__testBuildLookupTable__P_339_0(expected);
      },
      testBuildLookupTableWithOpenNodes: function testBuildLookupTableWithOpenNodes() {
        ...
        this.__openNodes__P_339_1(nodesToOpen);
      ...
      __testBuildLookupTable__P_339_0: function __testBuildLookupTable__P_339_0(expected) {
      ...
      testChangeBubblesRemoveItems: function testChangeBubblesRemoveItems() {
        ...
        this.__disposeChildren__P_339_2(removed);
      ...
      testGetLevel: function testGetLevel() {
        ...
        this.assertEquals(0, this.tree.getLevel(this.__getRowFrom__P_339_3(nodesToOpen[0])));
        this.assertEquals(1, this.tree.getLevel(this.__getRowFrom__P_339_3(nodesToOpen[1])));
        this.assertEquals(2, this.tree.getLevel(this.__getRowFrom__P_339_3(nodesToOpen[2])));
        this.assertEquals(3, this.tree.getLevel(this.__getRowFrom__P_339_3(nodesToOpen[3])));
        this.assertEquals(4, this.tree.getLevel(this.__getRowFrom__P_339_3(nodesToOpen[3].getChildren().getItem(4))));
      },
      testGetLevelWithHiddenRoot: function testGetLevelWithHiddenRoot() {
        ...
        this.assertEquals(0, this.tree.getLevel(this.__getRowFrom__P_339_3(excpected[0])));
        this.assertEquals(1, this.tree.getLevel(this.__getRowFrom__P_339_3(excpected[1])));
      },
      ...
      testSetOpenModeWithTap: function testSetOpenModeWithTap() {
        ...
        this.__testOpenMode__P_339_4(false, true);

        this.tree.resetOpenMode();

        this.__testOpenMode__P_339_4(true, false);
      },
      testSetOpenModeWithNone: function testSetOpenModeWithNone() {
        this.tree.setOpenMode("none");

        this.__testOpenMode__P_339_4(false, false);

        this.tree.resetOpenMode();

        this.__testOpenMode__P_339_4(true, false);
      },
      __testOpenMode__P_339_4: function __testOpenMode__P_339_4(dbltap, tap) {
      ...
      ---------------------------------------------------------------------------
      */
      __getRowFrom__P_339_3: function __getRowFrom__P_339_3(item) {
      ...
      ---------------------------------------------------------------------------
      */
      __openNodes__P_339_1: function __openNodes__P_339_1(nodes) {
        for (var i = 0; i < nodes.length; i++) {
          this.tree.openNodeWithoutScrolling(nodes[i]);
        }
      },
      __disposeChildren__P_339_2: function __disposeChildren__P_339_2(nativeArray) {
...
//# sourceMappingURL=Tree.js.map?dt=1599488370762