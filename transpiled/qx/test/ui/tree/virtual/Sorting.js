  ...
  qx.Class.define("qx.test.ui.tree.virtual.Sorting", {
    ...
    members: {
      testSorter: function testSorter() {
        ...
        this.__sortModel__P_342_0(sortedModel, sorter);
        ...
        this.__testBuildLookupTable__P_342_1(expected); //this.__logModel(sortedModel);
      ...
      testModelUnmodified: function testModelUnmodified() {
        ...
        this.__testOrderNotChanged__P_342_2(rootChildrenClone.toArray(), root.getChildren().toArray());
      ...
      __sortModel__P_342_0: function __sortModel__P_342_0(model, sorter) {
        ...
        for (var i = 0; i < children.getLength(); i++) {
          ...
          if (child instanceof qx.test.ui.tree.virtual.Node) {
            this.__sortModel__P_342_0(child, sorter);
          }
        }
      },
      __testBuildLookupTable__P_342_1: function __testBuildLookupTable__P_342_1(expected) {
      ...
      __testOrderNotChanged__P_342_2: function __testOrderNotChanged__P_342_2(expected, found) {
        var msg = "Expected [" + expected.join(", ") + "], but found [" + found.join(", ") + "]";
        this.assertEquals(expected.length, found.length, msg);
      ...
      ---------------------------------------------------------------------------
      */
      __logModel__P_342_3: function __logModel__P_342_3(model, level) {
        ...
        for (var i = 0; i < children.getLength(); i++) {
          this.__logModel__P_342_3(children.getItem(i), level + 1);
        }
      }
    }
  });
...
//# sourceMappingURL=Sorting.js.map?dt=1592867907790