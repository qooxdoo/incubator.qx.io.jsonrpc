  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.tree.TreeFolder", {
    ...
    members: {
      ...
      __tree__P_341_0: null,
      __root__P_341_1: null,
      __aa__P_341_2: null,
      __ab__P_341_3: null,
      __item__P_341_4: null,
      setUp: function setUp() {
        ...
        // - AA ("item")
        // - BB
        var tree = this.__tree__P_341_0 = new qx.ui.tree.Tree();
        var root = this.__root__P_341_1 = new qx.ui.tree.TreeFolder("A");
        tree.setRoot(root);
        root.setOpen(true);
        var aa = this.__aa__P_341_2 = new qx.ui.tree.TreeFolder("AA");
        var ab = this.__ab__P_341_3 = new qx.ui.tree.TreeFolder("AB");
        root.add(aa, ab); // Reference to "aa" as "item"

        this.__item__P_341_4 = this.__aa__P_341_2; // Render to set theme values
      ...
      testIconWhenClosed: function testIconWhenClosed() {
        var item = this.__item__P_341_4;
        this.flush();

        this.__assertIcon__P_341_5(item, this.__themeValueIcon__P_341_6(item));
      },
      testIconWhenClosedWithIcon: function testIconWhenClosedWithIcon() {
        ...
        this.__assertIcon__P_341_5(item, this.icon_closed);
      },
      ...
      testIconWhenOpened: function testIconWhenOpened() {
        ...
        this.__assertIcon__P_341_5(item, this.__themeValueIconOpened__P_341_7(item));
      },
      ...
      testIconWhenOpenedWithIconOpened: function testIconWhenOpenedWithIconOpened() {
        ...
        this.__assertIcon__P_341_5(item, this.icon_opened);
      },
      ...
      testRemoveAll: function testRemoveAll() {
        var removed = this.__root__P_341_1.removeAll();

        this.assertEquals(2, removed.length);
        this.assertEquals(this.__aa__P_341_2, removed[0]);
        this.assertEquals(this.__ab__P_341_3, removed[1]);
      },
      //
      // Helper methods
      //
      __themeValueIcon__P_341_6: function __themeValueIcon__P_341_6(item) {
        return qx.util.PropertyUtil.getThemeValue(item, "icon");
      },
      __themeValueIconOpened__P_341_7: function __themeValueIconOpened__P_341_7(item) {
        return qx.util.PropertyUtil.getThemeValue(item, "iconOpened");
      },
      __assertIcon__P_341_5: function __assertIcon__P_341_5(item, expected) {
      ...
      tearDown: function tearDown() {
        ...
        this.__tree__P_341_0.destroy();

        this.__root__P_341_1.destroy();

        this.__aa__P_341_2.destroy();

        this.__ab__P_341_3.destroy();
      }
    }
  });
...
//# sourceMappingURL=TreeFolder.js.map?dt=1599312845531