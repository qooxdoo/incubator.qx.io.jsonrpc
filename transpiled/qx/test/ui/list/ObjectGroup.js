  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.list.ObjectGroup", {
    ...
    members: {
      ...
      __groups__P_327_1: null,
      createModelData: function createModelData() {
        var model = new qx.data.Array();
        model.setAutoDisposeItems(true);
        var groups = this.__groups__P_327_1 = {};

        for (var i = 0; i < this.__names__P_327_0.length; i++) {
          var name = this.__names__P_327_0[i];
      ...
      tearDown: function tearDown() {
        ...
        for (var key in this.__groups__P_327_1) {
          if (this.__groups__P_327_1.hasOwnProperty(key)) {
            this.__groups__P_327_1[key].dispose();
          }
        }

        this.__groups__P_327_1 = null;
      },
      testGroup: function testGroup() {
        ...
        var groupedModel = this.__convertModel__P_327_2(this._model);
      ...
      testGroupWithSorter: function testGroupWithSorter() {
        ...
        var groupedModel = this.__convertModel__P_327_2(sortedModel);
      ...
      __convertModel__P_327_2: function __convertModel__P_327_2(model) {
...
//# sourceMappingURL=ObjectGroup.js.map?dt=1599343228233