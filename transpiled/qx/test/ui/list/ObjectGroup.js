(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.list.ObjectGroup", {
    ...
    members: {
      __names__P_331_0: ["Luise Siemer", "Trauhard Franke", "Sarina Wilde", "Florine Bähr", "Sigurd Adolph", "Sigmund Kurz", "Pankratius Hill", "Gerlinda Seel", "Trixi Clauß", "Cecilia Hemmer", "Rosely Fröhlich", "Annemargret Hunger", "Dietgar Münster", "Bertwin Joseph", "Edwina Schwarz", "Riana Dirks"],
      __groups__P_331_1: null,
      createModelData: function createModelData() {
        var model = new qx.data.Array();
        model.setAutoDisposeItems(true);
        var groups = this.__groups__P_331_1 = {};

        for (var i = 0; i < this.__names__P_331_0.length; i++) {
          var name = this.__names__P_331_0[i];
      ...
      tearDown: function tearDown() {
        ...
        for (var key in this.__groups__P_331_1) {
          if (this.__groups__P_331_1.hasOwnProperty(key)) {
            this.__groups__P_331_1[key].dispose();
          }
        }

        this.__groups__P_331_1 = null;
      },
      testGroup: function testGroup() {
        ...
        var groupedModel = this.__convertModel__P_331_2(this._model);
      ...
      testGroupWithSorter: function testGroupWithSorter() {
        ...
        var groupedModel = this.__convertModel__P_331_2(sortedModel);
      ...
      __convertModel__P_331_2: function __convertModel__P_331_2(model) {
...
//# sourceMappingURL=ObjectGroup.js.map?dt=1592520330967