(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.embed.Flash", {
    ...
    members: {
      __flash__P_294_0: null,
      __params__P_294_1: null,
      __variables__P_294_2: null,
      setUp: function setUp() {
        this.require(["plugin.flash"]);

        this.flush();
        this.__params__P_294_1 = {
          wmode: "opaque",
          quality: "best",
        ...
        this.__variables__P_294_2 = {
          init: "qx.test.ui.embed.Flash.flashCallback",
          flashVar1: "bli bla blub",
          flashVar2: "bulb alb ilb"
        };
        var flash = this.__flash__P_294_0 = new qx.ui.embed.Flash("qx/test/UnitTestFlash.swf", "flashmovie");
        flash.setVariables(this.__variables__P_294_2);
        flash.setScale("noscale");
        flash.setPlay(true);
        flash.setLoop(true);
        flash.setMenu(true);
        this.getRoot().add(this.__flash__P_294_0, {
          edge: 10
        });
      },
      tearDown: function tearDown() {
        ...
        this.__flash__P_294_0.destroy();

        this.__flash__P_294_0 = null;
      },
      testEvents: function testEvents() {
        ...
        this.__flash__P_294_0.addListener("loading", test.loading);

        this.__flash__P_294_0.addListener("loaded", test.loaded);

        this.__flash__P_294_0.addListener("timeout", test.timeout);
      ...
      testCreateFlash: function testCreateFlash() {
        var that = this;
        this.wait(2000, function () {
          var flash = that.__flash__P_294_0.getFlashElement();
          ...
          var params = that.__params__P_294_1;
...
//# sourceMappingURL=Flash.js.map?dt=1592866022195