(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.embed.Iframe", {
    ...
    members: {
      __iframe__P_294_0: null,
      setUp: function setUp() {
        this.__iframe__P_294_0 = new qx.ui.embed.Iframe();

        this.__iframe__P_294_0.set({
          width: 200,
          height: 500
        });
      },
      tearDown: function tearDown() {
        this.__iframe__P_294_0.destroy();
      },
      testHiddenSetSourceInitial: function testHiddenSetSourceInitial() {
        ...
        this.getRoot().add(this.__iframe__P_294_0);
        qx.ui.core.queue.Manager.flush();
        this.assertNotNull(this.__iframe__P_294_0.getContentElement().getDomElement());
      },
      testHiddenSetSource: function testHiddenSetSource() {
        this.getRoot().add(this.__iframe__P_294_0);
        qx.ui.core.queue.Manager.flush();

        this.__iframe__P_294_0.hide();

        qx.ui.core.queue.Manager.flush();
        var src = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.html");
        src = qx.util.Uri.getAbsolute(src);

        this.__iframe__P_294_0.setSource(src);

        qx.ui.core.queue.Manager.flush();

        this.__iframe__P_294_0.addListenerOnce("load", function () {
          this.resume(function () {
            this.assertEquals(this.__iframe__P_294_0.getSource(), this.__iframe__P_294_0.getWindow().location.href);
          });
        }, this);
      ...
      testGetWindow: function testGetWindow() {
        ...
        this.__iframe__P_294_0.addListener("load", function () {
          this.resume(function () {
            this.assertNotNull(this.__iframe__P_294_0.getWindow());
          }, this);
        }, this);
      ...
      testSyncSourceAfterDOMMove: function testSyncSourceAfterDOMMove() {
        ...
        var iframe = this.__iframe__P_294_0;
...
//# sourceMappingURL=Iframe.js.map?dt=1592520329120