(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.TextArea", {
    ...
    members: {
      __textArea__P_322_0: null,
      setUp: function setUp() {
        var textArea = this.__textArea__P_322_0 = new qx.ui.form.TextArea();
      ...
      "test: textarea set value": function testTextareaSetValue() {
        var textArea = this.__textArea__P_322_0;
      ...
      "test: textarea with autoSize respects initial value": function testTextareaWithAutoSizeRespectsInitialValue() {
        ...
        textArea.set({
          autoSize: true,
          value: this.__getLongValue__P_322_1()
        });
      ...
      "test: textarea with autoSize shrinks when long line is unwrapped": function testTextareaWithAutoSizeShrinksWhenLongLineIsUnwrapped() {
        ...
        if (!this.__supportsLiveWrap__P_322_2()) {
          this.skip();
        }
        ...
        var longValue = this.__getLongValue__P_322_1();
      ...
      "test: textarea with autoSize grows when long line is wrapped": function testTextareaWithAutoSizeGrowsWhenLongLineIsWrapped() {
        ...
        var longValue = this.__getLongValue__P_322_1(); // Wrap
      ...
      __getLongValue__P_322_1: function __getLongValue__P_322_1() {
      ...
      __supportsLiveWrap__P_322_2: function __supportsLiveWrap__P_322_2() {
      ...
      tearDown: function tearDown() {
        ...
        this.__textArea__P_322_0.destroy();
...
//# sourceMappingURL=TextArea.js.map?dt=1599312844046