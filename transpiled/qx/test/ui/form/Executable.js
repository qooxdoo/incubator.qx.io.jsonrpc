  ...
  qx.Class.define("qx.test.ui.form.Executable", {
    ...
    members: {
      ...
      testToggleButton: function testToggleButton() {
        this.__test__P_298_0(new qx.ui.form.ToggleButton());
      },
      testCheckBox: function testCheckBox() {
        this.__test__P_298_0(new qx.ui.form.CheckBox());
      },
      testButton: function testButton() {
        this.__test__P_298_0(new qx.ui.form.Button());
      },
      testRepeatButton: function testRepeatButton() {
        this.__test__P_298_0(new qx.ui.form.RepeatButton());
      },
      testMenuButton: function testMenuButton() {
        this.__test__P_298_0(new qx.ui.form.MenuButton());
      },
      testRadioButton: function testRadioButton() {
        this.__test__P_298_0(new qx.ui.form.RadioButton());
      },
      testToolbarButton: function testToolbarButton() {
        this.__test__P_298_0(new qx.ui.toolbar.Button());
      },
      testSplitButton: function testSplitButton() {
        this.__test__P_298_0(new qx.ui.toolbar.SplitButton());
      },
      testMenuCheckBox: function testMenuCheckBox() {
        this.__test__P_298_0(new qx.ui.menu.CheckBox());
      },
      testMenuRadioButton: function testMenuRadioButton() {
        this.__test__P_298_0(new qx.ui.menu.RadioButton());
      },
      testButtonInMenu: function testButtonInMenu() {
        this.__test__P_298_0(new qx.ui.menu.Button());
      },
      testCheckGroupBox: function testCheckGroupBox() {
        this.__test__P_298_0(new qx.ui.groupbox.CheckGroupBox());
      },
      testRadioGroupBox: function testRadioGroupBox() {
        this.__test__P_298_0(new qx.ui.groupbox.RadioGroupBox());
      },
      testDateChooser: function testDateChooser() {
        this.__test__P_298_0(new qx.ui.control.DateChooser());
      }
    }
  });
...
//# sourceMappingURL=Executable.js.map?dt=1599343226682