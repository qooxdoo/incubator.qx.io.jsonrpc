(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __testGetSingle__P_312_0: function __testGetSingle__P_312_0(widget, children) {
      ...
      __testGetMulti__P_312_1: function __testGetMulti__P_312_1(widget, children) {
        var children = children || widget.getChildren(); // check the model selection
      ...
      __testSetSingle__P_312_2: function __testSetSingle__P_312_2(widget, children) {
      ...
      __testSetMulti__P_312_3: function __testSetMulti__P_312_3(widget, children) {
        var children = children || widget.getChildren(); // check the set selection
      ...
      __createSelectBox__P_312_4: function __createSelectBox__P_312_4() {
        var box = new qx.ui.form.SelectBox();

        this.__addListItems__P_312_5(box);

        return box;
      },
      __createList__P_312_6: function __createList__P_312_6() {
        var list = new qx.ui.form.List();

        this.__addListItems__P_312_5(list);

        return list;
      },
      __addListItems__P_312_5: function __addListItems__P_312_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __createRadioGroup__P_312_7: function __createRadioGroup__P_312_7() {
        var group = new qx.ui.form.RadioGroup();

        this.__addRadioButton__P_312_8(group);

        return group;
      },
      __createRadioButtonGroup__P_312_9: function __createRadioButtonGroup__P_312_9() {
      ...
      __addRadioButton__P_312_8: function __addRadioButton__P_312_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __createTree__P_312_10: function __createTree__P_312_10() {
      ...
      __getRidOf__P_312_11: function __getRidOf__P_312_11(box) {
      ...
      testSelectBoxGetSingle: function testSelectBoxGetSingle() {
        var box = this.__createSelectBox__P_312_4();

        this.__testGetSingle__P_312_0(box);

        this.__getRidOf__P_312_11(box);
      },
      testSelectBoxSetSingle: function testSelectBoxSetSingle() {
        var box = this.__createSelectBox__P_312_4();

        this.__testSetSingle__P_312_2(box);

        this.__getRidOf__P_312_11(box);
      },
      testListGetSingle: function testListGetSingle() {
        var list = this.__createList__P_312_6();

        this.__testGetSingle__P_312_0(list);

        this.__getRidOf__P_312_11(list);
      },
      testListSetSingle: function testListSetSingle() {
        var list = this.__createList__P_312_6();

        this.__testSetSingle__P_312_2(list);
      ...
      testListGetMulti: function testListGetMulti() {
        ...
        this.__testGetMulti__P_312_1(list);
      ...
      testListSetMulti: function testListSetMulti() {
        ...
        this.__testSetMulti__P_312_3(list);

        this.__getRidOf__P_312_11(list);
      },
      testRadioGroupGetSingle: function testRadioGroupGetSingle() {
        var group = this.__createRadioGroup__P_312_7();

        this.__testGetSingle__P_312_0(group);

        this.__getRidOf__P_312_11(group);
      },
      testRadioGroupSetSingle: function testRadioGroupSetSingle() {
        var group = this.__createRadioGroup__P_312_7();

        this.__testSetSingle__P_312_2(group);

        this.__getRidOf__P_312_11(group);
      },
      testRadioButtonGroupGetSingle: function testRadioButtonGroupGetSingle() {
        var group = this.__createRadioButtonGroup__P_312_9();
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__createTree__P_312_10();

        var children = widget.getItems(true);

        this.__testGetSingle__P_312_0(widget, children);
      ...
      testTreeSetSingle: function testTreeSetSingle() {
        ...
        this.__testSetSingle__P_312_2(widget, children);
      ...
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        this.__testGetMulti__P_312_1(widget, children);
      ...
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        this.__testSetMulti__P_312_3(widget, children);
...
//# sourceMappingURL=ModelSelection.js.map?dt=1599312843588