  ...
  qx.Class.define("qx.test.ui.form.VirtualSelectBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__selectBox__P_319_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__selectBox__P_319_0);
        this.flush();
      },
      tearDown: function tearDown() {
        qx.test.ui.form.VirtualSelectBox.prototype.tearDown.base.call(this);

        this.__selectBox__P_319_0.destroy();

        this.__selectBox__P_319_0 = null;
      },
      __simulateUiInteraction__P_319_1: function __simulateUiInteraction__P_319_1() {
        // focus -> array key down -> array key down -> enter
        this.__selectBox__P_319_0.getSelection().setItem(0, this.__selectBox__P_319_0.getModel().getItem(1));
      },
      testChangeValueEvent: function testChangeValueEvent() {
        var m = qx.data.marshal.Json.createModel(["a", "b"]);

        this.__selectBox__P_319_0.addListenerOnce("changeValue", function (e) {
          this.assertIdentical("a", e.getData());
          this.assertNull(e.getOldData());
        }.bind(this));

        this.__selectBox__P_319_0.setModel(m);
        ...
        this.__simulateUiInteraction__P_319_1();
      },
      ...
      "test dropdown list same width as selectbox": function testDropdownListSameWidthAsSelectbox() {
        ...
        this.__selectBox__P_319_0.setAllowGrowDropDown(false);

        this.__selectBox__P_319_0.setModel(m);

        this.__selectBox__P_319_0.setWidth(150);

        this.__selectBox__P_319_0.open();

        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__selectBox__P_319_0.getWidth(), test.__selectBox__P_319_0.getBounds().width);
          test.assertIdentical(test.__selectBox__P_319_0.getWidth(), test.__selectBox__P_319_0.getChildControl('dropdown').getBounds().width);
          test.resume();
        }, 10);
        this.wait();
      },
      "test dropdown list wider than selectbox": function testDropdownListWiderThanSelectbox() {
        ...
        this.__selectBox__P_319_0.setAllowGrowDropDown(true);
        ...
        setTimeout(function () {
          test.assertIdentical(test.__selectBox__P_319_0.getWidth(), test.__selectBox__P_319_0.getBounds().width);
          test.assertTrue(test.__selectBox__P_319_0.getChildControl('dropdown').getBounds().width > 666, "dropdown could not fit the whole item");
          test.resume();
        }, 10);
        this.wait();
      }
...
//# sourceMappingURL=VirtualSelectBox.js.map?dt=1599343227655