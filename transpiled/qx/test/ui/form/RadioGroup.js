  ...
  qx.Class.define("qx.test.ui.form.RadioGroup", {
    ...
    members: {
      setUp: function setUp() {
        this.__radioGroup__P_310_0 = new qx.ui.form.RadioGroup();

        this.__radioGroup__P_310_0.setAllowEmptySelection(true);
        ...
        for (var i = 0, j = 3; i < j; i++) {
          ...
          this.__radioGroup__P_310_0.add(radioButton);
        }
      },
      tearDown: function tearDown() {
        ...
        for (var i = 0, j = this.__radioButtons__P_310_1.length; i < j; i++) {
          this.__radioGroup__P_310_0.remove(this.__radioButtons__P_310_1[i]);

          radioButton = this.__radioButtons__P_310_1.shift();
          radioButton.dispose();
        }

        this.__radioGroup__P_310_0.dispose();
      ...
      testHiddenRadioButtons: function testHiddenRadioButtons() {
        ...
        for (var i = 0, j = this.__radioButtons__P_310_1.length; i < j; i++) {
          composite.add(this.__radioButtons__P_310_1[i]);
        }
        ...
        this.__radioGroup__P_310_0.setModelSelection([this.__radioButtons__P_310_1[1].getModel()]);

        this.assertEquals(this.__radioButtons__P_310_1[1].getModel(), this.__radioGroup__P_310_0.getModelSelection().getItem(0), "Model selection does not work correctly!");
        this.assertTrue(this.__radioGroup__P_310_0.isSelected(this.__radioButtons__P_310_1[1]), "Wrong radio button selected!"); // now hide the radio group and check if the selection change still works

        for (var i = 0, j = this.__radioButtons__P_310_1.length; i < j; i++) {
          this.__radioButtons__P_310_1[i].exclude();
        }

        this.__radioGroup__P_310_0.setModelSelection([this.__radioButtons__P_310_1[0].getModel()]);

        this.assertEquals(this.__radioButtons__P_310_1[0].getModel(), this.__radioGroup__P_310_0.getModelSelection().getItem(0), "Model selection does not work correctly!");
        this.assertTrue(this.__radioGroup__P_310_0.isSelected(this.__radioButtons__P_310_1[0]), "Hidden radio button not selected!");
        composite.destroy();
      },
...
//# sourceMappingURL=RadioGroup.js.map?dt=1599343227338