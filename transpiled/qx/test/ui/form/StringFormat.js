(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.StringFormat", {
    ...
    members: {
      __test__P_321_0: function __test__P_321_0(widget) {
      ...
      testTextField: function testTextField() {
        this.__test__P_321_0(new qx.ui.form.TextField());
      },
      testPasswordField: function testPasswordField() {
        this.__test__P_321_0(new qx.ui.form.PasswordField());
      },
      testTextArea: function testTextArea() {
        this.__test__P_321_0(new qx.ui.form.TextArea());
      },
      testComboBox: function testComboBox() {
        this.__test__P_321_0(new qx.ui.form.ComboBox());
      },
      testLabel: function testLabel() {
        this.__test__P_321_0(new qx.ui.basic.Label());
      }
    }
  });
...
//# sourceMappingURL=StringFormat.js.map?dt=1599312843994