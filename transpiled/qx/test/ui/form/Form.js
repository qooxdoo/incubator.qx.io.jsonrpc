(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Form", {
    ...
    members: {
      __testRequired__P_301_0: function __testRequired__P_301_0(widget) {
      ...
      __testValid__P_301_1: function __testValid__P_301_1(widget, where) {
        // check if the interface is implemented
        ...
        if (where !== "dont") {
          ...
          window.setTimeout(function () {
            self.resume(function () {
              this.__testInvalidBorder__P_301_2(widget);
      ...
      __testInvalidBorder__P_301_2: function __testInvalidBorder__P_301_2(widget) {
      ...
      testRequiredSpinner: function testRequiredSpinner() {
        this.__testRequired__P_301_0(new qx.ui.form.Spinner());
      },
      testValidSpinner: function testValidSpinner() {
        this.__testValid__P_301_1(new qx.ui.form.Spinner());
      },
      testRequiredSlider: function testRequiredSlider() {
        this.__testRequired__P_301_0(new qx.ui.form.Slider());
      },
      testValidSlider: function testValidSlider() {
        this.__testValid__P_301_1(new qx.ui.form.Slider());
      },
      testRequiredTextField: function testRequiredTextField() {
        this.__testRequired__P_301_0(new qx.ui.form.TextField());
      },
      testValidTextField: function testValidTextField() {
        this.__testValid__P_301_1(new qx.ui.form.TextField());
      },
      testRequiredTextArea: function testRequiredTextArea() {
        this.__testRequired__P_301_0(new qx.ui.form.TextArea());
      },
      testValidTextArea: function testValidTextArea() {
        this.__testValid__P_301_1(new qx.ui.form.TextArea());
      },
      testRequiredPasswordField: function testRequiredPasswordField() {
        this.__testRequired__P_301_0(new qx.ui.form.PasswordField());
      },
      testValidPasswordField: function testValidPasswordField() {
        this.__testValid__P_301_1(new qx.ui.form.PasswordField());
      },
      testRequiredComboBox: function testRequiredComboBox() {
        this.__testRequired__P_301_0(new qx.ui.form.ComboBox());
      },
      testValidComboBox: function testValidComboBox() {
        this.__testValid__P_301_1(new qx.ui.form.ComboBox());
      },
      testRequiredSelectBox: function testRequiredSelectBox() {
        this.__testRequired__P_301_0(new qx.ui.form.SelectBox());
      },
      testValidSelectBox: function testValidSelectBox() {
        this.__testValid__P_301_1(new qx.ui.form.SelectBox());
      },
      testRequiredCheckBox: function testRequiredCheckBox() {
        this.__testRequired__P_301_0(new qx.ui.form.CheckBox());
      },
      testValidCheckBox: function testValidCheckBox() {
        this.__testValid__P_301_1(new qx.ui.form.CheckBox(), "dont");
      },
      testValidRadioButton: function testValidRadioButton() {
        this.__testValid__P_301_1(new qx.ui.form.RadioButton(), "dont");
      },
      testRequiredRadioButton: function testRequiredRadioButton() {
        this.__testRequired__P_301_0(new qx.ui.form.RadioButton());
      },
      testValidGroupBox: function testValidGroupBox() {
        this.__testValid__P_301_1(new qx.ui.groupbox.GroupBox(), "dont");
      },
      testRequiredGroupBox: function testRequiredGroupBox() {
        this.__testRequired__P_301_0(new qx.ui.groupbox.GroupBox());
      },
      testValidRadioGroupBox: function testValidRadioGroupBox() {
        this.__testValid__P_301_1(new qx.ui.groupbox.RadioGroupBox(), "dont");
      },
      testRequiredRadioGroupBox: function testRequiredRadioGroupBox() {
        this.__testRequired__P_301_0(new qx.ui.groupbox.RadioGroupBox());
      },
      testValidCheckGroupBox: function testValidCheckGroupBox() {
        this.__testValid__P_301_1(new qx.ui.groupbox.CheckGroupBox(), "dont");
      },
      testRequiredCheckGroupBox: function testRequiredCheckGroupBox() {
        this.__testRequired__P_301_0(new qx.ui.groupbox.CheckGroupBox());
      },
      testValidList: function testValidList() {
        this.__testValid__P_301_1(new qx.ui.form.List());
      },
      testRequiredList: function testRequiredList() {
        this.__testRequired__P_301_0(new qx.ui.form.List());
      },
      testValidTree: function testValidTree() {
        this.__testValid__P_301_1(new qx.ui.tree.Tree());
      },
      testRequiredTree: function testRequiredTree() {
        this.__testRequired__P_301_0(new qx.ui.tree.Tree());
      },
      testRequiredDateField: function testRequiredDateField() {
        this.__testRequired__P_301_0(new qx.ui.form.DateField());
      },
      testValidDateField: function testValidDateField() {
        this.__testValid__P_301_1(new qx.ui.form.DateField());
      },
      ...
      testRequiredRadioGroup: function testRequiredRadioGroup() {
        this.__testRequired__P_301_0(new qx.ui.form.RadioGroup());
      },
      testRequiredRadioButtonGroup: function testRequiredRadioButtonGroup() {
        this.__testRequired__P_301_0(new qx.ui.form.RadioButtonGroup());
      },
...
//# sourceMappingURL=Form.js.map?dt=1599578768067