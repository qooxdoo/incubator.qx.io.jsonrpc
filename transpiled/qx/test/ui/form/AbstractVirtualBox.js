  ...
  qx.Class.define("qx.test.ui.form.AbstractVirtualBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__selectBox__P_292_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__selectBox__P_292_0);
        this.__comboBox__P_292_1 = new qx.ui.form.VirtualComboBox();
      ...
      testListLengthAfterModelChangeSelectBox: function testListLengthAfterModelChangeSelectBox() {
        ...
        this.__selectBox__P_292_0.setModel(model);

        this.__selectBox__P_292_0.open();

        this.flush();

        var dropDown = this.__selectBox__P_292_0.getChildControl("dropdown");
        ...
        this.__selectBox__P_292_0.resetModel();
      },
      testListLengthAfterModelChangeComboBox: function testListLengthAfterModelChangeComboBox() {
        var model = new qx.data.Array(["a", "b", "c"]);

        this.__comboBox__P_292_1.setModel(model);

        this.__comboBox__P_292_1.open();

        this.flush();

        var dropDown = this.__comboBox__P_292_1.getChildControl("dropdown");
        ...
        this.__comboBox__P_292_1.resetModel();
      }
    }
  });
...
//# sourceMappingURL=AbstractVirtualBox.js.map?dt=1599343226553