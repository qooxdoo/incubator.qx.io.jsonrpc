(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.BooleanFormat", {
    ...
    members: {
      __test__P_298_0: function __test__P_298_0(widget, initValue) {
      ...
      testCheckBox: function testCheckBox() {
        this.__test__P_298_0(new qx.ui.form.CheckBox(), false);
      },
      testToggleButton: function testToggleButton() {
        this.__test__P_298_0(new qx.ui.form.ToggleButton(), false);
      },
      testMenuCheckBox: function testMenuCheckBox() {
        this.__test__P_298_0(new qx.ui.menu.CheckBox(), false);
      },
      testRadioButton: function testRadioButton() {
        this.__test__P_298_0(new qx.ui.form.RadioButton(), false);
      },
      testMenuRadioButton: function testMenuRadioButton() {
        this.__test__P_298_0(new qx.ui.menu.RadioButton(), false);
      },
      testRadioGroupBox: function testRadioGroupBox() {
        this.__test__P_298_0(new qx.ui.groupbox.RadioGroupBox(), true);
      },
      testCheckGroupBox: function testCheckGroupBox() {
        this.__test__P_298_0(new qx.ui.groupbox.CheckGroupBox(), true);
      }
    }
  });
...
//# sourceMappingURL=BooleanFormat.js.map?dt=1592867904971