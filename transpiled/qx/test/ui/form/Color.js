(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Color", {
    ...
    members: {
      __test__P_292_0: function __test__P_292_0(widget) {
      ...
      testColorSelector: function testColorSelector() {
        this.__test__P_292_0(new qx.ui.control.ColorSelector());
      },
      testColorPopup: function testColorPopup() {
        this.__test__P_292_0(new qx.ui.control.ColorPopup());
      }
    }
  });
...
//# sourceMappingURL=Color.js.map?dt=1625734516614