(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelProperty", {
    ...
    members: {
      __test__P_306_0: function __test__P_306_0(widget) {
      ...
      testListItem: function testListItem() {
        this.__test__P_306_0(new qx.ui.form.ListItem());
      },
      testRadioButton: function testRadioButton() {
        this.__test__P_306_0(new qx.ui.form.RadioButton());
      },
      testRadioGroupBox: function testRadioGroupBox() {
        this.__test__P_306_0(new qx.ui.groupbox.RadioGroupBox());
      },
      testCheckBox: function testCheckBox() {
        this.__test__P_306_0(new qx.ui.form.CheckBox());
      },
      testCheckGroupBox: function testCheckGroupBox() {
        this.__test__P_306_0(new qx.ui.groupbox.CheckGroupBox());
      },
      testTreeFolder: function testTreeFolder() {
        this.__test__P_306_0(new qx.ui.tree.TreeFolder());
      },
      testTreeFile: function testTreeFile() {
        this.__test__P_306_0(new qx.ui.tree.TreeFile());
      }
    }
  });
...
//# sourceMappingURL=ModelProperty.js.map?dt=1599462400436