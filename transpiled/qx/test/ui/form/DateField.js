  ...
  qx.Class.define("qx.test.ui.form.DateField", {
    ...
    members: {
      setUp: function setUp() {
        this.__datefield__P_299_0 = new qx.ui.form.DateField();
        this.getRoot().add(this.__datefield__P_299_0);
      },
      tearDown: function tearDown() {
        this.__datefield__P_299_0.destroy();
      ...
      "test: setting value sets date of chooser": function testSettingValueSetsDateOfChooser() {
        var datefield = this.__datefield__P_299_0,
      ...
      formatDate: function formatDate(date) {
        return this.__datefield__P_299_0.getDateFormat().format(date);
      },
...
//# sourceMappingURL=DateField.js.map?dt=1606238624730