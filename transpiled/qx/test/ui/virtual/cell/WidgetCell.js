(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.virtual.cell.WidgetCell", {
    ...
    members: {
      __cell__P_348_0: null,
      setUp: function setUp() {
        this.__cell__P_348_0 = new qx.ui.virtual.cell.WidgetCell();
      },
      tearDown: function tearDown() {
        this.__cell__P_348_0.dispose();

        this.__cell__P_348_0 = null;
      },
      testCreateWidget: function testCreateWidget() {
        var item = this.__cell__P_348_0.getCellWidget();

        this.assertQxWidget(item);
        item.dispose();
      },
      testCreateWidgetWithDelegate: function testCreateWidgetWithDelegate() {
        this.__setUpDelegate__P_348_1();
      ...
      testPoolOnDelegateChange: function testPoolOnDelegateChange() {
        var item1 = this.__cell__P_348_0.getCellWidget();

        this.assertQxWidget(item1);

        var item2 = this.__cell__P_348_0.getCellWidget();

        this.assertQxWidget(item2);

        this.__cell__P_348_0.pool(item1);

        this.__cell__P_348_0.pool(item2);
      ...
      testEvent: function testEvent() {
        var that = this;
        var widget = null;
        this.assertEventFired(this.__cell__P_348_0, "created", function () {
          widget = that.__cell__P_348_0.getCellWidget();
        }, function (e) {
          that.assertQxWidget(e.getData());
        });

        this.__cell__P_348_0.pool(widget);

        this.assertEventNotFired(this.__cell__P_348_0, "created", function () {
          that.__cell__P_348_0.getCellWidget();
        }, function (e) {
          that.assertQxWidget(e.getData());
        });
        widget.dispose();
      ...
      testUpdateData: function testUpdateData() {
        ...
        this.__cell__P_348_0.updateData(item, data);
      ...
      testUpdateEmptyData: function testUpdateEmptyData() {
        ...
        this.__cell__P_348_0.updateData(item);
      ...
      testUpdateWrongData: function testUpdateWrongData() {
        ...
        this.assertException(function () {
          that.__cell__P_348_0.updateData(item, data);
        });
        item.dispose();
      },
      __setUpDelegate__P_348_1: function __setUpDelegate__P_348_1() {
        this.__cell__P_348_0.setDelegate({
...
//# sourceMappingURL=WidgetCell.js.map?dt=1599312846276