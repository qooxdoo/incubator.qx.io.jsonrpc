  ...
  qx.Class.define("qx.test.ui.virtual.layer.HtmlCellSpan", {
    ...
    members: {
      tearDown: function tearDown() {
        ...
        this.__cellRenderer__P_342_0.dispose();

        this.__rowConfig__P_342_1.dispose();

        this.__columnConfig__P_342_2.dispose();
      },
      _createLayer: function _createLayer() {
        this.__cellRenderer__P_342_0 = new qx.ui.virtual.cell.Cell();
        this.__rowConfig__P_342_1 = new qx.ui.virtual.core.Axis(10, 100);
        this.__columnConfig__P_342_2 = new qx.ui.virtual.core.Axis(20, 100);
        return new qx.ui.virtual.layer.HtmlCellSpan(this, this.__rowConfig__P_342_1, this.__columnConfig__P_342_2);
      },
      getCellProperties: function getCellProperties(row, column) {
        return this.__cellRenderer__P_342_0.getCellProperties(row + " / " + column, {});
      },
    ...
    destruct: function destruct() {
      this.__cellRenderer__P_342_0 = null;
    }
  });
  qx.test.ui.virtual.layer.HtmlCellSpan.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HtmlCellSpan.js.map?dt=1625734520071