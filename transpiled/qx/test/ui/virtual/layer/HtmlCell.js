  ...
  qx.Class.define("qx.test.ui.virtual.layer.HtmlCell", {
    ...
    members: {
      tearDown: function tearDown() {
        ...
        this.__cellRenderer__P_341_0.dispose();
      },
      _createLayer: function _createLayer() {
        this.__cellRenderer__P_341_0 = new qx.ui.virtual.cell.Cell();
        return new qx.ui.virtual.layer.HtmlCell(this);
      },
      getCellProperties: function getCellProperties(row, column) {
        return this.__cellRenderer__P_341_0.getCellProperties(row + " / " + column, {});
      },
    ...
    destruct: function destruct() {
      this.__cellRenderer__P_341_0 = null;
    }
  });
  qx.test.ui.virtual.layer.HtmlCell.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HtmlCell.js.map?dt=1625734520049