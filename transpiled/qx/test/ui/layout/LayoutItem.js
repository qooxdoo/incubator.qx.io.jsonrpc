(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.layout.LayoutItem", {
    ...
    members: {
      bounds: null,
      __layout__P_323_0: null,
      __children__P_323_1: null,
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (changes.size || changes.local || changes.margin) {
          if (this.__layout__P_323_0 && this.getLayoutChildren().length > 0) {
            this.__layout__P_323_0.renderLayout(width, height, {
              top: 0,
              right: 0,
              bottom: 0,
              left: 0
      ...
      setLayout: function setLayout(layout) {
        ...
        this.__layout__P_323_0 = layout;
      },
      _getLayout: function _getLayout() {
        return this.__layout__P_323_0;
      },
      // overridden
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        if (this.__layout__P_323_0) {
          this.__layout__P_323_0.invalidateLayoutCache();
        }
      },
      invalidateLayoutChildren: function invalidateLayoutChildren() {
        var layout = this.__layout__P_323_0;
      ...
      _getContentHint: function _getContentHint() {
        if (this.__layout__P_323_0 && this.getLayoutChildren().length > 0) {
          return this.__layout__P_323_0.getSizeHint();
        } else {
          return {
            width: 0,
            height: 0
      ...
      add: function add(child, options) {
        if (!this.__children__P_323_1) {
          this.__children__P_323_1 = [];
        }

        this.__children__P_323_1.push(child);

        this.__layout__P_323_0.invalidateChildrenCache();
      ...
      remove: function remove(child) {
        ...
        qx.lang.Array.remove(this.__children__P_323_1, child); // Clear parent connection
      ...
      getLayoutChildren: function getLayoutChildren() {
        var children = this.__children__P_323_1 || [];
        var layoutChildren = [];
    ...
    destruct: function destruct() {
      this.bounds = this.__layout__P_323_0 = this.__children__P_323_1 = null;
    }
  });
  qx.test.ui.layout.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1625734518080