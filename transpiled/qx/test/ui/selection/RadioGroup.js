    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        for (var i = 0; i < length; i++) {
          ...
          this.__radioButtons__P_331_0.push(item);
      ...
      tearDown: function tearDown() {
        ...
        for (var i = 0; i < this.__radioButtons__P_331_0.length; i++) {
          this.__radioButtons__P_331_0[i].destroy();
        }

        this.__radioButtons__P_331_0 = null;
...
//# sourceMappingURL=RadioGroup.js.map?dt=1605962032421