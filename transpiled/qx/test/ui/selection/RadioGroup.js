(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.selection.RadioGroup", {
    ...
    members: {
      __radioButtons__P_327_0: null,
      setUp: function setUp() {
        var length = 10;
        this._mode = "one";
        this.__radioButtons__P_327_0 = [];
        ...
        for (var i = 0; i < length; i++) {
          ...
          this.__radioButtons__P_327_0.push(item);
      ...
      tearDown: function tearDown() {
        ...
        for (var i = 0; i < this.__radioButtons__P_327_0.length; i++) {
          this.__radioButtons__P_327_0[i].destroy();
        }

        this.__radioButtons__P_327_0 = null;
...
//# sourceMappingURL=RadioGroup.js.map?dt=1625734518555