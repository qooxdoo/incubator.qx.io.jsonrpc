(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.mobile.LocaleSwitch", {
    ...
    members: {
      manager: null,
      __translationAdded__P_256_0: null,
      setUp: function setUp() {
        qx.test.mobile.LocaleSwitch.prototype.setUp.base.call(this);

        if (!this.__translationAdded__P_256_0) {
          ...
          this.__translationAdded__P_256_0 = true;
        }
      ...
      __testListEn__P_256_1: function __testListEn__P_256_1() {
        //debugger
        var title0 = q(".list * .list-item-title").eq(0).getHtml();
...
//# sourceMappingURL=LocaleSwitch.js.map?dt=1599463026004