  ...
  qx.Class.define("qx.test.mobile.list.List", {
    ...
    members: {
      ...
      */
      ...
      __createModel__P_258_0: function __createModel__P_258_0() {
        var data = [];
        data.push({
          title: "1",
          subtitle: "s1",
      ...
      __createList__P_258_1: function __createList__P_258_1(createItemRenderer, configureItemFunction) {
        var list = new qx.ui.mobile.list.List();
        this.getRoot().add(list);
        list.setDelegate({
          configureItem: configureItemFunction ? configureItemFunction : this.__configureItemFunction__P_258_2,
          createItemRenderer: createItemRenderer ? createItemRenderer : null
        });
        list.setModel(this.__createModel__P_258_0());
        return list;
      },
      __configureItemFunction__P_258_2: function __configureItemFunction__P_258_2(item, data, row) {
        item.setImage(data.image);
        item.setTitle(data.title);
        item.setSubtitle(data.subtitle);
      },
      __assertItemsAndModelLength__P_258_3: function __assertItemsAndModelLength__P_258_3(list, dataLength) {
        var childrenLength = list.getContentElement().childNodes.length;
        this.assertEquals(dataLength, childrenLength);
      },
      __cleanUp__P_258_4: function __cleanUp__P_258_4(list) {
        list.destroy();
      ...
      testCreate: function testCreate() {
        var list = this.__createList__P_258_1();

        this.__assertItemsAndModelLength__P_258_3(list, 5);

        this.__cleanUp__P_258_4(list);
      },
      testCustomRenderer: function testCustomRenderer() {
        var list = this.__createList__P_258_1(function () {
      ...
      testSetModelNull: function testSetModelNull() {
        ...
        this.__assertItemsAndModelLength__P_258_3(list, 0);
      ...
      testModelChangeRemove: function testModelChangeRemove() {
        ...
        this.__assertItemsAndModelLength__P_258_3(list, 4);
      ...
      testModelChangeAdd: function testModelChangeAdd() {
        ...
        this.__assertItemsAndModelLength__P_258_3(list, 6);
...
//# sourceMappingURL=List.js.map?dt=1625734514254