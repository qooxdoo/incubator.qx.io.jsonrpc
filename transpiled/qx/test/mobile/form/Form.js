(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.mobile.form.Form", {
    ...
    members: {
      __username__P_262_0: null,
      testValidation: function testValidation() {
        var form = this.__createForm__P_262_1();
        ...
        this.__username__P_262_0.setValue('myusername');

        this.assertTrue(form.validate());
        this.assertEquals(2, renderer._getChildren()[1].getChildren().length);
        this.assertFalse(qx.bom.element.Class.has(renderer._getChildren()[1]._getChildren()[1].getContainerElement(), 'invalid'));

        this.__username__P_262_0.dispose();

        renderer.dispose();
        form.dispose();
      },
      __createForm__P_262_1: function __createForm__P_262_1() {
        var form = new qx.ui.mobile.form.Form();
        var validationManager = form.getValidationManager();
        var username = this.__username__P_262_0 = new qx.ui.mobile.form.TextField().set({
...
//# sourceMappingURL=Form.js.map?dt=1592908583141