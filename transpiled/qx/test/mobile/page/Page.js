  ...
  qx.Class.define("qx.test.mobile.page.Page", {
    ...
    members: {
      ...
      testInitialize: function testInitialize() {
        this.__testEventOnPage__P_261_0("initialize");
      },
      testStart: function testStart() {
        this.__testEventOnPageAndApplication__P_261_1("start");
      },
      testStop: function testStop() {
        this.__testEventOnPageAndApplication__P_261_1("stop", function (page) {
          page.initialize();
        });
      },
      testPause: function testPause() {
        this.__testEventOnPage__P_261_0("pause");
      },
      testResume: function testResume() {
        this.__testEventOnPage__P_261_0("resume");
      },
      testWait: function testWait() {
        this.__testEventOnPage__P_261_0("wait");
      },
      testBack: function testBack() {
        this.__testEventOnPageAndApplication__P_261_1("back");
      },
      ...
      testMenu: function testMenu() {
        this.__testEventOnPage__P_261_0("menu");
      },
      __testEventOnPage__P_261_0: function __testEventOnPage__P_261_0(name) {
        var page = new qx.ui.mobile.page.Page();
        this.getRoot().add(page);
      ...
      __testEventOnPageAndApplication__P_261_1: function __testEventOnPageAndApplication__P_261_1(name, beforeCallback) {
        var page = new qx.ui.mobile.page.Page();
        this.getRoot().add(page);
        var eventFiredOnApplication = false;
        var eventFiredOnPage = false;
...
//# sourceMappingURL=Page.js.map?dt=1599488363615