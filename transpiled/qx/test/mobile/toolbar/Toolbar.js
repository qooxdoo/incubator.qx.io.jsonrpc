(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.mobile.toolbar.Toolbar", {
    ...
    members: {
      __createToolbar__P_263_0: function __createToolbar__P_263_0() {
        var toolBar = new qx.ui.mobile.toolbar.ToolBar();
        this.getRoot().add(toolBar);
        return toolBar;
      },
      __assertChildNodesLength__P_263_1: function __assertChildNodesLength__P_263_1(toolBar, toolbarKidsNumber) {
      ...
      testAdd: function testAdd() {
        var toolBar = this.__createToolbar__P_263_0();

        var button1 = new qx.ui.mobile.toolbar.Button("Button 1");
        toolBar.add(button1);

        this.__assertChildNodesLength__P_263_1(toolBar, 1);

        var button2 = new qx.ui.mobile.toolbar.Button("Button with long name 2");
        toolBar.add(button2);

        this.__assertChildNodesLength__P_263_1(toolBar, 2);

        var button3 = new qx.ui.mobile.toolbar.Button("Button 3");
        toolBar.add(button3);

        this.__assertChildNodesLength__P_263_1(toolBar, 3);
      ...
      testRemove: function testRemove() {
        ...
        this.__assertChildNodesLength__P_263_1(toolBar, 0);
...
//# sourceMappingURL=Toolbar.js.map?dt=1599546980719