(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.mobile.tabbar.TabBar", {
    ...
    members: {
      __createTabBar__P_263_0: function __createTabBar__P_263_0() {
        var tabBar = new qx.ui.mobile.tabbar.TabBar();
        this.getRoot().add(tabBar);
        return tabBar;
      },
      __assertChildNodesLength__P_263_1: function __assertChildNodesLength__P_263_1(tabBar, tabNumber) {
      ...
      testAdd: function testAdd() {
        var tabBar = this.__createTabBar__P_263_0();

        var button1 = new qx.ui.mobile.tabbar.TabButton("Button 1");
        tabBar.add(button1);

        this.__assertChildNodesLength__P_263_1(tabBar, 1);

        var button2 = new qx.ui.mobile.tabbar.TabButton("Button 2");
        tabBar.add(button2);

        this.__assertChildNodesLength__P_263_1(tabBar, 2);

        var button3 = new qx.ui.mobile.tabbar.TabButton("Button 3");
        tabBar.add(button3);

        this.__assertChildNodesLength__P_263_1(tabBar, 3);
      ...
      testRemove: function testRemove() {
        ...
        this.__assertChildNodesLength__P_263_1(tabBar, 0);
...
//# sourceMappingURL=TabBar.js.map?dt=1599905732159