  ...
  qx.Class.define("qx.test.core.Property", {
    ...
    members: {
      ...
      */
       ...
       */
      __isNegativeZero__P_226_0: function __isNegativeZero__P_226_0(value) {
       ...
       * @return {Boolean} whether the value is <code>+0</code>
       */
      __isPositiveZero__P_226_1: function __isPositiveZero__P_226_1(value) {
        return value === 0 && 1 / value > 0; // 1/+0 => +Infinity
      },
      ...
      testIsEqualInline: function testIsEqualInline() {
        ...
        this.assertEventFired(object, "changeProp", function () {
          ...
          var isNegativeZero = self.__isNegativeZero__P_226_0(e.getData());

          var isPositiveZero = self.__isPositiveZero__P_226_1(e.getOldData());
        ...
        qx.Class.define("qx.TestProperty", {
          ...
          properties: {
            prop: {
              ...
              nullable: true,
              event: "changeProp",
              isEqual: "__fooBar__P_226_2"
            }
          },
          members: {
            __fooBar__P_226_2: function __fooBar__P_226_2(foo, bar) {
      ...
      testIsEqualInlineContext: function testIsEqualInlineContext() {
        ...
        qx.Class.define("qx.TestProperty", {
          ...
          members: {
            __checkCtx__P_226_3: function __checkCtx__P_226_3(foo, bar) {
              context = this;
            }
          }
        });
        ...
        qx.Class.define("qx.TestProperty", {
          ...
          properties: {
            prop: {
              ...
              nullable: true,
              event: "changeProp",
              transform: "__transform__P_226_4"
            },
            propTwo: {
              check: "qx.data.Array",
              nullable: true,
          ...
          members: {
            __transform__P_226_4: function __transform__P_226_4(value, oldValue) {
...
//# sourceMappingURL=Property.js.map?dt=1599312835490