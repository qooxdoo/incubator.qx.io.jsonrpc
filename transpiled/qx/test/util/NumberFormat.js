(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.util.NumberFormat", {
    ...
    members: {
      __nf__P_358_0: null,
      __oldLocale__P_358_1: null,
      setUp: function setUp() {
        this.assertNotUndefined(qx.util.format.NumberFormat);
        this.__oldLocale__P_358_1 = qx.locale.Manager.getInstance().getLocale();
        qx.locale.Manager.getInstance().setLocale("de_DE");
        this.__nf__P_358_0 = new qx.util.format.NumberFormat();
      },
      tearDown: function tearDown() {
        this.__nf__P_358_0.dispose();

        qx.locale.Manager.getInstance().setLocale(this.__oldLocale__P_358_1);
      },
      ...
      testNumberFormat: function testNumberFormat() {
        var nf = this.__nf__P_358_0; // this failed due to a rounding error
...
//# sourceMappingURL=NumberFormat.js.map?dt=1599312847205