    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (this.getConfig("selectionMode") == "single") {
          ...
          if (!this.__range__P_555_0) {
            this.__range__P_555_0 = value.map(function (val) {
      ...
      _selectDay: function _selectDay(e) {
        ...
        if (this.getConfig("selectionMode") == "range") {
          var range = this.__range__P_555_0.slice(0);
        ...
        for (var week = 0; week < 6; week++) {
          ...
          for (var i = 0; i < 7; i++) {
            ...
            if (this.getConfig("selectionMode") == "range" && qx.Bootstrap.isArray(this._value)) {
              ...
              var range = this.__range__P_555_0;
...
(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Carousel", {
    ...
    members: {
      __active__P_556_0: null,
      __pageContainer__P_556_1: null,
      __scrollContainer__P_556_2: null,
      __paginationLabels__P_556_3: null,
      __startPosLeft__P_556_4: null,
      __pagination__P_556_5: null,
      _ie9: false,
      __blocked__P_556_6: false,
      // overridden
      init: function init() {
        ...
        this.__scrollContainer__P_556_2 = qxWeb.create("<div>").addClass(prefix + "-container").appendTo(this);
        this.__pageContainer__P_556_1 = qxWeb.create("<div>").addClass("qx-hbox").setStyle("height", "100%").appendTo(this.__scrollContainer__P_556_2);
        this.__paginationLabels__P_556_3 = [];
        this.__pagination__P_556_5 = qxWeb.create("<div>").addClasses([prefix + "-pagination", "qx-hbox", "qx-flex1"]).setStyle("visibility", "excluded").appendTo(this);

        if (this._ie9) {
          this.__pageContainer__P_556_1.setStyle("display", "table");

          this.__pagination__P_556_5.setStyle("textAlign", "center");
        } else {
      ...
      setActive: function setActive(page) {
        var old = this.__active__P_556_0;
        this.__active__P_556_0 = page;
      ...
      addPage: function addPage(child) {
        child.addClasses(["qx-flex1", this.getCssPrefix() + "-page"]).appendTo(this.__pageContainer__P_556_1);

        if (this.find("." + this.getCssPrefix() + "-page").length > this.__paginationLabels__P_556_3.length) {
          var paginationLabel = this._createPaginationLabel();

          this.__paginationLabels__P_556_3.push(paginationLabel);

          this.__pagination__P_556_5.append(paginationLabel);
        }
        ...
        if (this._getPages().length === 3 && !this._ie9) {
          this.__scrollContainer__P_556_2.translate([-this.getWidth() + "px", 0, 0]);
        }
      ...
      removePage: function removePage(child) {
        ...
        if (this._getPages().length == 0) {
          this.__pagination__P_556_5.empty();
        ...
        this.__paginationLabels__P_556_3.splice(child.priorPosition, 1)[0].remove();

        for (var i = 0; i < this.__paginationLabels__P_556_3.length; i++) {
          this.__paginationLabels__P_556_3[i].getChildren(".label").setHtml(i + 1 + "");
        }
      ...
      _update: function _update() {
        ...
        if (!this._ie9) {
          ...
          if (direction == "right") {
            left = this._getPositionLeft() - this.__scrollContainer__P_556_2.getWidth();
          ...
          if (left !== undefined) {
            ...
            this.__scrollContainer__P_556_2.translate([-left + "px", 0, 0]); // animate to the new page
      ...
      _updateWidth: function _updateWidth() {
        ...
        this.__pageContainer__P_556_1.setStyle("width", containerWidth + "px"); // set the width of all pages to the carousel width
      ...
      _onTrackStart: function _onTrackStart() {
        if (this.__blocked__P_556_6) {
          return;
        }

        this.__startPosLeft__P_556_4 = this._getPositionLeft();

        this.__scrollContainer__P_556_2 // stop the current scroll animation
        .stop() // correct the scroll position as the stopped animation
        // resets to its initial value
        .translate([-Math.round(this.__startPosLeft__P_556_4) + "px", 0, 0]);
      },
      ...
      _onTrack: function _onTrack(e) {
        ...
        if (e.delta.axis == "x" && this._getPages().length > 2) {
          this.__scrollContainer__P_556_2.translate([-(this.__startPosLeft__P_556_4 - e.delta.x) + "px", 0, 0]);
        }
      },
      ...
      _onTrackEnd: function _onTrackEnd() {
        if (this.__startPosLeft__P_556_4 == null || this.__blocked__P_556_6) {
        ...
        window.setTimeout(function () {
          if (this._getPages().length < 3 || this.__scrollContainer__P_556_2.isPlaying()) {
            return;
          }

          this.__startPosLeft__P_556_4 = null;
      ...
      _onPaginationLabelTap: function _onPaginationLabelTap(e) {
        this.__paginationLabels__P_556_3.forEach(function (label, index) {
          if (label[0] === e.currentTarget) {
            ...
            this.__scrollContainer__P_556_2.translate([-activeIndex * this.getWidth() + "px", 0, 0]);

            this.__blocked__P_556_6 = true; // animate to the desired page

            this._translateTo((activeIndex + distance) * this.getWidth());

            this.__scrollContainer__P_556_2.once("animationEnd", function (page) {
              this.__blocked__P_556_6 = false; // set the viewport back to the default position
      ...
      _updatePagination: function _updatePagination() {
        ...
        this._getPages().length < 2 ? this.__pagination__P_556_5.setStyle("visibility", "excluded") : this.__pagination__P_556_5.setStyle("visibility", "visible");

        this.__pagination__P_556_5.find("." + this.getCssPrefix() + "-pagination-label").removeClass("active");

        var pages = this._getPages();

        this.__paginationLabels__P_556_3[pages.indexOf(this.getActive())].addClass("active");
      },
      ...
      _translateTo: function _translateTo(left) {
        this.__scrollContainer__P_556_2.animate({
      ...
      _getPages: function _getPages() {
        return this.__pageContainer__P_556_1.find("." + this.getCssPrefix() + "-page");
      },
      ...
      _getPositionLeft: function _getPositionLeft() {
        var containerRect = this.__scrollContainer__P_556_2[0].getBoundingClientRect();
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define('qx.ui.website.DatePicker', {
    ...
    statics: {
      ...
      __validPositions__P_557_0: null,
    ...
    members: {
      ...
      init: function init(date) {
        ...
        this.__setReadOnly__P_557_1(this);

        this.__setIcon__P_557_2(this);

        this.__addInputListener__P_557_3(this);
      ...
      setConfig: function setConfig(name, config) {
        if (name === 'position') {
          var validPositions = qx.ui.website.DatePicker.__validPositions__P_557_0;
       ...
       */
      __setReadOnly__P_557_1: function __setReadOnly__P_557_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __setIcon__P_557_2: function __setIcon__P_557_2(collection) {
        var icon;
       ...
       * @param collection {qxWeb} collection to work on
       */
      __addInputListener__P_557_3: function __addInputListener__P_557_3(collection) {
    ...
    defer: function defer(statics) {
      ...
      statics.__validPositions__P_557_0 = ['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right', 'left-top', 'left-middle', 'left-bottom', 'right-top', 'right-middle', 'right-bottom'];
    }
  });
    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (qxWeb.type.get(step) != "Array" || step.indexOf(value) != -1) {
          this.__valueToPosition__P_558_1(value);
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__dragMode__P_558_0) {
          return;
        }

        this.__dragMode__P_558_0 = true;
      ...
      _onDocPointerUp: function _onDocPointerUp(e) {
        if (this.__dragMode__P_558_0 === true) {
          // Cleanup status flags
          delete this.__dragMode__P_558_0;

          this.__valueToPosition__P_558_1(this.getValue());
      ...
      */
      ...
      _onWindowResize: function _onWindowResize() {
        ...
        this.__valueToPosition__P_558_1(this._value);
      },
       ...
       */
      __valueToPosition__P_558_1: function __valueToPosition__P_558_1(value) {
        var pixels = this._getPixels();
  ...
  qx.Bootstrap.define("qx.ui.website.Table", {
    ...
    statics: {
      ...
      */
       ...
       */
      __isNumber__P_559_1: function __isNumber__P_559_1(n) {
       ...
       * @return {Boolean} The result of the check
       */
      __isDate__P_559_2: function __isDate__P_559_2(val) {
        var d = new Date(val);
       ...
       */
      __getIndex__P_559_3: function __getIndex__P_559_3(htmlCollection, htmlElement) {
        var index = -1;
      ...
      */
      __getUID__P_559_4: function __getUID__P_559_4() {
        return (new Date().getTime() + "" + Math.floor(Math.random() * 1000000)).substr(0, 18);
      },

      /** */
      __selectionTypes__P_559_5: ["single", "multiple", "none"],

      /** */
      __internalCellClass__P_559_6: "qx-table-cell",

      /** */
      __internalHeaderClass__P_559_7: "qx-table-header",

      /** */
      __internalSelectionClass__P_559_8: "qx-table-row-selection",

      /** */
      __internalInputClass__P_559_9: "qx-table-selection-input",

      /** */
      __allColumnSelector__P_559_10: "qx-table-all-columns",

      /** */
      __dataColName__P_559_11: "data-qx-table-col-name",

      /** */
      __dataColType__P_559_12: "data-qx-table-col-type",

      /** */
      __dataSortingKey__P_559_13: "data-qx-table-cell-key",

      /** */
      __modelSortingKey__P_559_14: "cellKey",

      /** */
      __inputLabelClass__P_559_15: "qx-table-input-label",

      /** */
      __selectedRowClass__P_559_16: "qx-table-row-selected",

      /** */
      __ascSortingClass__P_559_17: "qx-table-sort-asc",

      /** */
      __descSortingClass__P_559_18: "qqx-table-sort-desc"
    },
    members: {
      __model__P_559_0: null,
      __columnMeta__P_559_19: null,
      __sortingFunction__P_559_20: null,
      __filterFunction__P_559_21: null,
      __filterFunc__P_559_22: null,
      __filters__P_559_23: null,
      __inputName__P_559_24: null,
      __hovered__P_559_25: null,
      __sortingData__P_559_26: null,
      // overridden
      init: function init() {
        ...
        var model = this.__model__P_559_0;
        ...
        this.__inputName__P_559_24 = "input" + qx.ui.website.Table.__getUID__P_559_4();

        this.__getColumnMetaData__P_559_27(model);

        this.setModel(model);
        this.setSortingFunction(this.__defaultColumnSort__P_559_28);

        this.__registerEvents__P_559_29();

        this.__hovered__P_559_25 = null;
        return true;
      },
      ...
      setColumnType: function setColumnType(columnName, type) {
        this.__checkColumnExistance__P_559_30(columnName);

        this.__columnMeta__P_559_19[columnName].type = type;
        return this;
      },
      ...
      getColumnType: function getColumnType(columnName) {
        this.eq(0).__checkColumnExistance__P_559_30(columnName);

        return this.eq(0).__columnMeta__P_559_19[columnName].type;
      },
      ...
      getCell: function getCell(row, col) {
        return qxWeb(this.eq(0).__getRoot__P_559_31().rows.item(row).cells.item(col));
      },
      ...
      */
      getRows: function getRows() {
        return qxWeb(this.eq(0).__getRoot__P_559_31().rows);
      },
      ...
      setSortingFunction: function setSortingFunction(func) {
        ...
        this.__sortingFunction__P_559_20 = func;
        return this;
      },
      ...
      unsetSortingFunction: function unsetSortingFunction() {
        this.__sortingFunction__P_559_20 = this.__defaultColumnSort__P_559_28;
        return this;
      },
      ...
      setFilterFunction: function setFilterFunction(func) {
        this.__filterFunction__P_559_21 = func;
        return this;
      },
      ...
      unsetFilterFunction: function unsetFilterFunction() {
        this.__filterFunction__P_559_21 = this.__defaultColumnFilter__P_559_32;
        return this;
      },
      ...
      */
      setColumnFilter: function setColumnFilter(columnName, func) {
        ...
        if (!this.__filterFunc__P_559_22) {
          this.__filterFunc__P_559_22 = {};
        }

        this.__filterFunc__P_559_22[columnName] = func;
        return this;
      },
      ...
      */
      getColumnFilter: function getColumnFilter(columnName) {
        if (this.__filterFunc__P_559_22) {
          return this.__filterFunc__P_559_22[columnName];
        }
      ...
      */
      setRowFilter: function setRowFilter(func) {
        ...
        this.__filterFunc__P_559_22.row = func;
        return this;
      },
      ...
      */
      getRowFilter: function getRowFilter() {
        if (this.__filterFunc__P_559_22) {
          return this.__filterFunc__P_559_22.row;
        }
      ...
      sort: function sort(columnName, dir) {
        ...
        this.__sortDOM__P_559_33(this.__sort__P_559_34(columnName, dir));
      ...
      */
      filter: function filter(keyword, columnName) {
        if (columnName) {
          ...
          columnName = qx.ui.website.Table.__allColumnSelector__P_559_10;
        }

        if (!this.__filters__P_559_23) {
          this.__filters__P_559_23 = {};
        }

        if (this.__filters__P_559_23[columnName]) {
          this.__filters__P_559_23[columnName].keyword = keyword;

          this.__getRoot__P_559_31().appendChild(this.__filters__P_559_23[columnName].rows);
        } else {
          this.__filters__P_559_23[columnName] = {
            keyword: keyword,
            rows: document.createDocumentFragment()
          };
        }

        this.__filterDom__P_559_35(keyword, columnName);
      ...
      */
      resetFilter: function resetFilter(columnName) {
        var filters = null;
        filters = this.__filters__P_559_23;

        if (filters) {
          if (columnName) {
            this.__getRoot__P_559_31().appendChild(filters[columnName].rows);
          } else {
            for (var col in filters) {
              this.__getRoot__P_559_31().appendChild(filters[col].rows);
            }
          }
        }
      ...
      */
      setContent: function setContent(tableData) {
        var rows = this.__extractTableRows__P_559_36(tableData);
      ...
      */
      __extractTableRows__P_559_36: function __extractTableRows__P_559_36(data) {
        var rows = qxWeb();
      ...
      * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
      */
      __filterDom__P_559_35: function __filterDom__P_559_35(keyword, columnName) {
        var colIndex = this.__getColumnIndex__P_559_37(columnName);

        var filterFunc = columnName == qx.ui.website.Table.__allColumnSelector__P_559_10 ? this.getRowFilter() : this.getColumnFilter(columnName);
        filterFunc = filterFunc || this.__defaultColumnFilter__P_559_32;

        var rows = this.__getDataRows__P_559_38(),
            data = {};
        ...
        for (var i = 0; i < rows.length; i++) {
          ...
          if (!filterFunc.bind(this)(data)) {
            this.__filters__P_559_23[columnName].rows.appendChild(rows[i]);
          }
        }
      ...
      getSortingData: function getSortingData() {
        return this.__sortingData__P_559_26;
      },
      //overridden
      render: function render() {
        ...
        this.__applyTemplate__P_559_39(this.__model__P_559_0);

        if (qx.ui.website.Table.__selectionTypes__P_559_5.indexOf(rowSelection) != -1) {
          this.__processSelectionInputs__P_559_40(rowSelection);
        }

        if (sortingData) {
          this.__sortDOM__P_559_33(this.__sort__P_559_34(sortingData.columnName, sortingData.direction));
        }
      ...
      * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
      */
      __processSelectionInputs__P_559_40: function __processSelectionInputs__P_559_40(rowSelection) {
        switch (rowSelection) {
          case "none":
            qxWeb("." + qx.ui.website.Table.__internalSelectionClass__P_559_8).remove();
            break;

          case "multiple":
          case "single":
            this.__createInputs__P_559_41("checkbox");

            break;

          case "single":
            this.__createInputs__P_559_41("radio");
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __createInputs__P_559_41: function __createInputs__P_559_41(type) {
        this.__createInput__P_559_42(this.__getHeaderRow__P_559_43(), type);

        var rows = this.find("tbody")[0].getElementsByTagName("tr");

        for (var i = 0; i < rows.length; i++) {
          this.__createInput__P_559_42(rows.item(i), type);
        }
      ...
      */
      __createInput__P_559_42: function __createInput__P_559_42(row, type, nodeName) {
        var cssPrefix = this.getCssPrefix();
        var clazz = qx.ui.website.Table;
        var headerInput = qxWeb("." + clazz.__internalHeaderClass__P_559_7 + " input");
        ...
        var inputName = this.__inputName__P_559_24;
        var className = nodeName == "th" ? clazz.__internalSelectionClass__P_559_8 + " " + clazz.__internalHeaderClass__P_559_7 : clazz.__internalSelectionClass__P_559_8;
        var currentInput = qxWeb(row).find("." + clazz.__internalSelectionClass__P_559_8);
        ...
        if (currentInput.length > 0) {
          ...
          var id = qx.ui.website.Table.__getUID__P_559_4();

          var inputNode = qxWeb.create("<" + nodeName + " class='" + className + "'><input id='" + id + "' name='" + inputName + "' " + checked + " class='" + cssPrefix + "-" + type + " " + clazz.__internalInputClass__P_559_9 + "' type='" + type + "' /><label class='" + clazz.__inputLabelClass__P_559_15 + "' for='" + id + "'></label></" + nodeName + ">");
      ...
      */
      __checkColumnExistance__P_559_30: function __checkColumnExistance__P_559_30(columnName) {
        var data = this.__columnMeta__P_559_19;
      ...
      */
      __getHeaderRow__P_559_43: function __getHeaderRow__P_559_43() {
      ...
      * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __getColumnMetaData__P_559_27: function __getColumnMetaData__P_559_27(model) {
        this.__addClassToHeaderAndFooter__P_559_44(this[0].tHead);

        this.__addClassToHeaderAndFooter__P_559_44(this[0].tFoot);
        ...
        var headerRow = this.__getHeaderRow__P_559_43();

        cells = headerRow.cells;

        for (var i = 0, l = cells.length; i < l; i++) {
          cell = qxWeb(cells.item(i));
          colName = this.__getColumName__P_559_45(cell[0]) || qx.ui.website.Table.__getUID__P_559_4();

          if (!cell[0].getAttribute(qx.ui.website.Table.__dataColName__P_559_11)) {
            cell.setAttribute(qx.ui.website.Table.__dataColName__P_559_11, colName);
          }

          data[colName] = {
            type: cell[0].getAttribute(qx.ui.website.Table.__dataColType__P_559_12) || "String",
            name: colName
          };
        }

        this.__columnMeta__P_559_19 = data;
        return this;
      },
      ...
      * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __addClassToHeaderAndFooter__P_559_44: function __addClassToHeaderAndFooter__P_559_44(footOrHead) {
        if (footOrHead && footOrHead.rows.length > 0) {
          if (footOrHead.rows.item(0).cells.length > 0) {
            var row = this.__getHeaderRow__P_559_43();

            if (!qxWeb(row.cells.item(0)).hasClass(qx.ui.website.Table.__internalHeaderClass__P_559_7)) {
              qxWeb(row.cells).addClass(qx.ui.website.Table.__internalHeaderClass__P_559_7);
            }
          }
        }
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __sortDOM__P_559_33: function __sortDOM__P_559_33(dataRows) {
        for (var i = 0, l = dataRows.length; i < l; i++) {
          if (i) {
            qxWeb(dataRows[i]).insertAfter(dataRows[i - 1]);
          } else {
            qxWeb(dataRows[i]).insertBefore(qxWeb(this.__getRoot__P_559_31().rows.item(0)));
          }
        }
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __registerEvents__P_559_29: function __registerEvents__P_559_29() {
        this.on("tap", this.__detectClickedCell__P_559_46);
        this.on("cellClick", function (data) {
          if (data.cell && data.cell.hasClass(qx.ui.website.Table.__internalHeaderClass__P_559_7)) {
            this.__sortingFunction__P_559_20.bind(this)(data);
          }
        }, this);
        this.on("pointerover", this.__cellHover__P_559_47, this);
        this.on("pointerout", this.__cellOut__P_559_48, this);
        return this;
      },
      ...
      */
      __selectionRendered__P_559_49: function __selectionRendered__P_559_49() {
        return qxWeb("." + qx.ui.website.Table.__internalSelectionClass__P_559_8).length > 0;
      },
      ...
      * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
      */
      __processSelection__P_559_50: function __processSelection__P_559_50(cell) {
        var clazz = qx.ui.website.Table;
        var inputs = qxWeb("." + clazz.__internalInputClass__P_559_9);
        ...
        if (selectionMode == "multiple") {
          if (cell.hasClass(clazz.__internalHeaderClass__P_559_7)) {
        ...
        qxWeb("." + clazz.__selectedRowClass__P_559_16).removeClass(clazz.__selectedRowClass__P_559_16);
        selectedRows.addClass(clazz.__selectedRowClass__P_559_16);
      ...
      */
      __fireEvent__P_559_51: function __fireEvent__P_559_51(eventType, cell, target) {
        var row = cell[0].parentNode,
            cells = row.cells;

        var colNumber = qx.ui.website.Table.__getIndex__P_559_3(cells, cell[0]);

        var tHead = this.__getHeaderRow__P_559_43();

        var headCell = tHead.cells.item(colNumber);

        var colName = this.__getColumName__P_559_45(headCell);

        var columnIndex = this.getConfig("rowSelection") != "none" ? this.__getColumnIndex__P_559_37(colName) - 1 : this.__getColumnIndex__P_559_37(colName);
        var data = {
          cell: qxWeb(cell),
          row: qxWeb(row),
          target: target,
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __detectClickedCell__P_559_46: function __detectClickedCell__P_559_46(e) {
        var target = e.getTarget();
        var cell = qxWeb(target);
        var clazz = qx.ui.website.Table;

        while (!(cell.hasClass(clazz.__internalCellClass__P_559_6) || cell.hasClass(clazz.__internalHeaderClass__P_559_7) || cell.hasClass(clazz.__internalSelectionClass__P_559_8))) {
        ...
        if (cell.hasClass(clazz.__internalSelectionClass__P_559_8)) {
          window.setTimeout(function () {
            this.__processSelection__P_559_50(cell);
          }.bind(this), 5);
        } else {
          if (cell && cell.length > 0) {
            this.__fireEvent__P_559_51("cellClick", cell, target);
          }
        }
      ...
      */
      __cellHover__P_559_47: function __cellHover__P_559_47(e) {
        var target = e.getTarget();
        var cell = qxWeb(target);
        var hovered = this.__hovered__P_559_25;
        ...
        if (cell && cell.length > 0 && (hovered && hovered.cell[0] != cell[0] || !hovered) && !cell.hasClass("qx-table-row-selection")) {
          ...
          this.__hovered__P_559_25 = this.__fireEvent__P_559_51("cellHover", cell, target);
        }
      },
      ...
      * @param e {Event} The native over event.
      */
      __cellOut__P_559_48: function __cellOut__P_559_48(e) {
        var relatedTarget = e.getRelatedTarget();
        var cell = qxWeb(relatedTarget);

        if (this.__hovered__P_559_25) {
          if (!cell.isChildOf(this)) {
            this.emit("cellOut", this.__hovered__P_559_25);
            this.__hovered__P_559_25 = null;
          } else {
            if (!cell.hasClass("qx-table-cell") && !cell.hasClass("qx-table-header")) {
              cell = cell.getClosest(".qx-table-cell, .qx-table-header");
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __applyTemplate__P_559_39: function __applyTemplate__P_559_39(model) {
        if (model && model.length > 0) {
          ...
          if (this.__getRoot__P_559_31().rows.length > model.length) {
            this.__deleteRows__P_559_52(model.length);
          }
          ...
          for (var i = 0, rowCount = model.length; i < rowCount; i++) {
            ...
            if (!this.__isRowRendered__P_559_53(i)) {
              createdRow = this.__getRoot__P_559_31().insertRow(i);

              if (this.__selectionRendered__P_559_49()) {
                this.__createInput__P_559_42(createdRow, inputType, "td");
              }
            }

            for (var j = 0, colCount = row.length; j < colCount; j++) {
              renderedColIndex = this.__selectionRendered__P_559_49() ? j + 1 : j;
              colName = this.__getColumName__P_559_45(tHead.cells.item(renderedColIndex));
              colMeta = this.__getDataForColumn__P_559_54(colName);
              coltemplate = this.getTemplate(colName) || coltemplate;
              renderedRow = this.__getRoot__P_559_31().rows.item(i);
              ...
              if (!this.__isCellRendered__P_559_55(i, renderedColIndex)) {
      ...
      * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
      */
      __deleteRows__P_559_52: function __deleteRows__P_559_52(rowCount) {
        var renderedRows = this.__getRoot__P_559_31().rows;
      ...
      */
      __getDataForColumn__P_559_54: function __getDataForColumn__P_559_54(columName) {
        return this.__columnMeta__P_559_19[columName];
      },
       ...
       */
      __getRoot__P_559_31: function __getRoot__P_559_31() {
       ...
       * @return {Boolean} The result of the check
       */
      __isRowRendered__P_559_53: function __isRowRendered__P_559_53(index) {
        if (this.__getRoot__P_559_31().rows.item(index)) {
          return true;
        }
       ...
       * @return {Boolean} The result of the check
       */
      __isCellRendered__P_559_55: function __isCellRendered__P_559_55(rowIndex, colIndex) {
        if (!this.__isRowRendered__P_559_53(rowIndex)) {
          return false;
        }

        if (this.__getRoot__P_559_31().rows.item(rowIndex).cells.item(colIndex)) {
          return true;
        }
      ...
      setSortingClass: function setSortingClass(columnName, dir) {
        ...
        this.__sortingData__P_559_26 = data;

        this.__addSortingClassToCol__P_559_56(this[0].tHead, columnName, dir);
      },
       ...
       * @param dir {String} The sorting direction
       */
      __addSortingClassToCol__P_559_56: function __addSortingClassToCol__P_559_56(HeaderOrFooter, columnName, dir) {
        var rows = this.__getHeaderRow__P_559_43();

        if (HeaderOrFooter && rows) {
          qxWeb(rows.cells).removeClasses(["qx-table-sort-asc", "qx-table-sort-desc"]);
          var cell = qxWeb("[" + qx.ui.website.Table.__dataColName__P_559_11 + "='" + columnName + "'], #" + columnName);
       ...
       */
      __sort__P_559_34: function __sort__P_559_34(columnName, direction) {
        var meta = this.__getDataForColumn__P_559_54(columnName);
        ...
        var model = this.__getDataRows__P_559_38();

        var columnIndex = this.__getColumnIndex__P_559_37(columnName);

        return model.sort(function (a, b) {
          var x = this.__getSortingKey__P_559_57(qxWeb(a.cells.item(columnIndex)));

          var y = this.__getSortingKey__P_559_57(qxWeb(b.cells.item(columnIndex)));
      ...
      _compareNumber: function _compareNumber(x, y, direction) {
        x = qx.ui.website.Table.__isNumber__P_559_1(x) ? Number(x) : 0;
        y = qx.ui.website.Table.__isNumber__P_559_1(y) ? Number(y) : 0;
      ...
      */
      __getColumName__P_559_45: function __getColumName__P_559_45(headerCell) {
        return headerCell.getAttribute(qx.ui.website.Table.__dataColName__P_559_11) || headerCell.getAttribute("id");
      },
      ...
      _compareDate: function _compareDate(x, y, direction) {
        x = qx.ui.website.Table.__isDate__P_559_2(x) ? new Date(x) : new Date(0);
        y = qx.ui.website.Table.__isDate__P_559_2(y) ? new Date(y) : new Date(0);
      ...
      */
      __getSortingKey__P_559_57: function __getSortingKey__P_559_57(cell) {
        return cell.getAttribute(qx.ui.website.Table.__dataSortingKey__P_559_13) || this.__getCellValue__P_559_58(cell);
      },
       ...
       */
      __getCellValue__P_559_58: function __getCellValue__P_559_58(cell) {
       ...
       */
      __getDataRows__P_559_38: function __getDataRows__P_559_38() {
        ...
        for (var i = 0, l = rows.length; i < l; i++) {
          ...
          for (var j = 0, len = cells.length; j < len; j++) {
            ...
            if (!cell.hasClass(qx.ui.website.Table.__internalCellClass__P_559_6)) {
              cell.addClass(qx.ui.website.Table.__internalCellClass__P_559_6);
            }
          }
       ...
       */
      __defaultColumnSort__P_559_28: function __defaultColumnSort__P_559_28(data) {
        var dir = "asc";
      ...
      */
      __defaultColumnFilter__P_559_32: function __defaultColumnFilter__P_559_32(data) {
        var caseSensitive = this.getConfig("caseSensitive");
        var cell = data.columnName == qx.ui.website.Table.__allColumnSelector__P_559_10 ? data.row : data.cell;

        var cellValue = this.__getCellValue__P_559_58(cell);
       ...
       */
      __getColumnIndex__P_559_37: function __getColumnIndex__P_559_37(columnName) {
        var tHead = this.__getHeaderRow__P_559_43();

        var cells = tHead.cells;

        for (var i = 0; i < cells.length; i++) {
          if (columnName == this.__getColumName__P_559_45(cells.item(i))) {
            return i;
          }
        }
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.DynamicScriptLoader", {
    ...
    construct: function construct(scriptArr) {
      ...
      this.__started__P_571_0 = false;
      this.__QUEUE__P_571_1 = qx.lang.Type.isString(scriptArr) ? [scriptArr] : qx.lang.Array.clone(scriptArr);
    },
    ...
    */
    members: {
       ...
       */
      __QUEUE__P_571_1: null,

      /**
       * True if start has been called.
       */
      __started__P_571_0: null,
      ...
      start: function start() {
        return new qx.Promise(function (resolve, reject) {
          ...
          if (this.__started__P_571_0) {
            reject(new Error('you can only call start once per instance'));
          }

          this.__started__P_571_0 = true;

          this.__loadScripts__P_571_4();
        }, this);
      },
       ...
       *
       */
      __loadScripts__P_571_4: function __loadScripts__P_571_4() {
        ...
        var uri;
        var loader;
        script = this.__QUEUE__P_571_1.shift();
        ...
        if (DynamicScriptLoader.__LOADED__P_571_3[script]) {
        ...
        dynLoader = DynamicScriptLoader.__IN_PROGRESS__P_571_2[script];
        ...
        loader.on("load", function (request) {
          ...
          DynamicScriptLoader.__LOADED__P_571_3[script] = true;
          delete DynamicScriptLoader.__IN_PROGRESS__P_571_2[script];
          this.fireDataEvent('loaded', {
            script: script,
        ...
        loader.open("GET", uri);
        DynamicScriptLoader.__IN_PROGRESS__P_571_2[script] = this;
        loader.send();
      }
    },
    destruct: function destruct() {
      ...
      for (var key in DynamicScriptLoader.__IN_PROGRESS__P_571_2) {
        if (DynamicScriptLoader.__IN_PROGRESS__P_571_2[key] === this) {
          delete DynamicScriptLoader.__IN_PROGRESS__P_571_2[key];
        }
      }

      this.__QUEUE__P_571_1 = undefined;
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.fsm.FiniteStateMachine", {
    ...
    construct: function construct(machineName) {
      ...
      this.__states__P_583_0 = {}; // The first state added will become the start state

      this.__startState__P_583_1 = null; // Initialize the saved-states stack

      this.__savedStates__P_583_2 = []; // Initialize the pending event queue

      this.__eventQueue__P_583_3 = []; // Initialize the blocked events queue

      this.__blockedEvents__P_583_4 = []; // Create the friendlyToObject" object.  Each object has as its property
      // name, the friendly name of the object; and as its property value, the
      // object itself.

      this.__friendlyToObject__P_583_5 = {}; // Create the "friendlyToHash" object.  Each object has as its property
      // name, the friendly name of the object; and as its property value, the
      // hash code of the object.

      this.__friendlyToHash__P_583_6 = {}; // Create the "hashToFriendly" object.  Each object has as its property
      // name, the hash code of the object; and as its property value, the
      // friendly name of the object.

      this.__hashToFriendly__P_583_7 = {}; // Friendly names can be added to groups, for easy manipulation of
      // enabling and disabling groups of widgets.  Track which friendly names
      // are in which group.

      this.__groupToFriendly__P_583_8 = {}; // We also need to be able to map back from friendly name to the groups it
      // is in.

      this.__friendlyToGroups__P_583_9 = {};
    },
    statics: {
      /**
    ...
    members: {
      __states__P_583_0: null,
      __startState__P_583_1: null,
      __eventQueue__P_583_3: null,
      __blockedEvents__P_583_4: null,
      __savedStates__P_583_2: null,
      __friendlyToObject__P_583_5: null,
      __friendlyToHash__P_583_6: null,
      __hashToFriendly__P_583_7: null,
      __groupToFriendly__P_583_8: null,
      __friendlyToGroups__P_583_9: null,
      __bEventProcessingInProgress__P_583_10: false,
      __bTerminated__P_583_11: true,
      ...
      isTerminated: function isTerminated() {
        return this.__bTerminated__P_583_11;
      },
      ...
      replaceState: function replaceState(state, bDispose) {
        ...
        var oldState = this.__states__P_583_0[stateName]; // Replace the old state with the new state object.

        this.__states__P_583_0[stateName] = state; // Did they request that the old state be disposed?
      ...
      addObject: function addObject(friendlyName, obj, groupNames) {
        ...
        this.__friendlyToHash__P_583_6[friendlyName] = hash;
        this.__hashToFriendly__P_583_7[hash] = friendlyName;
        this.__friendlyToObject__P_583_5[friendlyName] = obj; // If no groupNames are specified, we're done.
        ...
        for (var i = 0; i < groupNames.length; i++) {
          ...
          if (!this.__groupToFriendly__P_583_8[groupName]) {
            // ... then create it.
            this.__groupToFriendly__P_583_8[groupName] = {};
          } // Add the friendly name to the list of names in this group


          this.__groupToFriendly__P_583_8[groupName][friendlyName] = true; // If the friendly name group mapping doesn't yet exist...

          if (!this.__friendlyToGroups__P_583_9[friendlyName]) {
            // ... then create it.
            this.__friendlyToGroups__P_583_9[friendlyName] = [];
          } // Append this group name to the list of groups this friendly name is
          // in


          this.__friendlyToGroups__P_583_9[friendlyName].push(groupName);
        }
      },
      ...
      removeObject: function removeObject(friendlyName) {
        ...
        var objName;
        var bGroupEmpty;
        hash = this.__friendlyToHash__P_583_6[friendlyName]; // Delete references to any groups this friendly name was in

        if (this.__friendlyToGroups__P_583_9[friendlyName]) {
          for (var i = 0; i < this.__friendlyToGroups__P_583_9[friendlyName].length; i++) {
            groupName = this.__friendlyToGroups__P_583_9[friendlyName][i];
            delete this.__groupToFriendly__P_583_8[groupName][friendlyName]; // Is the group empty now?

            bGroupEmpty = true;

            for (objName in this.__groupToFriendly__P_583_8[groupName]) {
            ...
            if (bGroupEmpty) {
              ...
              delete this.__groupToFriendly__P_583_8[groupName];
            }
          }

          delete this.__friendlyToGroups__P_583_9[friendlyName];
        } // Delete the friendly name


        delete this.__hashToFriendly__P_583_7[hash];
        delete this.__friendlyToHash__P_583_6[friendlyName];
        delete this.__friendlyToObject__P_583_5[friendlyName];
      },
      ...
      getObject: function getObject(friendlyName) {
        return this.__friendlyToObject__P_583_5[friendlyName];
      },
      ...
      getFriendlyName: function getFriendlyName(obj) {
        ...
        return hash ? this.__hashToFriendly__P_583_7[hash] : null;
      },
      ...
      getGroupObjects: function getGroupObjects(groupName) {
        ...
        for (var name in this.__groupToFriendly__P_583_8[groupName]) {
          a.push(name);
        }
      ...
      displayAllObjects: function displayAllObjects() {
        for (var friendlyName in this.__friendlyToHash__P_583_6) {
          var hash = this.__friendlyToHash__P_583_6[friendlyName];
          var obj = this.getObject(friendlyName);
          this.debug(friendlyName + " => " + hash);
          this.debug("  " + hash + " => " + this.__hashToFriendly__P_583_7[hash]);
      ...
      _getInternalData: function _getInternalData() {
        return {
          "states": this.__states__P_583_0,
          "startState": this.__startState__P_583_1,
          "eventQueue": this.__eventQueue__P_583_3,
          "blockedEvents": this.__blockedEvents__P_583_4,
          "savedStates": this.__savedStates__P_583_2,
          "friendlyToObject": this.__friendlyToObject__P_583_5,
          "friendlyToHash": this.__friendlyToHash__P_583_6,
          "hashToFriendly": this.__hashToFriendly__P_583_7,
          "groupToFriendly": this.__groupToFriendly__P_583_8,
          "friendlyToGroups": this.__friendlyToGroups__P_583_9
        };
      },
       ...
       */
      start: function start() {
        this.__bTerminated__P_583_11 = false;
        var stateName = this.__startState__P_583_1;
        ...
        this.__states__P_583_0[stateName].getAutoActionsBeforeOnentry()(this); // Run the entry function for the new state, if one is specified
        ...
        this.__states__P_583_0[stateName].getOnentry()(this, null); // Run the actionsAfterOnentry actions for the initial state
        ...
        this.__states__P_583_0[stateName].getAutoActionsAfterOnentry()(this);
      },
      ...
      pushState: function pushState(state) {
        ...
        if (this.__savedStates__P_583_2.length >= this.getMaxSavedStates()) {
        ...
        if (state === true) {
          ...
          this.__savedStates__P_583_2.push(this.getState());
        } else if (state) {
          this.__savedStates__P_583_2.push(state);
        } else {
          // Push the previous state onto the saved-state stack
          this.__savedStates__P_583_2.push(this.getPreviousState());
        }
      },
      ...
      popState: function popState() {
        ...
        if (this.__savedStates__P_583_2.length == 0) {
          // Nope. Programmer error.
          throw new Error("Saved-state stack is empty");
        }

        return this.__savedStates__P_583_2.pop();
      },
      ...
      postponeEvent: function postponeEvent(event) {
        ...
        this.__blockedEvents__P_583_4.unshift(event);
      },
      ...
      enqueueEvent: function enqueueEvent(event, bAddAtHead) {
        ...
        if (bAddAtHead) {
          ...
          this.__eventQueue__P_583_3.push(event);
        } else {
          // Put event at the tail of the queue
          this.__eventQueue__P_583_3.unshift(event);
        }
      ...
      eventListener: function eventListener(event) {
        if (this.__bTerminated__P_583_11) {
        ...
        this.__processEvents__P_583_12();
      },
       ...
       *
       */
      __processEvents__P_583_12: function __processEvents__P_583_12() {
        // eventListener() can potentially be called while we're processing
        // events
        if (this.__bEventProcessingInProgress__P_583_10) {
          // We were processing already, so don't process concurrently.
          return;
        } // Track that we're processing events


        this.__bEventProcessingInProgress__P_583_10 = true; // Process each of the events on the event queue

        while (this.__eventQueue__P_583_3.length > 0) {
          // Pull the next event from the pending event queue
          var event = this.__eventQueue__P_583_3.pop(); // Run the finite state machine with this event


          var bDispose = this.__run__P_583_13(event); // If we didn't block (and re-queue) the event, dispose it.
        ...
        this.__bEventProcessingInProgress__P_583_10 = false;
      },
       ...
       */
      __run__P_583_13: function __run__P_583_13(event) {
        ...
        currentState = this.__states__P_583_0[thisState]; // Get a list of the transitions available from this state
        ...
        for (var t in transitions) {
          ...
          if (typeof nextState == "string") {
            ...
            if (!nextState in this.__states__P_583_0) {
            ...
            switch (nextState) {
              ...
              case qx.util.fsm.FiniteStateMachine.StateChange.POP_STATE_STACK:
                ...
                nextState = this.__savedStates__P_583_2.pop();
                this.setNextState(nextState);
                break;

              case qx.util.fsm.FiniteStateMachine.StateChange.TERMINATE:
                // Terminate fsm
                this.__bTerminated__P_583_11 = true;
                this.setNextState(null);
                break;
          ...
          currentState = this.__states__P_583_0[this.getNextState()]; // set previousState and state, and clear nextState, for transition
          ...
          for (var i = 0; i < this.__blockedEvents__P_583_4.length; i++) {
            e = this.__blockedEvents__P_583_4.pop();

            this.__eventQueue__P_583_3.unshift(e);
          }
    ...
    destruct: function destruct() {
      this._disposeArray("__eventQueue__P_583_3");

      this._disposeArray("__blockedEvents__P_583_4");

      this.__savedStates__P_583_2 = this.__states__P_583_0 = null;
    }
  });
  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__bindIfFunction__P_584_0(stateInfo[field], context));
            break;

          case "onexit":
            this.setOnexit(this.__bindIfFunction__P_584_0(stateInfo[field], context));
            break;
    ...
    properties: {
       ...
       */
      name: {
        transform: "__transformName__P_584_1",
        nullable: true
      },
       ...
       */
      onentry: {
        transform: "__transformOnentry__P_584_2",
        nullable: true,
       ...
       */
      onexit: {
        transform: "__transformOnexit__P_584_3",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsBeforeOnentry: {
        transform: "__transformAutoActionsBeforeOnentry__P_584_4",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsAfterOnentry: {
        transform: "__transformAutoActionsAfterOnentry__P_584_5",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsBeforeOnexit: {
        transform: "__transformAutoActionsBeforeOnexit__P_584_6",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsAfterOnexit: {
        transform: "__transformAutoActionsAfterOnexit__P_584_7",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      events: {
        transform: "__transformEvents__P_584_8",
        nullable: true
      }
    },
    members: {
       ...
       */
      __transformName__P_584_1: function __transformName__P_584_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __transformOnentry__P_584_2: function __transformOnentry__P_584_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __transformOnexit__P_584_3: function __transformOnexit__P_584_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __transformEvents__P_584_8: function __transformEvents__P_584_8(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsBeforeOnentry__P_584_4: function __transformAutoActionsBeforeOnentry__P_584_4(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsAfterOnentry__P_584_5: function __transformAutoActionsAfterOnentry__P_584_5(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsBeforeOnexit__P_584_6: function __transformAutoActionsBeforeOnexit__P_584_6(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsAfterOnexit__P_584_7: function __transformAutoActionsAfterOnexit__P_584_7(value) {
       ...
       *   unaltered.
       */
      __bindIfFunction__P_584_0: function __bindIfFunction__P_584_0(f, context) {
  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__bindIfFunction__P_585_0(transitionInfo[field], context));
            break;
          ...
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__bindIfFunction__P_585_0(transitionInfo[field], context));
            break;

          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__bindIfFunction__P_585_0(transitionInfo[field], context));
            break;

          case "ontransition":
            this.setOntransition(this.__bindIfFunction__P_585_0(transitionInfo[field], context));
            break;
    ...
    properties: {
      ...
      predicate: {
        ...
        transform: "__transformPredicate__P_585_1"
      },
      ...
      nextState: {
        ...
        transform: "__transformNextState__P_585_2"
      },
      ...
      autoActionsBeforeOntransition: {
        init: function init(fsm, event) {},
        transform: "__transformAutoActionsBeforeOntransition__P_585_3"
      },
      ...
      autoActionsAfterOntransition: {
        init: function init(fsm, event) {},
        transform: "__transformAutoActionsAfterOntransition__P_585_4"
      },
      ...
      ontransition: {
        init: function init(fsm, event) {},
        transform: "__transformOntransition__P_585_5"
      }
    },
    members: {
      /**
       ...
       */
      __transformPredicate__P_585_1: function __transformPredicate__P_585_1(value) {
       ...
       */
      __transformNextState__P_585_2: function __transformNextState__P_585_2(value) {
       ...
       * @return {Function} the final value
       */
      __transformAutoActionsBeforeOntransition__P_585_3: function __transformAutoActionsBeforeOntransition__P_585_3(value) {
       ...
       * @return {Function} the final value
       */
      __transformAutoActionsAfterOntransition__P_585_4: function __transformAutoActionsAfterOntransition__P_585_4(value) {
       ...
       * @return {Function} the final value
       */
      __transformOntransition__P_585_5: function __transformOntransition__P_585_5(value) {
       ...
       *   unaltered.
       */
      __bindIfFunction__P_585_0: function __bindIfFunction__P_585_0(f, context) {
        // Is the first parameter a function?
        if (typeof f == "function") {
          // Yup. Bind it to the specified context.
          f = qx.lang.Function.bind(f, context);
  ...
  ************************************************************************ */
  qx.Mixin.define("qxl.apiviewer.MWidgetRegistry", {
    ...
    statics: {
       ...
       */
      getWidgetById: function getWidgetById(id) {
        return this.__objectDb__P_591_0[id];
      },
  ...
  qx.Class.define("qxl.apiviewer.Viewer", {
    ...
    */
    construct: function construct() {
      ...
      this.__menuItemStore__P_592_0 = {};
      var layout = new qx.ui.layout.VBox();
      this.setLayout(layout);
      this.add(this.__createHeader__P_592_1());
      this.add(this.__createToolbar__P_592_2());
      ...
      var toggleView = this.__createToggleView__P_592_3(tree, this._searchView, legend);

      var mainFrame = this.__createDetailFrame__P_592_4();

      this.add(this.__createSplitPane__P_592_5(toggleView, mainFrame), {
        flex: 1
      ...
      if (parsedUri.queryKey && parsedUri.queryKey.search) {
        ...
        this.__toggleGroup__P_592_6.setSelection([this.__toggleGroup__P_592_6.getChildren()[1]]);
      }
    },
    ...
    */
    members: {
      __firstPartHash__P_592_7: null,
      __overflowMenu__P_592_8: null,
      __menuItemStore__P_592_0: null,
      __toggleGroup__P_592_6: null,
       ...
       */
      __createToggleView__P_592_3: function __createToggleView__P_592_3(treeWidget, searchWidget, infoWidget) {
        ...
        this.__toggleGroup__P_592_6.addListener("changeSelection", function (e) {
       ...
       */
      __createToolbar__P_592_2: function __createToolbar__P_592_2() {
        var toolbar = new qx.ui.toolbar.ToolBar();
        var part = new qx.ui.toolbar.Part();
        toolbar.add(part);
        this.__firstPartHash__P_592_7 = part.toHashCode();
        ...
        this.__toggleGroup__P_592_6 = group;
        toolbar.addSpacer();
        var part = new qx.ui.toolbar.Part();
        toolbar.add(part);
        ...
        this.__overflowMenu__P_592_8 = new qx.ui.menu.Menu();
        chevron.setMenu(this.__overflowMenu__P_592_8); // add the listener
      ...
      _getMenuItems: function _getMenuItems(toolbarPart) {
        ...
        if (toolbarPart.toHashCode() === this.__firstPartHash__P_592_7) {
          var cachedItem = this.__menuItemStore__P_592_0[toolbarPart.toHashCode()];

          if (!cachedItem) {
            cachedItem = new qx.ui.menu.Separator();

            this.__overflowMenu__P_592_8.addAt(cachedItem, 0);

            this.__menuItemStore__P_592_0[toolbarPart.toHashCode()] = cachedItem;
          }
        ...
        for (var i = partChildren.length - 1; i >= 0; i--) {
          ...
          cachedItem = this.__menuItemStore__P_592_0[toolbarItem.toHashCode()];
          ...
          if (!cachedItem) {
            ...
            this.__menuItemStore__P_592_0[toolbarItem.toHashCode()] = cachedItem;
          }
       ...
       */
      __createDetailFrame__P_592_4: function __createDetailFrame__P_592_4() {
       ...
       */
      __createMainFrame__P_592_9: function __createMainFrame__P_592_9(toolbar, detailFrame) {
       ...
       */
      __createSplitPane__P_592_5: function __createSplitPane__P_592_5(leftWidget, rightWidget) {
       ...
       */
      __createHeader__P_592_1: function __createHeader__P_592_1() {
    ...
    */
    destruct: function destruct() {
      this._classTreeNodeHash = this.__toggleGroup__P_592_6 = null;
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      this.__bindTabViewController__P_593_0();

      this._tree = this._widgetRegistry.getWidgetById("tree");

      this.__bindTree__P_593_1();

      this.__bindToolbar__P_593_2();
      ...
      btn_inherited.addListener("changeValue", this.__syncMenuButton__P_593_3, this);
      btn_included.addListener("changeValue", this.__syncMenuButton__P_593_3, this);
      this._history = qx.bom.History.getInstance();

      this.__bindHistory__P_593_4();

      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__openInNewTab__P_593_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __openInNewTab__P_593_5: false,
      // overridden
      ...
      load: function load(apidata) {
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (state) {
              this.__selectItem__P_593_6(this.__decodeState__P_593_7(state));
            } else {
              this.__selectItem__P_593_6("");
            }
          });
        });
      },
       ...
       */
      __bindTabViewController__P_593_0: function __bindTabViewController__P_593_0() {
       ...
       */
      __bindTree__P_593_1: function __bindTree__P_593_1() {
       ...
       */
      __bindToolbar__P_593_2: function __bindToolbar__P_593_2() {
       ...
       * 
       */
      __syncMenuButton__P_593_3: function __syncMenuButton__P_593_3() {
       ...
       * bind history events
       */
      __bindHistory__P_593_4: function __bindHistory__P_593_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__decodeState__P_593_7(evt.getData());

          if (item) {
            this.__selectItem__P_593_6(item);
          }
        }, this);
      },
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__encodeState__P_593_8(className), newTitle);
      },
      ...
      _selectClass: function _selectClass(classNode, callback, self) {
        ...
        return classNode.loadDependedClasses().then(() => {
          if (classNode instanceof qxl.apiviewer.dao.Class) {
            return this._tabViewController.openClass(classNode, this.__openInNewTab__P_593_5);
          } else {
            return this._tabViewController.openPackage(classNode, this.__openInNewTab__P_593_5);
          }
       ...
       */
      __selectItem__P_593_6: function __selectItem__P_593_6(fullItemName) {
      ...
      __encodeState__P_593_8: function __encodeState__P_593_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __decodeState__P_593_7: function __decodeState__P_593_7(encodedState) {
  ...
  qx.Class.define("qxl.apiviewer.ui.SearchView", {
    ...
    */
    construct: function construct() {
      ...
      this.__initresult__P_595_0 = false;
      this.listdata = [];
      this.apiindex = {};
    ...
    */
    members: {
      __note__P_595_1: null,
      __initresult__P_595_0: null,
      __table__P_595_2: null,
      __typeFilter__P_595_3: null,
      __typesIndex__P_595_4: null,
      __searchTerm__P_595_5: null,
      ...
      search: function search(term) {
        ...
        if (qx.lang.Object.getLength(this.apiindex) == 0) {
          ...
          this.__searchTerm__P_595_5 = term;
        } else {
          this.__searchTerm__P_595_5 = null; // Set search box value
      ...
      _showSearchForm: function _showSearchForm() {
        ...
        this.__typeFilter__P_595_3 = new qx.data.Array([true, true, true, true, true, true, true]);
        ...
        for (var i = 0; i < types.length; i++) {
          ...
          typeToggleButton.bind("value", this.__typeFilter__P_595_3, "[" + i + "]");
          ...
          this.__typeFilter__P_595_3.bind("[" + i + "]", typeToggleButton, "value");
        }
        ...
        typeToggleButtonAll.addListener("changeValue", function (e) {
          for (var i = 0; i < this.__typeFilter__P_595_3.length; i++) {
            this.__typeFilter__P_595_3.setItem(i, e.getData());
          }
        ...
        this.__initresult__P_595_0 = true;
        this.__table__P_595_2 = table; // table.addListener("appear", this.__handleNote, this);
      ...
      _searchResult: function _searchResult(svalue) {
        ...
        for (var i = 0; i < this.__typeFilter__P_595_3.length; i++) {
          if (this.__typeFilter__P_595_3.getItem(i) === true) {
      ...
      _searchIndex: function _searchIndex(svalue, spath) {
        ...
        var index = this.apiindex.__index____P_595_6;
        var fullNames = this.apiindex.__fullNames____P_595_7;
        var types = this.apiindex.__types____P_595_8;
      ...
      _isTypeFilteredIn: function _isTypeFilteredIn(type) {
        return this.__typeFilter__P_595_3.getItem(this.__typesIndex__P_595_4[type]);
      },
      ...
      _load: function _load() {
        ...
        req.addListener("completed", function (evt) {
          ...
          if (this.__searchTerm__P_595_5) {
            setTimeout(function () {
              this.sinput.setValue(this.__searchTerm__P_595_5);
              this.__searchTerm__P_595_5 = null;
            }.bind(this), 0);
          }
        }, this);
      ...
      __initNote__P_595_9: function __initNote__P_595_9(table) {
        this.__note__P_595_1 = new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({
          autoHide: false,
          width: 170
        });
        ...
        this.__note__P_595_1.add(hint, {
          edge: 3
        });

        this.__note__P_595_1.setPosition("bottom-left");

        this.__note__P_595_1.placeToWidget(this.sinput, false);

        this.__note__P_595_1.show();
      },
      __handleNote__P_595_10: function __handleNote__P_595_10(e) {
        if (this.__note__P_595_1) {
          if ((this.sinput.getValue() || "").trim().length == 0) {
            this.__note__P_595_1.show();
          }
        } else {
          this.__initNote__P_595_9();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this.apiindex = this._table = this.__table__P_595_2 = this._tableModel = this.__typeFilter__P_595_3 = this.__typesIndex__P_595_4 = this._selectionModel = null;

      this._disposeObjects("sinput", "__note__P_595_1");
  ...
  qx.Class.define("qxl.apiviewer.ui.LegendView", {
    ...
    */
    construct: function construct() {
      ...
      var length = this.__legend__P_596_0.length;
      var entry, imageUrl;

      for (var i = 0; i < length; i++) {
        entry = this.__legend__P_596_0[i];
    ...
    */
    destruct: function destruct() {
      this._disposeMap("__legend__P_596_0");
    }
  });
...
(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ClassLoader", {
    extend: qx.core.Object,
    statics: {
      __baseUri__P_597_0: null,
      setBaseUri: function setBaseUri(baseUri) {
        this.__baseUri__P_597_0 = baseUri;
      },
      getBaseUri: function getBaseUri() {
        return this.__baseUri__P_597_0;
      },
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.TabViewController", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      this._tabView.addListener("changeSelection", this.__onChangeSelection__P_598_0, this);
    },
    events: {
    ...
    members: {
      ...
      openPackage: function openPackage(classNode, newTab) {
        return this.__open__P_598_1(classNode, qxl.apiviewer.ui.tabview.PackagePage, newTab);
      },
      openClass: function openClass(classNode, newTab) {
        return this.__open__P_598_1(classNode, qxl.apiviewer.ui.tabview.ClassPage, newTab);
      },
      __open__P_598_1: function __open__P_598_1(classNode, clazz, newTab) {
      ...
      __onChangeSelection__P_598_0: function __onChangeSelection__P_598_0(event) {
  ...
  qx.Class.define("qxl.apiviewer.dao.Package", {
    ...
    statics: {
      ...
      getPackage: function getPackage(name, create) {
        var root = qxl.apiviewer.dao.Package.__rootPackage__P_599_0;

        if (!root) {
          root = qxl.apiviewer.dao.Package.__rootPackage__P_599_0 = new qxl.apiviewer.dao.Package("");
        }
...
(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.LoadingIndicator", {
    ...
    extend: qx.core.Object,
    construct: function construct() {
      this.__blocker__P_600_0 = new qx.ui.core.Blocker(qxl.apiviewer.MWidgetRegistry.getWidgetById("tabView"));

      this.__blocker__P_600_0.setColor("#D5D5D5");

      this.__blocker__P_600_0.setOpacity(0.5);

      this.__blocker__P_600_0.getBlockerElement().setStyle("padding-top", "100px");

      this.__blocker__P_600_0.getBlockerElement().setStyle("text-align", "center");
      ...
      this.__blocker__P_600_0.getBlockerElement().add(loadingImage);
    },
    members: {
      __blocker__P_600_0: null,
      show: function show() {
        this.__blocker__P_600_0.block();
      },
      hide: function hide() {
        this.__blocker__P_600_0.unblock();
      }
    }
  });
  ...
  qx.Class.define("qxl.apiviewer.ObjectRegistry", {
    statics: {
      ...
      register: function register(object) {
        ...
        this.__objectDb__P_607_0[hash] = object;
      },
      getObjectFromHashCode: function getObjectFromHashCode(hashCode) {
        return this.__objectDb__P_607_0[hashCode];
      }
    }
  });
    ...
    members: {
      ...
      _getTocHtml: function _getTocHtml(classNode) {
        ...
        this.getPanels().forEach(panel => {
          ...
          q(tocItem).on("tap", function (firstItem) {
            return function () {
              this.__enableSection__P_602_0(firstItem, firstItem.getName());
      ...
      _getDescriptionHtml: function _getDescriptionHtml(classNode) {
        ...
        if (classNode.getType() === "interface") {
          classHtml.add(this.__getInterfaceHierarchyHtml__P_602_1(classNode));
        } else {
          classHtml.add(this.__getClassHierarchyHtml__P_602_2(classNode));
        }

        return classNode.getChildClasses().then(childClasses => {
          classHtml.add(this.__getDependentClassesHtml__P_602_3(childClasses, "Direct " + subObjectsName + ":"));
          classHtml.add(this.__getDependentClassesHtml__P_602_3(classNode.getInterfaces(), "Implemented interfaces:"));
          classHtml.add(this.__getDependentClassesHtml__P_602_3(classNode.getMixins(), "Included mixins:"));
          return classNode.getImplementations();
        }).then(classes => {
          classHtml.add(this.__getDependentClassesHtml__P_602_3(classes, "Implementations of this interface:"));
          return classNode.getIncluder();
        }).then(classes => {
          classHtml.add(this.__getDependentClassesHtml__P_602_3(classes, "Classes including this mixin:"));
       ...
       */
      __getDependentClassesHtml__P_602_3: function __getDependentClassesHtml__P_602_3(dependentClasses, title) {
        var result = "";
       ...
       */
      __getClassHierarchyHtml__P_602_2: function __getClassHierarchyHtml__P_602_2(classNode) {
       ...
       * @return {String} HTML fragemnt
       */
      __getInterfaceHierarchyHtml__P_602_1: function __getInterfaceHierarchyHtml__P_602_1(classNode) {
      ...
      showItem: function showItem(itemName) {
        ...
        this.__enableSection__P_602_0(itemNode, itemName);
       ...
       */
      __enableSection__P_602_0: function __enableSection__P_602_0(itemNode, itemName) {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.InfoPanel", {
    ...
    members: {
      ...
      getItemHtml: function getItemHtml(node, currentDocNode, showDetails) {
        ...
        if (this.itemHasDetails(node, currentDocNode)) {
          ...
          html.add("<img src=\"", qx.util.ResourceManager.getInstance().toUri("qxl/apiviewer/image/open.gif"), "\" onclick=\"", this.__encodeObject__P_604_0(this), ".toggleShowItemDetails('", node.getName(), "'", parentNode != currentDocNode ? ",'" + parentNode.getFullName() + "'" : "", ")\"/>");
        } else {
          html.add("&#160;");
        }
        ...
        if (this.itemHasDetails(node, currentDocNode)) {
          html.add(" onclick=\"", this.__encodeObject__P_604_0(this), ".toggleShowItemDetails('", node.getName(), "'", parentNode != currentDocNode ? ",'" + parentNode.getFullName() + "'" : "", ")\">");
        } else {
          html.add(">");
        }
      ...
      __encodeObject__P_604_0: function __encodeObject__P_604_0(object) {
      ...
      getPanelHtml: function getPanelHtml(viewer) {
        ...
        html.add("<img class=\"openclose\" src=\"", qx.util.ResourceManager.getInstance().toUri("qxl/apiviewer/image/" + (this.getIsOpen() ? "close.gif" : "open.gif")), "\" onclick=\"", this.__encodeObject__P_604_0(viewer), ".togglePanelVisibility(" + this.__encodeObject__P_604_0(this), ")\"/> ", "<span onclick=\"", this.__encodeObject__P_604_0(viewer), ".togglePanelVisibility(", this.__encodeObject__P_604_0(this), ")\">", uppercaseLabelText, "</span>");
       ...
       */
      __filterItems__P_604_1: function __filterItems__P_604_1(nodeArr, expandProperties, showProtected, showPrivate, showInternal) {
      ...
      update: function update(classViewer, currentClassDocNode) {
        ...
        return this.setDocNodeAsync(currentClassDocNode).then(() => {
          ...
          if (nodeArr && nodeArr.length > 0) {
            ...
            nodeArr = this.__filterItems__P_604_1(nodeArr, expandProperties, showProtected, showPrivate, showInternal);
    ...
    statics: {
          ...
          if (useIcon) {
            ...
            if (classNode && classNode.isLoaded()) {
              ...
              if (itemName) {
                ...
                itemNode = this.__getItemFromClassHierarchy__P_604_2(cleanItemName, classNode);
       ...
       *
       */
      __getItemFromClassHierarchy__P_604_2: function __getItemFromClassHierarchy__P_604_2(itemName, baseClassNode) {
      ...
      createDescriptionHtml: function createDescriptionHtml(node, packageBaseClass, showDetails) {
        ...
        if (desc) {
          if (!showDetails) {
            desc = this.__extractFirstSentence__P_604_3(desc);
          }
       ...
       */
      __extractFirstSentence__P_604_3: function __extractFirstSentence__P_604_3(text) {
      ...
      descriptionHasDetails: function descriptionHasDetails(node) {
        ...
        if (desc) {
          return this.__extractFirstSentence__P_604_3(desc) != desc;
        }
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.ui.panels.ConstantPanel", {
    ...
    members: {
       ...
       */
      itemHasDetails: function itemHasDetails(node, currentClassDocNode) {
        return node.getSee().length > 0 || node.getErrors().length > 0 || qxl.apiviewer.ui.panels.InfoPanel.descriptionHasDetails(node) || this.__hasConstantValueHtml__P_605_0(node);
      },
      getItemTypeHtml: function getItemTypeHtml(node) {
        return qxl.apiviewer.ui.panels.InfoPanel.createTypeHtml(node, "var");
      },
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          textHtml += this.__createConstantValueHtml__P_605_1(node);
       ...
       */
      __hasConstantValueHtml__P_605_0: function __hasConstantValueHtml__P_605_0(node) {
       ...
       */
      __createConstantValueHtml__P_605_1: function __createConstantValueHtml__P_605_1(node) {
        if (this.__hasConstantValueHtml__P_605_0(node)) {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __createGeneratedMethodsHtml__P_606_0: function __createGeneratedMethodsHtml__P_606_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }

        if (node.isPrivate()) {
          var access = "____P_606_1";
      ...
      __createAttributesHtml__P_606_2: function __createAttributesHtml__P_606_2(node) {
        var attributes = [];
       ...
       * @return {String} HTML fragment
       */
      __createRefinedFromHtml__P_606_3: function __createRefinedFromHtml__P_606_3(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__createAttributesHtml__P_606_2(node));
          textHtml.add(this.__createGeneratedMethodsHtml__P_606_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__createRefinedFromHtml__P_606_3(node));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createInheritedFromHtml(node, currentClassDocNode));
...
//# sourceMappingURL=package-9.js.map?dt=1599488417279
qx.$$packageData['9'] = {
  "locales": {},
  "resources": {},
  "translations": {
