    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (this.getConfig("selectionMode") == "single") {
          ...
          if (!this.__range__P_560_0) {
            this.__range__P_560_0 = value.map(function (val) {
      ...
      _selectDay: function _selectDay(e) {
        ...
        if (this.getConfig("selectionMode") == "range") {
          var range = this.__range__P_560_0.slice(0);
        ...
        for (var week = 0; week < 6; week++) {
          ...
          for (var i = 0; i < 7; i++) {
            ...
            if (this.getConfig("selectionMode") == "range" && qx.Bootstrap.isArray(this._value)) {
              ...
              var range = this.__range__P_560_0;
...
(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Carousel", {
    ...
    members: {
      __active__P_561_0: null,
      __pageContainer__P_561_1: null,
      __scrollContainer__P_561_2: null,
      __paginationLabels__P_561_3: null,
      __startPosLeft__P_561_4: null,
      __pagination__P_561_5: null,
      _ie9: false,
      __blocked__P_561_6: false,
      // overridden
      init: function init() {
        ...
        this.__scrollContainer__P_561_2 = qxWeb.create("<div>").addClass(prefix + "-container").appendTo(this);
        this.__pageContainer__P_561_1 = qxWeb.create("<div>").addClass("qx-hbox").setStyle("height", "100%").appendTo(this.__scrollContainer__P_561_2);
        this.__paginationLabels__P_561_3 = [];
        this.__pagination__P_561_5 = qxWeb.create("<div>").addClasses([prefix + "-pagination", "qx-hbox", "qx-flex1"]).setStyle("visibility", "excluded").appendTo(this);

        if (this._ie9) {
          this.__pageContainer__P_561_1.setStyle("display", "table");

          this.__pagination__P_561_5.setStyle("textAlign", "center");
        } else {
      ...
      setActive: function setActive(page) {
        var old = this.__active__P_561_0;
        this.__active__P_561_0 = page;
      ...
      addPage: function addPage(child) {
        child.addClasses(["qx-flex1", this.getCssPrefix() + "-page"]).appendTo(this.__pageContainer__P_561_1);

        if (this.find("." + this.getCssPrefix() + "-page").length > this.__paginationLabels__P_561_3.length) {
          var paginationLabel = this._createPaginationLabel();

          this.__paginationLabels__P_561_3.push(paginationLabel);

          this.__pagination__P_561_5.append(paginationLabel);
        }
        ...
        if (this._getPages().length === 3 && !this._ie9) {
          this.__scrollContainer__P_561_2.translate([-this.getWidth() + "px", 0, 0]);
        }
      ...
      removePage: function removePage(child) {
        ...
        if (this._getPages().length == 0) {
          this.__pagination__P_561_5.empty();
        ...
        this.__paginationLabels__P_561_3.splice(child.priorPosition, 1)[0].remove();

        for (var i = 0; i < this.__paginationLabels__P_561_3.length; i++) {
          this.__paginationLabels__P_561_3[i].getChildren(".label").setHtml(i + 1 + "");
        }
      ...
      _update: function _update() {
        ...
        if (!this._ie9) {
          ...
          if (direction == "right") {
            left = this._getPositionLeft() - this.__scrollContainer__P_561_2.getWidth();
          ...
          if (left !== undefined) {
            ...
            this.__scrollContainer__P_561_2.translate([-left + "px", 0, 0]); // animate to the new page
      ...
      _updateWidth: function _updateWidth() {
        ...
        this.__pageContainer__P_561_1.setStyle("width", containerWidth + "px"); // set the width of all pages to the carousel width
      ...
      _onTrackStart: function _onTrackStart() {
        if (this.__blocked__P_561_6) {
          return;
        }

        this.__startPosLeft__P_561_4 = this._getPositionLeft();

        this.__scrollContainer__P_561_2 // stop the current scroll animation
        .stop() // correct the scroll position as the stopped animation
        // resets to its initial value
        .translate([-Math.round(this.__startPosLeft__P_561_4) + "px", 0, 0]);
      },
      ...
      _onTrack: function _onTrack(e) {
        ...
        if (e.delta.axis == "x" && this._getPages().length > 2) {
          this.__scrollContainer__P_561_2.translate([-(this.__startPosLeft__P_561_4 - e.delta.x) + "px", 0, 0]);
        }
      },
      ...
      _onTrackEnd: function _onTrackEnd() {
        if (this.__startPosLeft__P_561_4 == null || this.__blocked__P_561_6) {
        ...
        window.setTimeout(function () {
          if (this._getPages().length < 3 || this.__scrollContainer__P_561_2.isPlaying()) {
            return;
          }

          this.__startPosLeft__P_561_4 = null;
      ...
      _onPaginationLabelTap: function _onPaginationLabelTap(e) {
        this.__paginationLabels__P_561_3.forEach(function (label, index) {
          if (label[0] === e.currentTarget) {
            ...
            this.__scrollContainer__P_561_2.translate([-activeIndex * this.getWidth() + "px", 0, 0]);

            this.__blocked__P_561_6 = true; // animate to the desired page

            this._translateTo((activeIndex + distance) * this.getWidth());

            this.__scrollContainer__P_561_2.once("animationEnd", function (page) {
              this.__blocked__P_561_6 = false; // set the viewport back to the default position
      ...
      _updatePagination: function _updatePagination() {
        ...
        this._getPages().length < 2 ? this.__pagination__P_561_5.setStyle("visibility", "excluded") : this.__pagination__P_561_5.setStyle("visibility", "visible");

        this.__pagination__P_561_5.find("." + this.getCssPrefix() + "-pagination-label").removeClass("active");

        var pages = this._getPages();

        this.__paginationLabels__P_561_3[pages.indexOf(this.getActive())].addClass("active");
      },
      ...
      _translateTo: function _translateTo(left) {
        this.__scrollContainer__P_561_2.animate({
      ...
      _getPages: function _getPages() {
        return this.__pageContainer__P_561_1.find("." + this.getCssPrefix() + "-page");
      },
      ...
      _getPositionLeft: function _getPositionLeft() {
        var containerRect = this.__scrollContainer__P_561_2[0].getBoundingClientRect();
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define('qx.ui.website.DatePicker', {
    ...
    statics: {
      ...
      __validPositions__P_562_0: null,
    ...
    members: {
      ...
      init: function init(date) {
        ...
        this.__setReadOnly__P_562_1(this);

        this.__setIcon__P_562_2(this);

        this.__addInputListener__P_562_3(this);
      ...
      setConfig: function setConfig(name, config) {
        if (name === 'position') {
          var validPositions = qx.ui.website.DatePicker.__validPositions__P_562_0;
       ...
       */
      __setReadOnly__P_562_1: function __setReadOnly__P_562_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __setIcon__P_562_2: function __setIcon__P_562_2(collection) {
        var icon;
       ...
       * @param collection {qxWeb} collection to work on
       */
      __addInputListener__P_562_3: function __addInputListener__P_562_3(collection) {
    ...
    defer: function defer(statics) {
      ...
      statics.__validPositions__P_562_0 = ['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right', 'left-top', 'left-middle', 'left-bottom', 'right-top', 'right-middle', 'right-bottom'];
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.DynamicScriptLoader", {
    ...
    construct: function construct(scriptArr) {
      ...
      this.__started__P_576_0 = false;
      this.__QUEUE__P_576_1 = qx.lang.Type.isString(scriptArr) ? [scriptArr] : qx.lang.Array.clone(scriptArr);
    },
    ...
    */
    members: {
       ...
       */
      __QUEUE__P_576_1: null,

      /**
       * True if start has been called.
       */
      __started__P_576_0: null,
      ...
      start: function start() {
        return new qx.Promise(function (resolve, reject) {
          ...
          if (this.__started__P_576_0) {
            reject(new Error('you can only call start once per instance'));
          }

          this.__started__P_576_0 = true;

          this.__loadScripts__P_576_4();
        }, this);
      },
       ...
       *
       */
      __loadScripts__P_576_4: function __loadScripts__P_576_4() {
        ...
        var uri;
        var loader;
        script = this.__QUEUE__P_576_1.shift();
        ...
        if (DynamicScriptLoader.__LOADED__P_576_3[script]) {
        ...
        dynLoader = DynamicScriptLoader.__IN_PROGRESS__P_576_2[script];
        ...
        loader.on("load", function (request) {
          ...
          DynamicScriptLoader.__LOADED__P_576_3[script] = true;
          delete DynamicScriptLoader.__IN_PROGRESS__P_576_2[script];
          this.fireDataEvent('loaded', {
            script: script,
        ...
        loader.open("GET", uri);
        DynamicScriptLoader.__IN_PROGRESS__P_576_2[script] = this;
        loader.send();
      }
    },
    destruct: function destruct() {
      ...
      for (var key in DynamicScriptLoader.__IN_PROGRESS__P_576_2) {
        if (DynamicScriptLoader.__IN_PROGRESS__P_576_2[key] === this) {
          delete DynamicScriptLoader.__IN_PROGRESS__P_576_2[key];
        }
      }

      this.__QUEUE__P_576_1 = undefined;
    }
  });
  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__bindIfFunction__P_589_0(stateInfo[field], context));
            break;

          case "onexit":
            this.setOnexit(this.__bindIfFunction__P_589_0(stateInfo[field], context));
            break;
    ...
    properties: {
       ...
       */
      name: {
        transform: "__transformName__P_589_1",
        nullable: true
      },
       ...
       */
      onentry: {
        transform: "__transformOnentry__P_589_2",
        nullable: true,
       ...
       */
      onexit: {
        transform: "__transformOnexit__P_589_3",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsBeforeOnentry: {
        transform: "__transformAutoActionsBeforeOnentry__P_589_4",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsAfterOnentry: {
        transform: "__transformAutoActionsAfterOnentry__P_589_5",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsBeforeOnexit: {
        transform: "__transformAutoActionsBeforeOnexit__P_589_6",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      autoActionsAfterOnexit: {
        transform: "__transformAutoActionsAfterOnexit__P_589_7",
        nullable: true,
        init: function init(fsm, event) {}
      },
       ...
       */
      events: {
        transform: "__transformEvents__P_589_8",
        nullable: true
      }
    },
    members: {
       ...
       */
      __transformName__P_589_1: function __transformName__P_589_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __transformOnentry__P_589_2: function __transformOnentry__P_589_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __transformOnexit__P_589_3: function __transformOnexit__P_589_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __transformEvents__P_589_8: function __transformEvents__P_589_8(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsBeforeOnentry__P_589_4: function __transformAutoActionsBeforeOnentry__P_589_4(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsAfterOnentry__P_589_5: function __transformAutoActionsAfterOnentry__P_589_5(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsBeforeOnexit__P_589_6: function __transformAutoActionsBeforeOnexit__P_589_6(value) {
       ...
       * @return {var} the final value
       */
      __transformAutoActionsAfterOnexit__P_589_7: function __transformAutoActionsAfterOnexit__P_589_7(value) {
  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__bindIfFunction__P_590_0(transitionInfo[field], context));
            break;
          ...
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__bindIfFunction__P_590_0(transitionInfo[field], context));
            break;

          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__bindIfFunction__P_590_0(transitionInfo[field], context));
            break;

          case "ontransition":
            this.setOntransition(this.__bindIfFunction__P_590_0(transitionInfo[field], context));
            break;
    ...
    properties: {
      ...
      predicate: {
        ...
        transform: "__transformPredicate__P_590_1"
      },
      ...
      nextState: {
        ...
        transform: "__transformNextState__P_590_2"
      },
      ...
      autoActionsBeforeOntransition: {
        init: function init(fsm, event) {},
        transform: "__transformAutoActionsBeforeOntransition__P_590_3"
      },
      ...
      autoActionsAfterOntransition: {
        init: function init(fsm, event) {},
        transform: "__transformAutoActionsAfterOntransition__P_590_4"
      },
      ...
      ontransition: {
        init: function init(fsm, event) {},
        transform: "__transformOntransition__P_590_5"
      }
    },
    members: {
      /**
       ...
       */
      __transformPredicate__P_590_1: function __transformPredicate__P_590_1(value) {
       ...
       */
      __transformNextState__P_590_2: function __transformNextState__P_590_2(value) {
       ...
       * @return {Function} the final value
       */
      __transformAutoActionsBeforeOntransition__P_590_3: function __transformAutoActionsBeforeOntransition__P_590_3(value) {
       ...
       * @return {Function} the final value
       */
      __transformAutoActionsAfterOntransition__P_590_4: function __transformAutoActionsAfterOntransition__P_590_4(value) {
       ...
       * @return {Function} the final value
       */
      __transformOntransition__P_590_5: function __transformOntransition__P_590_5(value) {
       ...
       *   unaltered.
       */
      __bindIfFunction__P_590_0: function __bindIfFunction__P_590_0(f, context) {
        // Is the first parameter a function?
        if (typeof f == "function") {
          // Yup. Bind it to the specified context.
          f = qx.lang.Function.bind(f, context);
  ...
  ************************************************************************ */
  qx.Mixin.define("qxl.apiviewer.MWidgetRegistry", {
    ...
    statics: {
       ...
       */
      getWidgetById: function getWidgetById(id) {
        return this.__objectDb__P_596_0[id];
      },
  ...
  qx.Class.define("qxl.apiviewer.Viewer", {
    ...
    */
    construct: function construct() {
      ...
      this.__menuItemStore__P_597_0 = {};
      var layout = new qx.ui.layout.VBox();
      this.setLayout(layout);
      this.add(this.__createHeader__P_597_1());
      this.add(this.__createToolbar__P_597_2());
      ...
      var toggleView = this.__createToggleView__P_597_3(tree, this._searchView, legend);

      var mainFrame = this.__createDetailFrame__P_597_4();

      this.add(this.__createSplitPane__P_597_5(toggleView, mainFrame), {
        flex: 1
      ...
      if (parsedUri.queryKey && parsedUri.queryKey.search) {
        ...
        this.__toggleGroup__P_597_6.setSelection([this.__toggleGroup__P_597_6.getChildren()[1]]);
      }
    },
    ...
    */
    members: {
      __firstPartHash__P_597_7: null,
      __overflowMenu__P_597_8: null,
      __menuItemStore__P_597_0: null,
      __toggleGroup__P_597_6: null,
       ...
       */
      __createToggleView__P_597_3: function __createToggleView__P_597_3(treeWidget, searchWidget, infoWidget) {
        ...
        this.__toggleGroup__P_597_6.addListener("changeSelection", function (e) {
       ...
       */
      __createToolbar__P_597_2: function __createToolbar__P_597_2() {
        var toolbar = new qx.ui.toolbar.ToolBar();
        var part = new qx.ui.toolbar.Part();
        toolbar.add(part);
        this.__firstPartHash__P_597_7 = part.toHashCode();
        ...
        this.__toggleGroup__P_597_6 = group;
        toolbar.addSpacer();
        var part = new qx.ui.toolbar.Part();
        toolbar.add(part);
        ...
        this.__overflowMenu__P_597_8 = new qx.ui.menu.Menu();
        chevron.setMenu(this.__overflowMenu__P_597_8); // add the listener
      ...
      _getMenuItems: function _getMenuItems(toolbarPart) {
        ...
        if (toolbarPart.toHashCode() === this.__firstPartHash__P_597_7) {
          var cachedItem = this.__menuItemStore__P_597_0[toolbarPart.toHashCode()];

          if (!cachedItem) {
            cachedItem = new qx.ui.menu.Separator();

            this.__overflowMenu__P_597_8.addAt(cachedItem, 0);

            this.__menuItemStore__P_597_0[toolbarPart.toHashCode()] = cachedItem;
          }
        ...
        for (var i = partChildren.length - 1; i >= 0; i--) {
          ...
          cachedItem = this.__menuItemStore__P_597_0[toolbarItem.toHashCode()];
          ...
          if (!cachedItem) {
            ...
            this.__menuItemStore__P_597_0[toolbarItem.toHashCode()] = cachedItem;
          }
       ...
       */
      __createDetailFrame__P_597_4: function __createDetailFrame__P_597_4() {
       ...
       */
      __createMainFrame__P_597_9: function __createMainFrame__P_597_9(toolbar, detailFrame) {
       ...
       */
      __createSplitPane__P_597_5: function __createSplitPane__P_597_5(leftWidget, rightWidget) {
       ...
       */
      __createHeader__P_597_1: function __createHeader__P_597_1() {
    ...
    */
    destruct: function destruct() {
      this._classTreeNodeHash = this.__toggleGroup__P_597_6 = null;
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.PackageTree", {
    ...
    construct: function construct() {
      ...
      this.setPadding(0);
      this.__root__P_599_0 = new qx.ui.tree.TreeFolder("Packages");

      this.__root__P_599_0.setOpen(true);

      this.setRoot(this.__root__P_599_0);
      this.setSelection([this.__root__P_599_0]); // TODO: Is this workaround still needed?
    ...
    */
    members: {
      ...
      setTreeData: function setTreeData(docTree) {
        ...
        this.__fillPackageNode__P_599_1(this.__root__P_599_0, docTree, 0);
      ...
      selectTreeNodeByClassName: function selectTreeNodeByClassName(className) {
        ...
        if (!className) {
          ...
          this.setSelection([this.__root__P_599_0]);
          this.scrollChildIntoView(this.__root__P_599_0);
          return qx.Promise.resolve(true);
        }
       ...
       */
      __getPackageNodeOpener__P_599_2: function __getPackageNodeOpener__P_599_2(packageTreeNode, packageDoc, depth) {
        var self = this;
        return function () {
          if (!packageTreeNode.loaded) {
            packageTreeNode.loaded = true;

            self.__fillPackageNode__P_599_1(packageTreeNode, packageDoc, depth + 1);
       ...
       *          {var} current depth in the tree
       */
      __fillPackageNode__P_599_1: function __fillPackageNode__P_599_1(treeNode, docNode, depth) {
        ...
        qx.Promise.map(packagesDoc, packageDoc => {
          ...
          packageTreeNode.addListener("changeOpen", this.__getPackageNodeOpener__P_599_2(packageTreeNode, packageDoc, depth + 1), this); // Register the tree node
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__root__P_599_0");
    }
  });
  ...
  qx.Class.define("qxl.apiviewer.ui.SearchView", {
    ...
    */
    construct: function construct() {
      ...
      this.__initresult__P_600_0 = false;
      this.listdata = [];
      this.apiindex = {};
    ...
    */
    members: {
      __note__P_600_1: null,
      __initresult__P_600_0: null,
      __table__P_600_2: null,
      __typeFilter__P_600_3: null,
      __typesIndex__P_600_4: null,
      __searchTerm__P_600_5: null,
      ...
      search: function search(term) {
        ...
        if (qx.lang.Object.getLength(this.apiindex) == 0) {
          ...
          this.__searchTerm__P_600_5 = term;
        } else {
          this.__searchTerm__P_600_5 = null; // Set search box value
      ...
      _showSearchForm: function _showSearchForm() {
        ...
        this.__typeFilter__P_600_3 = new qx.data.Array([true, true, true, true, true, true, true]);
        ...
        for (var i = 0; i < types.length; i++) {
          ...
          typeToggleButton.bind("value", this.__typeFilter__P_600_3, "[" + i + "]");
          ...
          this.__typeFilter__P_600_3.bind("[" + i + "]", typeToggleButton, "value");
        }
        ...
        typeToggleButtonAll.addListener("changeValue", function (e) {
          for (var i = 0; i < this.__typeFilter__P_600_3.length; i++) {
            this.__typeFilter__P_600_3.setItem(i, e.getData());
          }
        ...
        this.__initresult__P_600_0 = true;
        this.__table__P_600_2 = table; // table.addListener("appear", this.__handleNote, this);
      ...
      _searchResult: function _searchResult(svalue) {
        ...
        for (var i = 0; i < this.__typeFilter__P_600_3.length; i++) {
          if (this.__typeFilter__P_600_3.getItem(i) === true) {
      ...
      _searchIndex: function _searchIndex(svalue, spath) {
        ...
        var index = this.apiindex.__index____P_600_6;
        var fullNames = this.apiindex.__fullNames____P_600_7;
        var types = this.apiindex.__types____P_600_8;
      ...
      _isTypeFilteredIn: function _isTypeFilteredIn(type) {
        return this.__typeFilter__P_600_3.getItem(this.__typesIndex__P_600_4[type]);
      },
      ...
      _load: function _load() {
        ...
        req.addListener("completed", function (evt) {
          ...
          if (this.__searchTerm__P_600_5) {
            setTimeout(function () {
              this.sinput.setValue(this.__searchTerm__P_600_5);
              this.__searchTerm__P_600_5 = null;
            }.bind(this), 0);
          }
        }, this);
      ...
      __initNote__P_600_9: function __initNote__P_600_9(table) {
        this.__note__P_600_1 = new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({
          autoHide: false,
          width: 170
        });
        ...
        this.__note__P_600_1.add(hint, {
          edge: 3
        });

        this.__note__P_600_1.setPosition("bottom-left");

        this.__note__P_600_1.placeToWidget(this.sinput, false);

        this.__note__P_600_1.show();
      },
      __handleNote__P_600_10: function __handleNote__P_600_10(e) {
        if (this.__note__P_600_1) {
          if ((this.sinput.getValue() || "").trim().length == 0) {
            this.__note__P_600_1.show();
          }
        } else {
          this.__initNote__P_600_9();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this.apiindex = this._table = this.__table__P_600_2 = this._tableModel = this.__typeFilter__P_600_3 = this.__typesIndex__P_600_4 = this._selectionModel = null;

      this._disposeObjects("sinput", "__note__P_600_1");
  ...
  qx.Class.define("qxl.apiviewer.ui.LegendView", {
    ...
    */
    construct: function construct() {
      ...
      var length = this.__legend__P_601_0.length;
      var entry, imageUrl;

      for (var i = 0; i < length; i++) {
        entry = this.__legend__P_601_0[i];
    ...
    */
    destruct: function destruct() {
      this._disposeMap("__legend__P_601_0");
    }
  });
...
(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ClassLoader", {
    extend: qx.core.Object,
    statics: {
      __baseUri__P_602_0: null,
      setBaseUri: function setBaseUri(baseUri) {
        this.__baseUri__P_602_0 = baseUri;
      },
      getBaseUri: function getBaseUri() {
        return this.__baseUri__P_602_0;
      },
  ...
  qx.Class.define("qxl.apiviewer.dao.Package", {
    ...
    statics: {
      ...
      getPackage: function getPackage(name, create) {
        var root = qxl.apiviewer.dao.Package.__rootPackage__P_604_0;

        if (!root) {
          root = qxl.apiviewer.dao.Package.__rootPackage__P_604_0 = new qxl.apiviewer.dao.Package("");
        }
...
(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.LoadingIndicator", {
    ...
    extend: qx.core.Object,
    construct: function construct() {
      this.__blocker__P_605_0 = new qx.ui.core.Blocker(qxl.apiviewer.MWidgetRegistry.getWidgetById("tabView"));

      this.__blocker__P_605_0.setColor("#D5D5D5");

      this.__blocker__P_605_0.setOpacity(0.5);

      this.__blocker__P_605_0.getBlockerElement().setStyle("padding-top", "100px");

      this.__blocker__P_605_0.getBlockerElement().setStyle("text-align", "center");
      ...
      this.__blocker__P_605_0.getBlockerElement().add(loadingImage);
    },
    members: {
      __blocker__P_605_0: null,
      show: function show() {
        this.__blocker__P_605_0.block();
      },
      hide: function hide() {
        this.__blocker__P_605_0.unblock();
      }
    }
  });
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.ui.tabview.AbstractPage", {
    ...
    construct: function construct() {
      ...
      this.__bindViewer__P_606_0(this._viewer);
    },
    properties: {
      classNode: {
    ...
    members: {
      ...
      __bindViewer__P_606_0: function __bindViewer__P_606_0(viewer) {
        var uiModel = qxl.apiviewer.UiModel.getInstance();
      ...
      __removeBinding__P_606_1: function __removeBinding__P_606_1() {
        var uiModel = qxl.apiviewer.UiModel.getInstance();
        var bindings = this._bindings;
  ...
  qx.Class.define("qxl.apiviewer.ui.AbstractViewer", {
    ...
    members: {
      ...
      _init: function _init(pkg) {
        this.__initHtml__P_608_0();

        this.addListenerOnce("appear", () => this._syncHtml());
      },
      __initHtml__P_608_0: function __initHtml__P_608_0() {
  ...
  qx.Class.define("qxl.apiviewer.ObjectRegistry", {
    statics: {
      ...
      register: function register(object) {
        ...
        this.__objectDb__P_612_0[hash] = object;
      },
      getObjectFromHashCode: function getObjectFromHashCode(hashCode) {
        return this.__objectDb__P_612_0[hashCode];
      }
    }
  });
    ...
    members: {
      ...
      _getTocHtml: function _getTocHtml(classNode) {
        ...
        this.getPanels().forEach(panel => {
          ...
          q(tocItem).on("tap", function (firstItem) {
            return function () {
              this.__enableSection__P_607_0(firstItem, firstItem.getName());
      ...
      _getDescriptionHtml: function _getDescriptionHtml(classNode) {
        ...
        if (classNode.getType() === "interface") {
          classHtml.add(this.__getInterfaceHierarchyHtml__P_607_1(classNode));
        } else {
          classHtml.add(this.__getClassHierarchyHtml__P_607_2(classNode));
        }

        return classNode.getChildClasses().then(childClasses => {
          classHtml.add(this.__getDependentClassesHtml__P_607_3(childClasses, "Direct " + subObjectsName + ":"));
          classHtml.add(this.__getDependentClassesHtml__P_607_3(classNode.getInterfaces(), "Implemented interfaces:"));
          classHtml.add(this.__getDependentClassesHtml__P_607_3(classNode.getMixins(), "Included mixins:"));
          return classNode.getImplementations();
        }).then(classes => {
          classHtml.add(this.__getDependentClassesHtml__P_607_3(classes, "Implementations of this interface:"));
          return classNode.getIncluder();
        }).then(classes => {
          classHtml.add(this.__getDependentClassesHtml__P_607_3(classes, "Classes including this mixin:"));
       ...
       */
      __getDependentClassesHtml__P_607_3: function __getDependentClassesHtml__P_607_3(dependentClasses, title) {
        var result = "";
       ...
       */
      __getClassHierarchyHtml__P_607_2: function __getClassHierarchyHtml__P_607_2(classNode) {
       ...
       * @return {String} HTML fragemnt
       */
      __getInterfaceHierarchyHtml__P_607_1: function __getInterfaceHierarchyHtml__P_607_1(classNode) {
      ...
      showItem: function showItem(itemName) {
        ...
        this.__enableSection__P_607_0(itemNode, itemName);
       ...
       */
      __enableSection__P_607_0: function __enableSection__P_607_0(itemNode, itemName) {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.InfoPanel", {
    ...
    members: {
      ...
      getItemHtml: function getItemHtml(node, currentDocNode, showDetails) {
        ...
        if (this.itemHasDetails(node, currentDocNode)) {
          ...
          html.add("<img src=\"", qx.util.ResourceManager.getInstance().toUri("qxl/apiviewer/image/open.gif"), "\" onclick=\"", this.__encodeObject__P_609_0(this), ".toggleShowItemDetails('", node.getName(), "'", parentNode != currentDocNode ? ",'" + parentNode.getFullName() + "'" : "", ")\"/>");
        } else {
          html.add("&#160;");
        }
        ...
        if (this.itemHasDetails(node, currentDocNode)) {
          html.add(" onclick=\"", this.__encodeObject__P_609_0(this), ".toggleShowItemDetails('", node.getName(), "'", parentNode != currentDocNode ? ",'" + parentNode.getFullName() + "'" : "", ")\">");
        } else {
          html.add(">");
        }
      ...
      __encodeObject__P_609_0: function __encodeObject__P_609_0(object) {
      ...
      getPanelHtml: function getPanelHtml(viewer) {
        ...
        html.add("<img class=\"openclose\" src=\"", qx.util.ResourceManager.getInstance().toUri("qxl/apiviewer/image/" + (this.getIsOpen() ? "close.gif" : "open.gif")), "\" onclick=\"", this.__encodeObject__P_609_0(viewer), ".togglePanelVisibility(" + this.__encodeObject__P_609_0(this), ")\"/> ", "<span onclick=\"", this.__encodeObject__P_609_0(viewer), ".togglePanelVisibility(", this.__encodeObject__P_609_0(this), ")\">", uppercaseLabelText, "</span>");
       ...
       */
      __filterItems__P_609_1: function __filterItems__P_609_1(nodeArr, expandProperties, showProtected, showPrivate, showInternal) {
      ...
      update: function update(classViewer, currentClassDocNode) {
        ...
        return this.setDocNodeAsync(currentClassDocNode).then(() => {
          ...
          if (nodeArr && nodeArr.length > 0) {
            ...
            nodeArr = this.__filterItems__P_609_1(nodeArr, expandProperties, showProtected, showPrivate, showInternal);
    ...
    statics: {
          ...
          if (useIcon) {
            ...
            if (classNode && classNode.isLoaded()) {
              ...
              if (itemName) {
                ...
                itemNode = this.__getItemFromClassHierarchy__P_609_2(cleanItemName, classNode);
       ...
       *
       */
      __getItemFromClassHierarchy__P_609_2: function __getItemFromClassHierarchy__P_609_2(itemName, baseClassNode) {
      ...
      createDescriptionHtml: function createDescriptionHtml(node, packageBaseClass, showDetails) {
        ...
        if (desc) {
          if (!showDetails) {
            desc = this.__extractFirstSentence__P_609_3(desc);
          }
       ...
       */
      __extractFirstSentence__P_609_3: function __extractFirstSentence__P_609_3(text) {
      ...
      descriptionHasDetails: function descriptionHasDetails(node) {
        ...
        if (desc) {
          return this.__extractFirstSentence__P_609_3(desc) != desc;
        }
  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.ui.panels.ConstantPanel", {
    ...
    members: {
       ...
       */
      itemHasDetails: function itemHasDetails(node, currentClassDocNode) {
        return node.getSee().length > 0 || node.getErrors().length > 0 || qxl.apiviewer.ui.panels.InfoPanel.descriptionHasDetails(node) || this.__hasConstantValueHtml__P_610_0(node);
      },
      getItemTypeHtml: function getItemTypeHtml(node) {
        return qxl.apiviewer.ui.panels.InfoPanel.createTypeHtml(node, "var");
      },
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          textHtml += this.__createConstantValueHtml__P_610_1(node);
       ...
       */
      __hasConstantValueHtml__P_610_0: function __hasConstantValueHtml__P_610_0(node) {
       ...
       */
      __createConstantValueHtml__P_610_1: function __createConstantValueHtml__P_610_1(node) {
        if (this.__hasConstantValueHtml__P_610_0(node)) {
...
//# sourceMappingURL=package-9.js.map?dt=1599312879355
qx.$$packageData['9'] = {
  "locales": {},
  "resources": {},
  "translations": {
