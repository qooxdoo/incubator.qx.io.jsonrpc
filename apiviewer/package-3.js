    ...
    members: {
      ...
      */
      ...
      timeout: function timeout() {
        ...
        this.__disableRequestTimeout__P_160_0();
      },
      ...
      */
       ...
       *
       */
      __disableRequestTimeout__P_160_0: function __disableRequestTimeout__P_160_0() {
        var vRequest = this.getRequest();
  ...
  qx.Class.define("qx.io.remote.transport.Iframe", {
    ...
    */
    construct: function construct() {
      ...
      this.__frame__P_165_0 = qx.bom.Iframe.create({
        id: vFrameName,
        name: vFrameName,
        src: vFrameSource
      });
      qx.bom.element.Style.set(this.__frame__P_165_0, "display", "none"); // Create form element with textarea as conduit for request data.
      ...
      this.__form__P_165_1 = qx.dom.Element.create("form", {
        id: vFormName,
        name: vFormName,
        target: vFrameName
      });
      qx.bom.element.Style.set(this.__form__P_165_1, "display", "none");
      qx.dom.Element.insertEnd(this.__form__P_165_1, qx.dom.Node.getBodyElement(document));
      this.__data__P_165_2 = qx.dom.Element.create("textarea", {
        id: "_data_",
        name: "_data_"
      });
      qx.dom.Element.insertEnd(this.__data__P_165_2, this.__form__P_165_1); // Finally, attach iframe to DOM and add listeners

      qx.dom.Element.insertEnd(this.__frame__P_165_0, qx.dom.Node.getBodyElement(document));
      qx.event.Registration.addListener(this.__frame__P_165_0, "load", this._onload, this); // qx.event.handler.Iframe does not yet support the readystatechange event

      this.__onreadystatechangeWrapper__P_165_3 = qx.lang.Function.listener(this._onreadystatechange, this);
      qx.bom.Event.addNativeListener(this.__frame__P_165_0, "readystatechange", this.__onreadystatechangeWrapper__P_165_3);
    },
    ...
    */
    members: {
      __data__P_165_2: null,
      __lastReadyState__P_165_4: 0,
      __form__P_165_1: null,
      __frame__P_165_0: null,
      __onreadystatechangeWrapper__P_165_3: null,
      ...
      */
      ...
      send: function send() {
        ...
        for (var vId in vFormFields) {
          ...
          this.__form__P_165_1.appendChild(vField);
        } // --------------------------------------
        //   Preparing form
        // --------------------------------------


        this.__form__P_165_1.action = vUrl;
        this.__form__P_165_1.method = vMethod; // --------------------------------------
        //   Sending data
        // --------------------------------------

        this.__data__P_165_2.appendChild(document.createTextNode(this.getData()));

        this.__form__P_165_1.submit();
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        this._switchReadyState(qx.io.remote.transport.Iframe._numericMap[this.__frame__P_165_0.readyState]);
      }),
      ...
      _switchReadyState: function _switchReadyState(vReadyState) {
        ...
        while (this.__lastReadyState__P_165_4 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_165_4]);
        }
      },
      ...
      */
      ...
      getIframeWindow: function getIframeWindow() {
        return qx.bom.Iframe.getWindow(this.__frame__P_165_0);
      },
      ...
      getIframeDocument: function getIframeDocument() {
        return qx.bom.Iframe.getDocument(this.__frame__P_165_0);
      },
      ...
      getIframeBody: function getIframeBody() {
        return qx.bom.Iframe.getBody(this.__frame__P_165_0);
      },
    ...
    */
    destruct: function destruct() {
      if (this.__frame__P_165_0) {
        qx.event.Registration.removeListener(this.__frame__P_165_0, "load", this._onload, this);
        qx.bom.Event.removeNativeListener(this.__frame__P_165_0, "readystatechange", this.__onreadystatechangeWrapper__P_165_3); // Reset source to a blank image for gecko
        // Otherwise it will switch into a load-without-end behaviour

        if (qx.core.Environment.get("engine.name") == "gecko") {
          this.__frame__P_165_0.src = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.gif");
        } // Finally, remove element node


        qx.dom.Element.remove(this.__frame__P_165_0);
      }

      if (this.__form__P_165_1) {
        qx.dom.Element.remove(this.__form__P_165_1);
      }

      this.__frame__P_165_0 = this.__form__P_165_1 = this.__data__P_165_2 = null;
    }
  });
  ...
  qx.Class.define("qx.io.remote.transport.Script", {
    ...
    */
    construct: function construct() {
      ...
      var vUniqueId = ++qx.io.remote.transport.Script.__uniqueId__P_166_0;

      if (vUniqueId >= 2000000000) {
        qx.io.remote.transport.Script.__uniqueId__P_166_0 = vUniqueId = 1;
      }

      this.__element__P_166_1 = null;
      this.__uniqueId__P_166_0 = vUniqueId;
    },
    ...
    */
    members: {
      __lastReadyState__P_166_2: 0,
      __element__P_166_1: null,
      __uniqueId__P_166_0: null,
      ...
      */
      ...
      send: function send() {
        ...
        vUrl += (vUrl.indexOf("?") >= 0 ? "&" : "?") + qx.io.remote.transport.Script.ScriptTransport_ID_PARAM + "=" + this.__uniqueId__P_166_0;
        ...
        qx.io.remote.transport.Script._instanceRegistry[this.__uniqueId__P_166_0] = this;
        this.__element__P_166_1 = document.createElement("script"); // IE needs this (it ignores the
        // encoding from the header sent by the
        // server for dynamic script tags)

        this.__element__P_166_1.charset = "utf-8";
        this.__element__P_166_1.src = vUrl;
        {
          if (qx.core.Environment.get("qx.debug.io.remote.data")) {
            this.debug("Request: " + vUrl);
          }
        }
        document.body.appendChild(this.__element__P_166_1);
      },
      ...
      _switchReadyState: function _switchReadyState(vReadyState) {
        ...
        while (this.__lastReadyState__P_166_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_166_2]);
        }
      },
    ...
    */
    destruct: function destruct() {
      if (this.__element__P_166_1) {
        delete qx.io.remote.transport.Script._instanceRegistry[this.__uniqueId__P_166_0];
        document.body.removeChild(this.__element__P_166_1);
      }

      this.__element__P_166_1 = this._responseContent = null;
    }
  });
    ...
    members: {
      ...
      */
      ...
      getResponseHeader: function getResponseHeader(vHeader) {
        if (this.__lowerHeaders__P_163_0) {
          return this.__lowerHeaders__P_163_0[vHeader.toLowerCase()] || null;
        }
      ...
      _applyResponseHeaders: function _applyResponseHeaders(value, old) {
        ...
        if (value !== null) {
          ...
          this.__lowerHeaders__P_163_0 = lowerHeaders;
        }
      }
    }
  });
  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct: function construct(vUrl, vMethod, vResponseType) {
      qx.core.Object.constructor.call(this);
      this.__requestHeaders__P_161_0 = {};
      this.__urlParameters__P_161_1 = {};
      this.__dataParameters__P_161_2 = {};
      this.__formFields__P_161_3 = {};
      ...
      this.__seqNum__P_161_4 = ++qx.io.remote.Request.__seqNum__P_161_4;
    },
    ...
    */
    members: {
      __requestHeaders__P_161_0: null,
      __urlParameters__P_161_1: null,
      __dataParameters__P_161_2: null,
      __formFields__P_161_3: null,
      __seqNum__P_161_4: null,
      ...
      */
       ...
       */
      __forwardEvent__P_161_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      _onqueued: function _onqueued(e) {
        ...
        this.__forwardEvent__P_161_5(e);
      },
      ...
      _oncompleted: function _oncompleted(e) {
        ...
        this.__forwardEvent__P_161_5(e); // Automatically dispose after event completion
      ...
      */
      ...
      setRequestHeader: function setRequestHeader(vId, vValue) {
        this.__requestHeaders__P_161_0[vId] = vValue;
      },
      ...
      removeRequestHeader: function removeRequestHeader(vId) {
        delete this.__requestHeaders__P_161_0[vId];
      },
      ...
      getRequestHeader: function getRequestHeader(vId) {
        return this.__requestHeaders__P_161_0[vId] || null;
      },
      ...
      getRequestHeaders: function getRequestHeaders() {
        return this.__requestHeaders__P_161_0;
      },
      ...
      */
      ...
      setParameter: function setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__dataParameters__P_161_2[vId] = vValue;
        } else {
          this.__urlParameters__P_161_1[vId] = vValue;
        }
      },
      ...
      removeParameter: function removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__dataParameters__P_161_2[vId];
        } else {
          delete this.__urlParameters__P_161_1[vId];
        }
      },
      ...
      getParameter: function getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__dataParameters__P_161_2[vId] || null;
        } else {
          return this.__urlParameters__P_161_1[vId] || null;
        }
      },
      ...
      getParameters: function getParameters(bFromData) {
        return bFromData ? this.__dataParameters__P_161_2 : this.__urlParameters__P_161_1;
      },
      ...
      */
      ...
      setFormField: function setFormField(vId, vValue) {
        this.__formFields__P_161_3[vId] = vValue;
      },
      ...
      removeFormField: function removeFormField(vId) {
        delete this.__formFields__P_161_3[vId];
      },
      ...
      getFormField: function getFormField(vId) {
        return this.__formFields__P_161_3[vId] || null;
      },
      ...
      getFormFields: function getFormFields() {
        return this.__formFields__P_161_3;
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__requestHeaders__P_161_0 = this.__urlParameters__P_161_1 = this.__dataParameters__P_161_2 = this.__formFields__P_161_3 = null;
    }
  });
...
(function () {
  ...
  */
  qx.Class.define("qx.io.remote.Rpc", {
    ...
    */
    ...
    construct: function construct(url, serviceName) {
      ...
      if (qx.core.ServerSettings) {
        this.__currentServerSuffix__P_164_0 = qx.core.ServerSettings.serverPathSuffix;
      }
    },
    ...
    */
    members: {
      __previousServerSuffix__P_164_1: null,
      __currentServerSuffix__P_164_0: null,
        ...
        req.addListener("completed", function (evt) {
          ...
          if (exTest != null) {
            ...
            if (refreshSession) {
              ...
              if (self.__currentServerSuffix__P_164_0 != newSuffix) {
                self.__previousServerSuffix__P_164_1 = self.__currentServerSuffix__P_164_0;
                self.__currentServerSuffix__P_164_0 = newSuffix;
              }
      ...
      fixUrl: function fixUrl(url) {
        if (this.__previousServerSuffix__P_164_1 == null || this.__currentServerSuffix__P_164_0 == null || this.__previousServerSuffix__P_164_1 == "" || this.__previousServerSuffix__P_164_1 == this.__currentServerSuffix__P_164_0) {
          return url;
        }

        var index = url.indexOf(this.__previousServerSuffix__P_164_1);

        if (index == -1) {
          return url;
        }

        return url.substring(0, index) + this.__currentServerSuffix__P_164_0 + url.substring(index + this.__previousServerSuffix__P_164_1.length);
      },
...
//# sourceMappingURL=package-3.js.map?dt=1625734560689
qx.$$packageData['3'] = {
  "locales": {},
  "resources": {},
  "translations": {}
