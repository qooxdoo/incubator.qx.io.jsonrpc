  ...
  qx.Class.define("qxl.testtapper.Application", {
    ...
    members: {
      ...
      main: function main() {
        ...
        let namespace = "qx.test.io.jsonrpc";
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.logpane.LogPane", {
    ...
    construct: function construct() {
      this.__logLevelData__P_595_0 = [["debug", "Debug", "icon/16/categories/system.png"], ["info", "Info", "icon/16/status/dialog-information.png"], ["warn", "Warning", "icon/16/status/dialog-warning.png"], ["error", "Error", "icon/16/status/dialog-error.png"]];
      ...
      this.__toolbar__P_595_1 = new qx.ui.toolbar.ToolBar();

      this.__toolbar__P_595_1.add(caption);

      this.__toolbar__P_595_1.addSpacer();

      this.__toolbar__P_595_1.setBackgroundColor("white");
      ...
      this.__toolbar__P_595_1.add(clearButton);

      this.add(this.__toolbar__P_595_1); // log pane
      ...
      this.__logAppender__P_595_2 = new qx.log.appender.Element();
      qx.log.Logger.unregister(this.__logAppender__P_595_2); // Directly create DOM element to use

      this.__logElem__P_595_3 = document.createElement("DIV");

      this.__logAppender__P_595_2.setElement(this.__logElem__P_595_3);

      logArea.addListenerOnce("appear", function () {
        logArea.getContentElement().getDomElement().appendChild(this.__logElem__P_595_3);
      }, this);
    },
    properties: {
      /** Shows the toolbar */
    ...
    members: {
      __logElem__P_595_3: null,
      __logAppender__P_595_2: null,
      __logLevelData__P_595_0: null,
      __logLevelButton__P_595_4: null,
      __toolbar__P_595_1: null,

      /**
       * Clears the log.
       */
      clear: function clear() {
        this.__logAppender__P_595_2.clear();
      },
      ...
      fetch: function fetch(Logger) {
        ...
        Logger.register(this.__logAppender__P_595_2); // Clear buffer
      ...
      getAppenderElement: function getAppenderElement() {
        return this.__logElem__P_595_3;
      },
      _applyShowToolBar: function _applyShowToolBar(value, old) {
        if (value) {
          this.__toolbar__P_595_1.show();
        } else {
          this.__toolbar__P_595_1.exclude();
        }
      },
      // property apply
      _applyShowLogLevel: function _applyShowLogLevel(value, old) {
        if (!this.__logLevelButton__P_595_4) {
          this.__logLevelButton__P_595_4 = this.__createLogLevelMenu__P_595_5();

          this.__toolbar__P_595_1.add(this.__logLevelButton__P_595_4);
        }

        if (value) {
          this.__logLevelButton__P_595_4.show();
        } else {
          this.__logLevelButton__P_595_4.exclude();
        }
      },
       ...
       */
      __createLogLevelMenu__P_595_5: function __createLogLevelMenu__P_595_5() {
        ...
        for (var i = 0, l = this.__logLevelData__P_595_0.length; i < l; i++) {
          var data = this.__logLevelData__P_595_0[i];
    ...
    destruct: function destruct() {
      this._disposeObjects("__logAppender__P_595_2");

      this.__logElem__P_595_3 = null;
    }
  });
  qxl.logpane.LogPane.$$dbClassInfo = $$dbClassInfo;
})();
//# sourceMappingURL=package-11.js.map?dt=1599312880918
qx.$$packageData['11'] = {
  "locales": {},
  "resources": {},
  "translations": {
