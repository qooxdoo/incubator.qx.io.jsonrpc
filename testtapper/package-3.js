  ...
  qx.Class.define("qx.io.remote.transport.Iframe", {
    ...
    */
    construct: function construct() {
      ...
      this.__frame__P_170_0 = qx.bom.Iframe.create({
        id: vFrameName,
        name: vFrameName,
        src: vFrameSource
      });
      qx.bom.element.Style.set(this.__frame__P_170_0, "display", "none"); // Create form element with textarea as conduit for request data.
      ...
      this.__form__P_170_1 = qx.dom.Element.create("form", {
        id: vFormName,
        name: vFormName,
        target: vFrameName
      });
      qx.bom.element.Style.set(this.__form__P_170_1, "display", "none");
      qx.dom.Element.insertEnd(this.__form__P_170_1, qx.dom.Node.getBodyElement(document));
      this.__data__P_170_2 = qx.dom.Element.create("textarea", {
        id: "_data_",
        name: "_data_"
      });
      qx.dom.Element.insertEnd(this.__data__P_170_2, this.__form__P_170_1); // Finally, attach iframe to DOM and add listeners

      qx.dom.Element.insertEnd(this.__frame__P_170_0, qx.dom.Node.getBodyElement(document));
      qx.event.Registration.addListener(this.__frame__P_170_0, "load", this._onload, this); // qx.event.handler.Iframe does not yet support the readystatechange event

      this.__onreadystatechangeWrapper__P_170_3 = qx.lang.Function.listener(this._onreadystatechange, this);
      qx.bom.Event.addNativeListener(this.__frame__P_170_0, "readystatechange", this.__onreadystatechangeWrapper__P_170_3);
    },
    ...
    */
    members: {
      __data__P_170_2: null,
      __lastReadyState__P_170_4: 0,
      __form__P_170_1: null,
      __frame__P_170_0: null,
      __onreadystatechangeWrapper__P_170_3: null,
      ...
      */
      ...
      send: function send() {
        ...
        for (var vId in vFormFields) {
          ...
          this.__form__P_170_1.appendChild(vField);
        } // --------------------------------------
        //   Preparing form
        // --------------------------------------


        this.__form__P_170_1.action = vUrl;
        this.__form__P_170_1.method = vMethod; // --------------------------------------
        //   Sending data
        // --------------------------------------

        this.__data__P_170_2.appendChild(document.createTextNode(this.getData()));

        this.__form__P_170_1.submit();
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        this._switchReadyState(qx.io.remote.transport.Iframe._numericMap[this.__frame__P_170_0.readyState]);
      }),
      ...
      _switchReadyState: function _switchReadyState(vReadyState) {
        ...
        while (this.__lastReadyState__P_170_4 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_170_4]);
        }
      },
      ...
      */
      ...
      getIframeWindow: function getIframeWindow() {
        return qx.bom.Iframe.getWindow(this.__frame__P_170_0);
      },
      ...
      getIframeDocument: function getIframeDocument() {
        return qx.bom.Iframe.getDocument(this.__frame__P_170_0);
      },
      ...
      getIframeBody: function getIframeBody() {
        return qx.bom.Iframe.getBody(this.__frame__P_170_0);
      },
    ...
    */
    destruct: function destruct() {
      if (this.__frame__P_170_0) {
        qx.event.Registration.removeListener(this.__frame__P_170_0, "load", this._onload, this);
        qx.bom.Event.removeNativeListener(this.__frame__P_170_0, "readystatechange", this.__onreadystatechangeWrapper__P_170_3); // Reset source to a blank image for gecko
        // Otherwise it will switch into a load-without-end behaviour

        if (qx.core.Environment.get("engine.name") == "gecko") {
          this.__frame__P_170_0.src = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.gif");
        } // Finally, remove element node


        qx.dom.Element.remove(this.__frame__P_170_0);
      }

      if (this.__form__P_170_1) {
        qx.dom.Element.remove(this.__form__P_170_1);
      }

      this.__frame__P_170_0 = this.__form__P_170_1 = this.__data__P_170_2 = null;
    }
  });
  ...
  qx.Class.define("qx.io.remote.transport.XmlHttp", {
    ...
    */
    statics: {
      ...
      setTimeout: function setTimeout(timeout) {
        this.__timeout__P_172_0 = timeout;
      },
      ...
      getTimeout: function getTimeout() {
        return this.__timeout__P_172_0;
      }
    },
    ...
    */
    members: {
      ...
      ---------------------------------------------------------------------------
      */
      __localRequest__P_172_1: false,
      __lastReadyState__P_172_2: 0,
      __request__P_172_3: null,
      ...
      getRequest: function getRequest() {
        if (this.__request__P_172_3 === null) {
          this.__request__P_172_3 = qx.io.remote.transport.XmlHttp.createRequestObject();
          this.__request__P_172_3.onreadystatechange = qx.lang.Function.bind(this._onreadystatechange, this);
        }

        return this.__request__P_172_3;
      },
      ...
      */
       ...
       */
      send: function send() {
        this.__lastReadyState__P_172_2 = 0;
        var vRequest = this.getRequest();
        var vMethod = this.getMethod();
        ...
        this.__localRequest__P_172_1 = vLocalRequest; // --------------------------------------
      ...
      */
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        ...
        if (vReadyState == 4) {
          ...
          if (!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(), vReadyState, this.__localRequest__P_172_1)) {
            // Fix for bug #2272
        ...
        if (vReadyState == 3 && this.__lastReadyState__P_172_2 == 1) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_172_2]);
        } // Updating internal state


        while (this.__lastReadyState__P_172_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_172_2]);
        }
      }),
      ...
      */
      ...
      getResponseXml: function getResponseXml() {
        ...
        if (qx.io.remote.Exchange.wasSuccessful(vStatus, vReadyState, this.__localRequest__P_172_1)) {
          try {
    ...
    members: {
      ...
      */
      ...
      getResponseHeader: function getResponseHeader(vHeader) {
        if (this.__lowerHeaders__P_168_0) {
          return this.__lowerHeaders__P_168_0[vHeader.toLowerCase()] || null;
        }
      ...
      _applyResponseHeaders: function _applyResponseHeaders(value, old) {
        ...
        if (value !== null) {
          ...
          this.__lowerHeaders__P_168_0 = lowerHeaders;
        }
      }
    }
  });
  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct: function construct(vUrl, vMethod, vResponseType) {
      qx.core.Object.constructor.call(this);
      this.__requestHeaders__P_166_0 = {};
      this.__urlParameters__P_166_1 = {};
      this.__dataParameters__P_166_2 = {};
      this.__formFields__P_166_3 = {};
      ...
      this.__seqNum__P_166_4 = ++qx.io.remote.Request.__seqNum__P_166_4;
    },
    ...
    */
    members: {
      __requestHeaders__P_166_0: null,
      __urlParameters__P_166_1: null,
      __dataParameters__P_166_2: null,
      __formFields__P_166_3: null,
      __seqNum__P_166_4: null,
      ...
      */
       ...
       */
      __forwardEvent__P_166_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      _onqueued: function _onqueued(e) {
        ...
        this.__forwardEvent__P_166_5(e);
      },
      ...
      _oncompleted: function _oncompleted(e) {
        ...
        this.__forwardEvent__P_166_5(e); // Automatically dispose after event completion
      ...
      */
      ...
      setRequestHeader: function setRequestHeader(vId, vValue) {
        this.__requestHeaders__P_166_0[vId] = vValue;
      },
      ...
      removeRequestHeader: function removeRequestHeader(vId) {
        delete this.__requestHeaders__P_166_0[vId];
      },
      ...
      getRequestHeader: function getRequestHeader(vId) {
        return this.__requestHeaders__P_166_0[vId] || null;
      },
      ...
      getRequestHeaders: function getRequestHeaders() {
        return this.__requestHeaders__P_166_0;
      },
      ...
      */
      ...
      setParameter: function setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__dataParameters__P_166_2[vId] = vValue;
        } else {
          this.__urlParameters__P_166_1[vId] = vValue;
        }
      },
      ...
      removeParameter: function removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__dataParameters__P_166_2[vId];
        } else {
          delete this.__urlParameters__P_166_1[vId];
        }
      },
      ...
      getParameter: function getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__dataParameters__P_166_2[vId] || null;
        } else {
          return this.__urlParameters__P_166_1[vId] || null;
        }
      },
      ...
      getParameters: function getParameters(bFromData) {
        return bFromData ? this.__dataParameters__P_166_2 : this.__urlParameters__P_166_1;
      },
      ...
      */
      ...
      setFormField: function setFormField(vId, vValue) {
        this.__formFields__P_166_3[vId] = vValue;
      },
      ...
      removeFormField: function removeFormField(vId) {
        delete this.__formFields__P_166_3[vId];
      },
      ...
      getFormField: function getFormField(vId) {
        return this.__formFields__P_166_3[vId] || null;
      },
      ...
      getFormFields: function getFormFields() {
        return this.__formFields__P_166_3;
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__requestHeaders__P_166_0 = this.__urlParameters__P_166_1 = this.__dataParameters__P_166_2 = this.__formFields__P_166_3 = null;
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct: function construct() {
      qx.core.Object.constructor.call(this);
      this.__queue__P_167_0 = [];
      this.__active__P_167_1 = [];
      this.__totalRequests__P_167_2 = 0; // timeout handling

      this.__timer__P_167_3 = new qx.event.Timer(500);

      this.__timer__P_167_3.addListener("interval", this._oninterval, this);
    },
    ...
    */
    members: {
      __queue__P_167_0: null,
      __active__P_167_1: null,
      __totalRequests__P_167_2: null,
      __timer__P_167_3: null,
      ...
      */
      ...
      _debug: function _debug() {
        {
          if (qx.core.Environment.get("qx.debug.io.remote")) {
            // Debug output
            var vText = this.__active__P_167_1.length + "/" + (this.__queue__P_167_0.length + this.__active__P_167_1.length);
      ...
      _check: function _check() {
        ...
        if (this.__active__P_167_1.length == 0 && this.__queue__P_167_0.length == 0) {
          this.__timer__P_167_3.stop();
        } // Checking if enabled
        ...
        if (this.__queue__P_167_0.length == 0 || this.__queue__P_167_0[0].isAsynchronous() && this.__active__P_167_1.length >= this.getMaxConcurrentRequests()) {
          return;
        } // Checking number of total requests


        if (this.getMaxTotalRequests() != null && this.__totalRequests__P_167_2 >= this.getMaxTotalRequests()) {
          return;
        }

        var vRequest = this.__queue__P_167_0.shift();

        var vTransport = new qx.io.remote.Exchange(vRequest); // Increment counter

        this.__totalRequests__P_167_2++; // Add to active queue

        this.__active__P_167_1.push(vTransport); // Debug output
        ...
        if (this.__queue__P_167_0.length > 0) {
          this._check();
        }
      },
      ...
      _remove: function _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__active__P_167_1, vTransport); // Dispose transport object
      ...
      */
      ...
      _onsending: function _onsending(e) {
        {
          if (qx.core.Environment.get("qx.debug.io.remote")) {
            this.__activeCount__P_167_4++;
            e.getTarget()._counted = true;
            this.debug("ActiveCount: " + this.__activeCount__P_167_4);
          }
        }
      ...
      */
      ...
      _oninterval: function _oninterval(e) {
        var vActive = this.__active__P_167_1;
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        ...
        this.__timer__P_167_3.setEnabled(value);
      },
      ...
      */
      ...
      add: function add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__queue__P_167_0.push(vRequest);
        } else {
          this.__queue__P_167_0.unshift(vRequest);
        }

        this._check();

        if (this.getEnabled()) {
          this.__timer__P_167_3.start();
        }
      },
      ...
      abort: function abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__queue__P_167_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__queue__P_167_0, vRequest);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__active__P_167_1");

      this._disposeObjects("__timer__P_167_3");

      this.__queue__P_167_0 = null;
    }
  });
...
(function () {
  ...
  */
  qx.Class.define("qx.io.remote.Rpc", {
    ...
    */
    ...
    construct: function construct(url, serviceName) {
      ...
      if (qx.core.ServerSettings) {
        this.__currentServerSuffix__P_169_0 = qx.core.ServerSettings.serverPathSuffix;
      }
    },
    ...
    */
    members: {
      __previousServerSuffix__P_169_1: null,
      __currentServerSuffix__P_169_0: null,
        ...
        req.addListener("completed", function (evt) {
          ...
          if (exTest != null) {
            ...
            if (refreshSession) {
              ...
              if (self.__currentServerSuffix__P_169_0 != newSuffix) {
                self.__previousServerSuffix__P_169_1 = self.__currentServerSuffix__P_169_0;
                self.__currentServerSuffix__P_169_0 = newSuffix;
              }
      ...
      fixUrl: function fixUrl(url) {
        if (this.__previousServerSuffix__P_169_1 == null || this.__currentServerSuffix__P_169_0 == null || this.__previousServerSuffix__P_169_1 == "" || this.__previousServerSuffix__P_169_1 == this.__currentServerSuffix__P_169_0) {
          return url;
        }

        var index = url.indexOf(this.__previousServerSuffix__P_169_1);

        if (index == -1) {
          return url;
        }

        return url.substring(0, index) + this.__currentServerSuffix__P_169_0 + url.substring(index + this.__previousServerSuffix__P_169_1.length);
      },
...
//# sourceMappingURL=package-3.js.map?dt=1599343261218
qx.$$packageData['3'] = {
  "locales": {},
  "resources": {},
  "translations": {}
